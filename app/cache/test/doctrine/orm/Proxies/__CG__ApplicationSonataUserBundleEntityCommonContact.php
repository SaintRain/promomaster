 ...
 */
class CommonContact extends \Application\Sonata\UserBundle\Entity\CommonContact implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'address', 'contragent', 'city', 'mark', 'postIndex');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CommonContact $proxy) {
