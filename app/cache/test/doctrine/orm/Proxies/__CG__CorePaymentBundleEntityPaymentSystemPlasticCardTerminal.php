 ...
 */
class PlasticCardTerminal extends \Core\PaymentBundle\Entity\PaymentSystem\PlasticCardTerminal implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'captionRu', 'captionEn', 'descriptionRu', 'descriptionEn');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PlasticCardTerminal $proxy) {
