 ...
 */
class CouponAccess extends \Application\Sonata\UserBundle\Entity\CouponAccess implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'hash', 'user', 'createdAt', 'url');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CouponAccess $proxy) {
