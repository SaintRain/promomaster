...
class __TwigTemplate_55863ad3e118e4deb7d72431f9abc6612d686539712d9f3198db674ec4b56b9b extends Twig_Template
{
    ...
    <fieldset>
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["extra"]) ? $context["extra"] : $this->getContext($context, "extra")), "analysisMRC", array()));
        $context['loop'] = array(
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["d"]) {
            ...
            echo "</span>                            
                            ...
                            <td>    
                                <span class=\"money\">";
            // line 46
            echo twig_escape_filter($this->env, $this->env->getExtension('money_extension')->moneyFormatFunction($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["extra"]) ? $context["extra"] : $this->getContext($context, "extra")), "ph", array()), $this->getAttribute($this->getAttribute($context["d"], "product", array()), "id", array()), array(), "array"), "orderOnlyPriceBuying", array())), "html", null, true);
            echo " ";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["extra"]) ? $context["extra"] : $this->getContext($context, "extra")), "ph", array()), $this->getAttribute($this->getAttribute($context["d"], "product", array()), "id", array()), array(), "array"), "OOPBCurrency", array()), "symbol", array()), "html", null, true);
            echo "</span>
                                ";
            // line 47
            if ($this->getAttribute($this->getAttribute($context["d"], "extra", array(), "any", false, true), "difCurrency", array(), "any", true, true)) {
            ...
            echo "                            </td>
                            ...
                            <td nowrap>
                                <span class=\"money\">";
            // line 61
            echo twig_escape_filter($this->env, $this->env->getExtension('money_extension')->moneyFormatFunction($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["extra"]) ? $context["extra"] : $this->getContext($context, "extra")), "ph", array()), $this->getAttribute($this->getAttribute($context["d"], "product", array()), "id", array()), array(), "array"), "mrc", array())), "html", null, true);
            echo " ";
            echo twig_escape_filter($this->env, $this->env->getExtension('money_extension')->currencyFormatFunction(), "html", null, true);
            echo "</span>
                            </td>
    ...
    \$(function () {
        ...
        \$('.enableMrcProductButton').click(function () {
            ...
            if (ids.length > 0) {
                \$.post(\"";
        // line 146
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["admin"]) ? $context["admin"] : $this->getContext($context, "admin")), "generateObjectUrl", array(0 => "enableProduct", 1 => $this->getAttribute((isset($context["admin"]) ? $context["admin"] : $this->getContext($context, "admin")), "subject", array())), "method"), "html", null, true);
        echo "\", {ids: ids})
                        .done(function (data) {
        ...
        \$('.updateProductMrcButton').click(function () {
            ...
            if (ids.length > 0) {
                \$.post(\"";
        // line 167
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["admin"]) ? $context["admin"] : $this->getContext($context, "admin")), "generateObjectUrl", array(0 => "setMrcPriceForProductsFromPrice", 1 => $this->getAttribute((isset($context["admin"]) ? $context["admin"] : $this->getContext($context, "admin")), "subject", array())), "method"), "html", null, true);
        echo "\", {ids: ids})
                        .done(function (data) {
