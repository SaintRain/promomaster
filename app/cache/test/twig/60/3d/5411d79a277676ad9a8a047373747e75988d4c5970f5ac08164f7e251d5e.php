...
class __TwigTemplate_603d5411d79a277676ad9a8a047373747e75988d4c5970f5ac08164f7e251d5e extends Twig_Template
{
    ...
    public function block_seo($context, array $blocks = array())
    {
        ...
        if ((((isset($context["_page"]) ? $context["_page"] : $this->getContext($context, "_page")) - 1) > 0)) {
            ...
            ";
                ...
                // line 49
                echo "                <link rel=\"prev\" href=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("application_sonata_user_profile_products_history", array("page" => ((isset($context["_page"]) ? $context["_page"] : $this->getContext($context, "_page")) - 1), "_format" => "html")), "html", null, true);
                echo "\" />
            ";
            }
            // line 51
    ...
    public function block_products_container_filter_sort_last($context, array $blocks = array())
    {
        ...
        // line 80
        if (((isset($context["sort"]) ? $context["sort"] : $this->getContext($context, "sort")) == "viewed_desc")) {
            echo "active desc";
        } elseif (((isset($context["sort"]) ? $context["sort"] : $this->getContext($context, "sort")) == "viewed_asc")) {
            echo "active";
        }
        echo "\"><a href=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath((isset($context["routeFirsPage"]) ? $context["routeFirsPage"] : $this->getContext($context, "routeFirsPage")), twig_array_merge((isset($context["parameters"]) ? $context["parameters"] : $this->getContext($context, "parameters")), array("sort" => ((((isset($context["sort"]) ? $context["sort"] : $this->getContext($context, "sort")) == "viewed_asc")) ? ("viewed_desc") : ("viewed_asc"))))), "html", null, true);
        echo "\">";
