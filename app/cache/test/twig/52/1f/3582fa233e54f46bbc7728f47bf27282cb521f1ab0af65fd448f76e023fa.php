...
class __TwigTemplate_521f3582fa233e54f46bbc7728f47bf27282cb521f1ab0af65fd448f76e023fa extends Twig_Template
{
    ...
    {
        // line 1
        if (twig_length_filter($this->env, (isset($context["articles"]) ? $context["articles"] : $this->getContext($context, "articles")))) {
            // line 2
    ...
    ";
            ...
            <a ";
                ...
                echo "\">";
                echo twig_escape_filter($this->env, (isset($context["captionRu"]) ? $context["captionRu"] : $this->getContext($context, "captionRu")), "html", null, true);
                echo "</a>
        </li>
    ";
            }
