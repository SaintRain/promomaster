...
class __TwigTemplate_5c5a232c1064be4c12c22056bb8fa2abbbe7c31e662f0b49a4793749f6ad333b extends Twig_Template
{
...
";
    ...
    public function block_tickets_block_tickets_table($context, array $blocks = array())
    {
        ...
        ob_start();
        // line 12
        if ((array_key_exists("tickets", $context) && (twig_length_filter($this->env, (isset($context["tickets"]) ? $context["tickets"] : $this->getContext($context, "tickets"))) > 0))) {
            // line 14
            ...
            $context['_seq'] = twig_ensure_traversable(twig_reverse_filter($this->env, (isset($context["tickets"]) ? $context["tickets"] : $this->getContext($context, "tickets"))));
            foreach ($context['_seq'] as $context["_key"] => $context["ticket"]) {
                ...
                echo "</a></td>
                            <td nowrap>
                                ";
                // line 28
                echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute($context["ticket"], "updatedDateTime", array()), "d.m.y H:i", (isset($context["default_timezone"]) ? $context["default_timezone"] : $this->getContext($context, "default_timezone"))), "html", null, true);
                echo "
                                <br>
                                ";
                // line 30
