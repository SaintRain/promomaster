...
class __TwigTemplate_35799c78f2de4679bb3bd7e90d34e874bb5b971977417c7c764712c2c799865a extends Twig_Template
{
...
";
    ...
    <div class=\"main_col\">
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["centerCategories"]) ? $context["centerCategories"] : $this->getContext($context, "centerCategories")));
        $context['loop'] = array(
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["centCat"]) {
            ...
            echo "\">
                            <span>";
            // line 93
            echo twig_escape_filter($this->env, $this->getAttribute($context["centCat"], ("caption" . $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "request", array()), "locale", array()))), "html", null, true);
            echo "</span>
                        </li>
                    ";
            ++$context['loop']['index0'];
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["centCat"]) {
            ...
            // line 104
            echo "                    ";
            $context["products"] = ((((isset($context["productLen"]) ? $context["productLen"] : $this->getContext($context, "productLen")) > 8)) ? (twig_slice($this->env, $this->getAttribute($context["centCat"], "products", array()), 0, 7)) : ($this->getAttribute($context["centCat"], "products", array())));
            // line 105
            echo "                    ";
            $context['_parent'] = (array) $context;
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
                // line 106
                echo "                        ";
                if (((((isset($context["i"]) ? $context["i"] : $this->getContext($context, "i")) % 4) == 0) || ((isset($context["productLen"]) ? $context["productLen"] : $this->getContext($context, "productLen")) == 0))) {
                    // line 107
                    echo "                            <div class=\"products_grid_line grid_container in_cat_";
                    echo twig_escape_filter($this->env, $this->getAttribute($context["centCat"], "name", array()), "html", null, true);
                    if ((!(isset($context["isFirst"]) ? $context["isFirst"] : $this->getContext($context, "isFirst")))) {
                        echo " hidden";
                    }
                    echo "\">
                        ";
                ...
                // line 136
                echo "                        ";
                $context["productLen"] = ((isset($context["productLen"]) ? $context["productLen"] : $this->getContext($context, "productLen")) - 1);
                // line 137
                echo "                        ";
                if (((((isset($context["i"]) ? $context["i"] : $this->getContext($context, "i")) % 4) == 0) || ((isset($context["productLen"]) ? $context["productLen"] : $this->getContext($context, "productLen")) == 0))) {
                    // line 138
        ...
        ";
        // line 146
        if (twig_length_filter($this->env, (isset($context["brands"]) ? $context["brands"] : $this->getContext($context, "brands")))) {
            // line 147
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["brand"]) {
                ...
                if ($this->getAttribute($context["brand"], "logo", array())) {
                    // line 160
                    echo "                                        ";
                    if ($this->getAttribute(twig_first($this->env, $this->getAttribute($context["brand"], "logo", array())), ("alt" . $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "request", array()), "locale", array())))) {
                        // line 161
                        echo "                                            ";
                        $context["imgAlt"] = $this->getAttribute(twig_first($this->env, $this->getAttribute($context["brand"], "logo", array())), ("alt" . $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "request", array()), "locale", array())));
                        // line 162
                        echo "                                            ";
                    } else {
                        // line 163
                        echo "                                                ";
                        $context["imgAlt"] = $this->getAttribute($context["brand"], ("caption" . $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "request", array()), "locale", array())));
                        // line 164
                        echo "                                        ";
                    }
                    // line 165
                    ...
                    // line 168
                    echo "                                        <img title=\"";
                    echo twig_escape_filter($this->env, $this->getAttribute($context["brand"], ("caption" . $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "request", array()), "locale", array()))), "html", null, true);
                    echo "\" alt=\"";
                    echo twig_escape_filter($this->env, $this->getAttribute($context["brand"], ("caption" . $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "request", array()), "locale", array()))), "html", null, true);
                    echo "\" src=\"";
