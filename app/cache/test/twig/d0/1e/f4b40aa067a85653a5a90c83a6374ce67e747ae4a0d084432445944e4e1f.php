...
class __TwigTemplate_d01ef4b40aa067a85653a5a90c83a6374ce67e747ae4a0d084432445944e4e1f extends Twig_Template
{
    ...
    public function block_seo($context, array $blocks = array())
    {
        ...
        if ((twig_length_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "request", array()), "query", array()), "all", array())) > 0)) {
            ...
            if (((isset($context["_page"]) ? $context["_page"] : $this->getContext($context, "_page")) && ((isset($context["_page"]) ? $context["_page"] : $this->getContext($context, "_page")) > 1))) {
                ...
                ";
                // line 30
                $context["canonical"] = $this->env->getExtension('routing')->getPath($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "request", array()), "attributes", array()), "get", array(0 => "_route"), "method"), array("page" => (isset($context["_page"]) ? $context["_page"] : $this->getContext($context, "_page")), "_format" => "html"));
                // line 31
                echo "
            ";
            } else {
                ...
                ";
                // line 34
                $context["canonical"] = $this->env->getExtension('routing')->getPath($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "request", array()), "attributes", array()), "get", array(0 => "_route"), "method"), array("_format" => "html"));
                // line 35
                echo "
            ";
            }
        ...
        if ((((isset($context["_page"]) ? $context["_page"] : $this->getContext($context, "_page")) - 1) > 0)) {
            ...
            ";
                ...
                // line 49
                echo "                <link rel=\"prev\" href=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("application_sonata_user_profile_products_favorites", array("page" => ((isset($context["_page"]) ? $context["_page"] : $this->getContext($context, "_page")) - 1), "_format" => "html")), "html", null, true);
                echo "\" />
            ";
            }
            // line 51
    ...
    <li class=\"filter_sort_switch ";
        // line 65
        if (((isset($context["sort"]) ? $context["sort"] : $this->getContext($context, "sort")) == "added_desc")) {
            echo "active desc";
        } elseif (((isset($context["sort"]) ? $context["sort"] : $this->getContext($context, "sort")) == "added_asc")) {
            echo "active";
        }
        echo "\"><a href=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath((isset($context["routeFirsPage"]) ? $context["routeFirsPage"] : $this->getContext($context, "routeFirsPage")), twig_array_merge((isset($context["parameters"]) ? $context["parameters"] : $this->getContext($context, "parameters")), array("sort" => ((((isset($context["sort"]) ? $context["sort"] : $this->getContext($context, "sort")) == "added_asc")) ? ("added_desc") : ("added_asc"))))), "html", null, true);
        echo "\">";
