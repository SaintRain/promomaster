...
class __TwigTemplate_d0e3b26f849ed3b841f13270e75d0bb9bafe89bdf1a7909b8ad1e0143841fd6a extends Twig_Template
{
    ...
    <center>
        <table border=\"0\" cellspacing=\"0\" width=\"100%\" style=\"margin: 10pt 0 0 0; font-size: 8pt; line-height: 8.2pt; width: 595px; \">
            <tr>
                <td style=\"font-family: Verdana, Arial; line-height: 8.4pt;\">
                    <span style=\"font-size: 60px; letter-spacing: -7px;\">OLIKIDS.RU</span>
        ...
        echo "<br /><br /><br />";
        echo twig_escape_filter($this->env, (isset($context["default_email"]) ? $context["default_email"] : $this->getContext($context, "default_email")), "html", null, true);
        echo "</td>
            </tr>
            <tr>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["unit"]) {
            ...
            if ($this->getAttribute($this->getAttribute($context["unit"], "serials", array()), "count", array())) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["serial"]) {
                    // line 58
                    echo "                                    ";
                    $context["c_index"] = ((isset($context["c_index"]) ? $context["c_index"] : $this->getContext($context, "c_index")) + 1);
                    // line 59
                    echo "                                    <tr>
                                        <td style=\"border-width: 0 0 .5pt .5pt;width:30px\">";
                    // line 60
                    echo twig_escape_filter($this->env, (isset($context["c_index"]) ? $context["c_index"] : $this->getContext($context, "c_index")), "html", null, true);
                    echo "</td>
                    ...
                    if ($this->getAttribute($context["unit"], "warrantyBefore", array(), "any", true, true)) {
                        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute($context["unit"], "warrantyBefore", array()), "d.m.Y", (isset($context["default_timezone"]) ? $context["default_timezone"] : $this->getContext($context, "default_timezone"))), "html", null, true);
                    } else {
                        echo "&mdash;";
                    }
                    echo "</td>
                ...
                if ($this->getAttribute((isset($context["serial"]) ? $context["serial"] : null), "value", array(), "any", true, true)) {
                    echo twig_escape_filter($this->env, $this->getAttribute((isset($context["serial"]) ? $context["serial"] : $this->getContext($context, "serial")), "value", array()), "html", null, true);
                } else {
                    echo "Без с/н.";
                }
                echo "</td>
        ...
        echo "                    </table>
            ...
            <tr>
                <td colspan=\"2\">                                                                                                                                        
                    <b>Условия</b>
                    <ol class=\"conditions\" >
                        <li>Документом, дающим право на гарантийное обслуживание, является гарантийный талон, который оформляется при приобретении товаров в интернет-магазине детских товаров OLIKIDS.RU (OOO РОСТПЭЙ). В гарантийном талоне указываются (на каждую отдельную позицию):
                            <ul>
                                <li>- Код товара</li>
                                <li>- Наименование</li>
                        ...
                        <li>Прием товаров в гарантийный ремонт или на замену по гарантии осуществляется только после предварительного обращения в службу поддержки и проведения консультации с менеджером посредством системы обращений компании OLIKIDS.RU на странице www.olikids.ru/contacts.html</li>
                        <li>Прием товаров в гарантийный ремонт или на замену по гарантии осуществляется в офисе компании OLIKIDS.RU (OOO РОСТПЭЙ) по адресу: 344011, г. Ростов-на-Дону, пер.Доломановский, д. 70Д, оф.1001</li>
                        <li>Доставка товаров в офис OLIKIDS.RU (OOO РОСТПЭЙ) и обратно осуществляется Покупателем за свой счет. В случае если подтверждается гарантийный случай, затраты клиента на доставку товара компенсируются интернет магазином OLIKIDS.RU (OOO РОСТПЭЙ).</li>
                        ...
                        <li>Условия возврат товара надлежащего качества:
                            <ul>
                                ...
                                <li>- Клиент доставляет товар до продавца за свой счет. Прием товара осуществляется в офисе компании OLIKIDS.RU (OOO РОСТПЭЙ) по адресу: 344011, г. Ростов-на-Дону, пер.Доломановский, д. 70Д, оф.1001.</li>
                            </ul>
                    </ol>                                                                  
                </td>
            </tr>
