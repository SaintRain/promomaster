...
class __TwigTemplate_ae085579801d0f9d5a428a85a1bebc9b6a09c8c9fec5b1cfb9c620e68ba55468 extends Twig_Template
{
            ...
            <div class=\"modal-body\">
                <div class=\"sonata-ba-collapsed-fields\">
                    <div class=\"control-group\">
                        ";
        // line 16
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["articleForm"]) ? $context["articleForm"] : $this->getContext($context, "articleForm")), "captionRu", array()), 'label');
        echo "
                        <div class=\"controls sonata-ba-field sonata-ba-field-standard-natural\">
                            ";
        // line 18
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["articleForm"]) ? $context["articleForm"] : $this->getContext($context, "articleForm")), "captionRu", array()), 'widget');
        echo "
                        </div>
                    </div>
                    <div class=\"control-group\">
                        ";
        // line 22
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["articleForm"]) ? $context["articleForm"] : $this->getContext($context, "articleForm")), "slug", array()), 'label');
        echo "
                        <div class=\"controls sonata-ba-field sonata-ba-field-standard-natural\">
                            ";
        // line 24
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["articleForm"]) ? $context["articleForm"] : $this->getContext($context, "articleForm")), "slug", array()), 'widget');
        echo "
                            <div>
                    ...
                    <div class=\"control-group\">
                        ";
        // line 35
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["articleForm"]) ? $context["articleForm"] : $this->getContext($context, "articleForm")), "bodyRu", array()), 'label');
        echo "
                        <div class=\"controls sonata-ba-field sonata-ba-field-standard-natural\">
                            ";
        // line 37
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["articleForm"]) ? $context["articleForm"] : $this->getContext($context, "articleForm")), "bodyRu", array()), 'widget');
        echo "
                            ";
        // line 38
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock((isset($context["articleForm"]) ? $context["articleForm"] : $this->getContext($context, "articleForm")), 'rest');
        echo "
                        </div>
                    </div>
                </div>
    ...
    ";
        // line 66
        if (((isset($context["onCreateOrderError"]) ? $context["onCreateOrderError"] : $this->getContext($context, "onCreateOrderError")) || ((!$this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "status", array())) || ($this->getAttribute($this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "status", array()), "name", array()) != "canceled")))) {
            // line 67
            echo "        ";
            ...
            ";
                ...
                adminRoutes['core_pre_order_get'] = \"";
                    ...
                    echo "\",
                        currentObjectId= \"";
                    // line 79
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["admin"]) ? $context["admin"] : $this->getContext($context, "admin")), "subject", array()), "id", array()), "html", null, true);
                    echo "\",
                        uniqid=\"";
                    // line 80
