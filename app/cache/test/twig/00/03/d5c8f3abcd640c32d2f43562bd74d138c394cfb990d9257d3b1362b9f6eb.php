...
/* ApplicationSonataAdminBundle:Admin/ExtraBlocks/Comments:email_message_to_user.html.twig */
class __TwigTemplate_0003d5c8f3abcd640c32d2f43562bd74d138c394cfb990d9257d3b1362b9f6eb extends Twig_Template
{
...
";
    ...
    public function block_comments_block_email_message($context, array $blocks = array())
    {
        ...
        echo "</a> к пользователю <a href=\"http://";
        echo twig_escape_filter($this->env, (isset($context["domain"]) ? $context["domain"] : $this->getContext($context, "domain")), "html", null, true);
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_sonata_user_user_edit", array("id" => $this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "id", array()))), "html", null, true);
        echo "\">";
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "username", array()), "html", null, true);
        echo "</a>.</p>
    ...
    {
        return "ApplicationSonataAdminBundle:Admin/ExtraBlocks/Comments:email_message_to_user.html.twig";
    }
