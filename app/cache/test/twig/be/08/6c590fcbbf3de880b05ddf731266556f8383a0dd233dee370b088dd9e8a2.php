...
class __TwigTemplate_be086c590fcbbf3de880b05ddf731266556f8383a0dd233dee370b088dd9e8a2 extends Twig_Template
{
...
";
    ...
    public function block_slug_history_widget($context, array $blocks = array())
    {
        ...
        if (array_key_exists("response", $context)) {
            ...
            if ($this->getAttribute((isset($context["response"]) ? $context["response"] : null), "error", array(), "any", true, true)) {
                ...
                echo "                <div class=\"alert alert-error alert-dismissable\">
                    ...
                    ";
                // line 21
                echo twig_join_filter($this->getAttribute((isset($context["response"]) ? $context["response"] : $this->getContext($context, "response")), "error", array()), "<br>");
                echo "
                </div>
            ";
                ...
                echo "                <div class=\"alert alert-success alert-dismissable\">
                    ...
                    ";
                // line 26
                echo twig_join_filter($this->getAttribute((isset($context["response"]) ? $context["response"] : $this->getContext($context, "response")), "success", array()), "<br>");
                echo "
                </div>
            ";
            }
        ...
        // line 32
        echo twig_escape_filter($this->env, (isset($context["target_id"]) ? $context["target_id"] : $this->getContext($context, "target_id")), "html", null, true);
        ...
        echo "\">
            ...
            ";
        // line 34
        if (twig_length_filter($this->env, (isset($context["history"]) ? $context["history"] : $this->getContext($context, "history")))) {
            // line 35
            echo "
                <thead>
                    <tr>
        ...
        // line 66
        if ((array_key_exists("url", $context) && twig_length_filter($this->env, (isset($context["url"]) ? $context["url"] : $this->getContext($context, "url"))))) {
            echo "value=\"";
