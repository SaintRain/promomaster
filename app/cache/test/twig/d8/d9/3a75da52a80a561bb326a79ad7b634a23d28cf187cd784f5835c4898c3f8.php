...
class __TwigTemplate_d8d93a75da52a80a561bb326a79ad7b634a23d28cf187cd784f5835c4898c3f8 extends Twig_Template
{
...
";
    ...
    public function block_core_pre_order_admin_cancelReason_textarea_widget($context, array $blocks = array())
    {
        ...
        <div class=\"control-group\">
            ";
        // line 56
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "parent", array()), "children", array()), "preDefinedAnswers", array()), 'label');
        echo "
            <div class=\"controls sonata-ba-field sonata-ba-field-standard-natural\">
                ";
        // line 58
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "parent", array()), "children", array()), "preDefinedAnswers", array()), 'widget');
        echo "
            </div>
        </div>
        <div class=\"control-group\">
        ...
        echo "\">
            ...
            ";
        // line 71
        if ($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["sonata_admin"]) ? $context["sonata_admin"] : $this->getContext($context, "sonata_admin")), "admin", array()), "subject", array()), "isSendCancelMsg", array())) {
            // line 72
            echo "                ";
            $context["imagePrefix"] = "";
            // line 73
        ...
        echo "            <div class=\"checkbox-msg-wr\">
                ";
        // line 77
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "parent", array()), "children", array()), "isSendCancelMsg", array()), 'widget');
        echo "
                <label title=\"Нужно ли отправлять уведомление заказчику при отмене\" class=\"checkbox-label-msg\" for=\"";
        // line 78
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "parent", array()), "children", array()), "isSendCancelMsg", array()), "vars", array()), "id", array()), "html", null, true);
        echo "\"></label>
            </div>
        </div>
    </div>
...
";
    ...
    public function block_core_pre_order_admin_compositions_sonata_type_collection_widget($context, array $blocks = array())
    {
        ...
        ";
        // line 88
        if (((!$this->getAttribute($this->getAttribute($this->getAttribute((isset($context["sonata_admin"]) ? $context["sonata_admin"] : $this->getContext($context, "sonata_admin")), "admin", array()), "subject", array()), "order", array())) && (!$this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "request", array()), "isXmlHttpRequest", array(), "method")))) {
            // line 89
            echo "            <br>
            <div id=\"pre_order_cost_wr\" ";
            // line 90
            if ((!$this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["sonata_admin"]) ? $context["sonata_admin"] : $this->getContext($context, "sonata_admin")), "admin", array()), "subject", array()), "compositions", array()), "count", array()))) {
