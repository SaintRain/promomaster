...
class __TwigTemplate_7e1e51e2a250b5927c7b87087266b932a5dbebeb995e6f15c83bc93ef87c94fc extends Twig_Template
{
    ...
    ";
        ...
        if ($this->getAttribute($this->getAttribute((isset($context["unit"]) ? $context["unit"] : null), "productInSupply", array(), "any", false, true), "priceInGtdCurrency", array(), "any", true, true)) {
            ...
            // line 7
            echo twig_escape_filter($this->env, $this->env->getExtension('money_extension')->moneyFormatFunction($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["sonata_admin"]) ? $context["sonata_admin"] : $this->getContext($context, "sonata_admin")), "admin", array()), "subject", array()), "productInSupply", array()), "priceInGtdCurrency", array())), "html", null, true);
            echo " ";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["sonata_admin"]) ? $context["sonata_admin"] : $this->getContext($context, "sonata_admin")), "admin", array()), "subject", array()), "productInSupply", array()), "gtdCurrency", array()), "symbol", array()), "html", null, true);
            echo "</span></label></div>
        ...
        ";
        // line 11
        if (((!$this->getAttribute((isset($context["unit"]) ? $context["unit"] : $this->getContext($context, "unit")), "isCouldBeSold", array())) && $this->getAttribute($this->getAttribute((isset($context["unit"]) ? $context["unit"] : null), "composition", array(), "any", false, true), "order", array(), "any", true, true))) {
            // line 12
            ...
            if ($this->getAttribute($this->getAttribute((isset($context["unit"]) ? $context["unit"] : null), "composition", array(), "any", false, true), "order", array(), "any", true, true)) {
                // line 14
                echo "                (заказ <a href=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_core_order_order_edit", array("id" => $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["unit"]) ? $context["unit"] : $this->getContext($context, "unit")), "composition", array()), "order", array()), "id", array()))), "html", null, true);
                echo "\">#";
                echo twig_escape_filter($this->env, $this->env->getExtension('common_extension')->idFormatFilter($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["unit"]) ? $context["unit"] : $this->getContext($context, "unit")), "composition", array()), "order", array()), "id", array())), "html", null, true);
                echo "</a>)
            ";
            }
            // line 15
        ...
        ";
            ...
            if ($this->getAttribute($this->getAttribute((isset($context["unit"]) ? $context["unit"] : null), "composition", array(), "any", false, true), "order", array(), "any", true, true)) {
                ...
                if ($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["unit"]) ? $context["unit"] : $this->getContext($context, "unit")), "composition", array()), "order", array()), "isCanceledStatus", array())) {
            ...
            ";
                ...
                // line 21
                echo "                ";
                if ($this->getAttribute((isset($context["unit"]) ? $context["unit"] : $this->getContext($context, "unit")), "isWithDefect", array())) {
                    // line 22
                ...
                ";
                    ...
                    // line 24
                    echo "                    ";
                    if (($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["unit"]) ? $context["unit"] : $this->getContext($context, "unit")), "supply", array()), "status", array()), "name", array()) == twig_constant("Core\\LogisticsBundle\\Entity\\Supply::onTheWayStatusName"))) {
                        // line 25
                        echo "                        <span class=\"label label-info\">";
                        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["unit"]) ? $context["unit"] : $this->getContext($context, "unit")), "supply", array()), "status", array()), "captionRu", array()), "html", null, true);
                        echo "</span>
                    ";
                    } else {
                        // line 27
                        echo "                        ";
                        if (($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["unit"]) ? $context["unit"] : $this->getContext($context, "unit")), "supply", array()), "status", array()), "name", array()) == twig_constant("Core\\LogisticsBundle\\Entity\\Supply::suppliedStatusName"))) {
                            // line 28
                            echo "                            <span class=\"label label-success\">";
                            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["unit"]) ? $context["unit"] : $this->getContext($context, "unit")), "supply", array()), "status", array()), "captionRu", array()), "html", null, true);
                            echo "</span>
