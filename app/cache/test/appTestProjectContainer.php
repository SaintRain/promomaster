...
class appTestProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/home/olikids/public_html.sam/app/cache/test/annotations', false);
    }
    public function getApplactionUserMailerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            $container = $this;
            return $this->services['applaction_user_mailer'] = new ApplicationSonataUserBundleMailerMailer_0000000075bcb42400007f16bc7d975d(
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig'), $this->get('monolog.logger.assetic', ContainerInterface::NULL_ON_INVALID_REFERENCE)), new \Assetic\Cache\ConfigCache('/home/olikids/public_html.sam/app/cache/test/assetic/config'), false)));
    ...
    public function getBasicDataLogicService($lazyLoad = true)
    {
        if ($lazyLoad) {
            $container = $this;
            return $this->services['basic_data_logic'] = new CoreOfficeWorkTimeBundleLogicBasicDataLogic_0000000075bca6eb00007f16bc7d975d(
                function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) use ($container) {
    ...
    public function getCoreDelivery_CdekService($lazyLoad = true)
    {
        if ($lazyLoad) {
            $container = $this;
            return $this->services['core_delivery.cdek'] = new CoreDeliveryBundleLogicCdek_0000000075bcb76900007f16bc7d975d(
                function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) use ($container) {
    ...
    public function getCoreDelivery_DellinService($lazyLoad = true)
    {
        if ($lazyLoad) {
            $container = $this;
            return $this->services['core_delivery.dellin'] = new CoreDeliveryBundleLogicDellin_0000000075bcb76c00007f16bc7d975d(
                function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) use ($container) {
    ...
    public function getCoreDelivery_DpdService($lazyLoad = true)
    {
        if ($lazyLoad) {
            $container = $this;
            return $this->services['core_delivery.dpd'] = new CoreDeliveryBundleLogicDpd_0000000075bcb76e00007f16bc7d975d(
                function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) use ($container) {
    ...
    public function getCoreDelivery_EmsService($lazyLoad = true)
    {
        if ($lazyLoad) {
            $container = $this;
            return $this->services['core_delivery.ems'] = new CoreDeliveryBundleLogicEms_0000000075bcb77200007f16bc7d975d(
                function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) use ($container) {
    ...
    public function getCoreDelivery_EnergyService($lazyLoad = true)
    {
        if ($lazyLoad) {
            $container = $this;
            return $this->services['core_delivery.energy'] = new CoreDeliveryBundleLogicEnergy_0000000075bcb77000007f16bc7d975d(
                function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) use ($container) {
    ...
    public function getCoreDelivery_JeldorService($lazyLoad = true)
    {
        if ($lazyLoad) {
            $container = $this;
            return $this->services['core_delivery.jeldor'] = new CoreDeliveryBundleLogicJelDor_0000000075bcb77300007f16bc7d975d(
                function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) use ($container) {
    ...
    public function getCoreDelivery_PekService($lazyLoad = true)
    {
        if ($lazyLoad) {
            $container = $this;
            return $this->services['core_delivery.pek'] = new CoreDeliveryBundleLogicPek_0000000075bcb76f00007f16bc7d975d(
                function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) use ($container) {
    ...
    public function getCoreDelivery_PostruService($lazyLoad = true)
    {
        if ($lazyLoad) {
            $container = $this;
            return $this->services['core_delivery.postru'] = new CoreDeliveryBundleLogicPostRu_0000000075bcb76d00007f16bc7d975d(
                function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) use ($container) {
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_777a177ea13fdf56457d52a171a97da082d57c115566a12aa5acd3313638a06b');
        $c = new \Doctrine\Common\Cache\ApcCache();
        $c->setNamespace('sf2orm_default_777a177ea13fdf56457d52a171a97da082d57c115566a12aa5acd3313638a06b');
        $d = new \Doctrine\Common\Cache\MemcacheCache();
        $d->setMemcache($this->get('doctrine.orm.default_memcache_instance'));
        $d->setNamespace('sf2orm_default_777a177ea13fdf56457d52a171a97da082d57c115566a12aa5acd3313638a06b');
        ...
        $h->setProxyDir('/home/olikids/public_html.sam/app/cache/test/doctrine/orm/Proxies');
    ...
    protected function getDoctrine_Orm_ForceMasterEntityManagerService()
    {
        $a = $this->get('annotation_reader');
        $b = new \Doctrine\Common\Cache\ApcCache();
        $b->setNamespace('sf2orm_force_master_777a177ea13fdf56457d52a171a97da082d57c115566a12aa5acd3313638a06b');
        $c = new \Doctrine\Common\Cache\ApcCache();
        $c->setNamespace('sf2orm_force_master_777a177ea13fdf56457d52a171a97da082d57c115566a12aa5acd3313638a06b');
        $d = new \Doctrine\Common\Cache\MemcacheCache();
        $d->setMemcache($this->get('doctrine.orm.force_master_memcache_instance'));
        $d->setNamespace('sf2orm_force_master_777a177ea13fdf56457d52a171a97da082d57c115566a12aa5acd3313638a06b');
        $e = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array('/home/olikids/public_html.sam/src/Application/Sonata/UserBundle/Resources/config/doctrine' => 'Application\\Sonata\\UserBundle\\Entity', '/home/olikids/public_html.sam/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/Resources/config/doctrine' => 'FOS\\UserBundle\\Entity', '/home/olikids/public_html.sam/vendor/sonata-project/user-bundle/Sonata/UserBundle/Resources/config/doctrine' => 'Sonata\\UserBundle\\Entity'));
        $e->setGlobalBasename('mapping');
        $f = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => '/home/olikids/public_html.sam/src/Core/DirectoryBundle/Entity', 1 => '/home/olikids/public_html.sam/src/Core/FileBundle/Entity', 2 => '/home/olikids/public_html.sam/src/Core/ManufacturerBundle/Entity', 3 => '/home/olikids/public_html.sam/src/Core/CategoryBundle/Entity', 4 => '/home/olikids/public_html.sam/src/Core/OrderBundle/Entity', 5 => '/home/olikids/public_html.sam/src/Core/ProductBundle/Entity', 6 => '/home/olikids/public_html.sam/src/Core/PropertyBundle/Entity', 7 => '/home/olikids/public_html.sam/src/Core/TroubleTicketBundle/Entity', 8 => '/home/olikids/public_html.sam/src/Core/PaymentBundle/Entity', 9 => '/home/olikids/public_html.sam/src/Core/FaqBundle/Entity', 10 => '/home/olikids/public_html.sam/src/Core/UnionBundle/Entity', 11 => '/home/olikids/public_html.sam/src/Core/ColorBundle/Entity', 12 => '/home/olikids/public_html.sam/src/Core/LogisticsBundle/Entity', 13 => '/home/olikids/public_html.sam/src/Core/DeliveryBundle/Entity', 14 => '/home/olikids/public_html.sam/src/Core/DiscountsBundle/Entity', 15 => '/home/olikids/public_html.sam/src/Core/ReviewBundle/Entity', 16 => '/home/olikids/public_html.sam/src/Core/ConfigBundle/Entity', 17 => '/home/olikids/public_html.sam/src/Core/StatisticsBundle/Entity', 18 => '/home/olikids/public_html.sam/src/Core/SlugHistoryBundle/Entity', 19 => '/home/olikids/public_html.sam/src/Core/HolidayBundle/Entity', 20 => '/home/olikids/public_html.sam/src/Core/OfficeWorkTimeBundle/Entity', 21 => '/home/olikids/public_html.sam/vendor/gedmo/doctrine-extensions/lib/Gedmo/Translatable/Entity', 22 => '/home/olikids/public_html.sam/vendor/gedmo/doctrine-extensions/lib/Gedmo/Translator/Entity', 23 => '/home/olikids/public_html.sam/vendor/gedmo/doctrine-extensions/lib/Gedmo/Loggable/Entity', 24 => '/home/olikids/public_html.sam/vendor/gedmo/doctrine-extensions/lib/Gedmo/Tree/Entity'));
        $g = new \Doctrine\ORM\Mapping\Driver\DriverChain();
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/home/olikids/public_html.sam/app/cache/test/jms_diextra/metadata'));
        return $instance;
    }
    ...
    {
        return $this->services['jms_i18n_routing.loader'] = new \JMS\I18nRoutingBundle\Router\I18nLoader(new \JMS\I18nRoutingBundle\Router\DefaultRouteExclusionStrategy(), new \JMS\I18nRoutingBundle\Router\DefaultPatternGenerationStrategy('custom', $this->get('translator.default'), array(0 => 'ru'), '/home/olikids/public_html.sam/app/cache/test', 'routes', 'ru'));
    }
    ...
    protected function getLiipMonitor_RunnerService()
    {
        ...
        $instance->addCheck(new \ZendDiagnostics\Check\DiskUsage(70, 90, '/home/olikids/public_html.sam/app/cache/test'), 'disk_usage');
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/home/olikids/public_html.sam/app/logs/test.log', 400, true);
    }
    ...
    public function getOfficeWorkTimeLogicService($lazyLoad = true)
    {
        if ($lazyLoad) {
            $container = $this;
            return $this->services['office_work_time_logic'] = new CoreOfficeWorkTimeBundleLogicOfficeWorkTimeLogic_0000000075bca6ee00007f16bc7d975d(
                function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) use ($container) {
    ...
    {
        $this->services['router'] = $instance = new \JMS\I18nRoutingBundle\Router\I18nRouter($this, '/home/olikids/public_html.sam/app/config/routing.yml', array('cache_dir' => '/home/olikids/public_html.sam/app/cache/test', 'debug' => false, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appTestUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appTestUrlMatcher', 'strict_requirements' => NULL), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => $this->get('security.context_listener.0'), 2 => $i, 3 => $j, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($c, $h, $f, $b, $g), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($c, '54741a98d3ca0', $b), 6 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($c, $this->get('security.authentication.trust_resolver'), $d, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($this->get('http_kernel'), $d, '/login.html', false), NULL, NULL, $b));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/home/olikids/public_html.sam/app/cache/test/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/home/olikids/public_html.sam/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/home/olikids/public_html.sam/app/cache/test/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/home/olikids/public_html.sam/app/cache/test/translations', 'debug' => false));
        ...
        $instance->addResource('yml', '/home/olikids/public_html.sam/vendor/coresphere/console-bundle/CoreSphere/ConsoleBundle/Resources/translations/messages.ru.yml', 'ru', 'messages');
        $instance->addResource('yml', '/home/olikids/public_html.sam/vendor/coresphere/console-bundle/CoreSphere/ConsoleBundle/Resources/translations/messages.de.yml', 'de', 'messages');
        $instance->addResource('yml', '/home/olikids/public_html.sam/vendor/coresphere/console-bundle/CoreSphere/ConsoleBundle/Resources/translations/messages.pl.yml', 'pl', 'messages');
        $instance->addResource('yml', '/home/olikids/public_html.sam/vendor/coresphere/console-bundle/CoreSphere/ConsoleBundle/Resources/translations/messages.bg.yml', 'bg', 'messages');
        $instance->addResource('yml', '/home/olikids/public_html.sam/vendor/coresphere/console-bundle/CoreSphere/ConsoleBundle/Resources/translations/messages.en.yml', 'en', 'messages');
        $instance->addResource('yml', '/home/olikids/public_html.sam/vendor/coresphere/console-bundle/CoreSphere/ConsoleBundle/Resources/translations/messages.it.yml', 'it', 'messages');
        $instance->addResource('yml', '/home/olikids/public_html.sam/vendor/coresphere/console-bundle/CoreSphere/ConsoleBundle/Resources/translations/messages.fr.yml', 'fr', 'messages');
        return $instance;
    }
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/home/olikids/public_html.sam/app/cache/test/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/home/olikids/public_html.sam/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/home/olikids/public_html.sam/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/home/olikids/public_html.sam/vendor/coresphere/console-bundle/CoreSphere/ConsoleBundle/Resources/views', 'CoreSphereConsole');
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('/home/olikids/public_html.sam/app/cache/test/jms_security', false));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/home/olikids/public_html.sam/app/cache/test');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/home/olikids/public_html.sam/app/cache/test',
            ...
            'session.save_path' => '/home/olikids/public_html.sam/app/cache/test/sessions',
            ...
            'twig.options' => array(
                ...
                'cache' => '/home/olikids/public_html.sam/app/cache/test/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => '/home/olikids/public_html.sam/app/cache/test/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/home/olikids/public_html.sam/app/cache/test/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/home/olikids/public_html.sam/app/cache/test/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => '/home/olikids/public_html.sam/app/cache/test/jms_aop',
            ...
            'security.extra.cache_dir' => '/home/olikids/public_html.sam/app/cache/test/jms_security',
            ...
            'jms_di_extra.cache_dir' => '/home/olikids/public_html.sam/app/cache/test/jms_diextra',
            ...
            'core_file' => array(
                ...
                'temp_dir' => '/home/olikids/public_html.sam/app/cache/test/core_file',
                'web_dir' => 'web',
                'upload_dir' => 'uploads',
            ...
            'liip_monitor.check.disk_usage.path' => '/home/olikids/public_html.sam/app/cache/test',
...
class ApplicationSonataUserBundleMailerMailer_0000000075bcb42400007f16bc7d975d extends \Application\Sonata\UserBundle\Mailer\Mailer implements \ProxyManager\Proxy\VirtualProxyInterface
{
    private $valueHolder54741a9c2922b661537685 = null;
    private $initializer54741a9c292c0091639834 = null;
    private static $publicProperties54741a9c28c00727972247 = array(
        
    );
    public function sendEmailChangedMessage(\FOS\UserBundle\Model\UserInterface $user)
    {
        $this->initializer54741a9c292c0091639834 && $this->initializer54741a9c292c0091639834->__invoke($this->valueHolder54741a9c2922b661537685, $this, 'sendEmailChangedMessage', array('user' => $user), $this->initializer54741a9c292c0091639834);
        return $this->valueHolder54741a9c2922b661537685->sendEmailChangedMessage($user);
    }
    public function __construct($initializer)
    {
        $this->initializer54741a9c292c0091639834 = $initializer;
    }
    public function & __get($name)
    {
        $this->initializer54741a9c292c0091639834 && $this->initializer54741a9c292c0091639834->__invoke($this->valueHolder54741a9c2922b661537685, $this, '__get', array('name' => $name), $this->initializer54741a9c292c0091639834);
        if (isset(self::$publicProperties54741a9c28c00727972247[$name])) {
            return $this->valueHolder54741a9c2922b661537685->$name;
        }
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c2922b661537685;
    ...
    {
        $this->initializer54741a9c292c0091639834 && $this->initializer54741a9c292c0091639834->__invoke($this->valueHolder54741a9c2922b661537685, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer54741a9c292c0091639834);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c2922b661537685;
    ...
    {
        $this->initializer54741a9c292c0091639834 && $this->initializer54741a9c292c0091639834->__invoke($this->valueHolder54741a9c2922b661537685, $this, '__isset', array('name' => $name), $this->initializer54741a9c292c0091639834);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c2922b661537685;
    ...
    {
        $this->initializer54741a9c292c0091639834 && $this->initializer54741a9c292c0091639834->__invoke($this->valueHolder54741a9c2922b661537685, $this, '__unset', array('name' => $name), $this->initializer54741a9c292c0091639834);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c2922b661537685;
    ...
    {
        $this->initializer54741a9c292c0091639834 && $this->initializer54741a9c292c0091639834->__invoke($this->valueHolder54741a9c2922b661537685, $this, '__clone', array(), $this->initializer54741a9c292c0091639834);
        $this->valueHolder54741a9c2922b661537685 = clone $this->valueHolder54741a9c2922b661537685;
    }
    public function __sleep()
    {
        $this->initializer54741a9c292c0091639834 && $this->initializer54741a9c292c0091639834->__invoke($this->valueHolder54741a9c2922b661537685, $this, '__sleep', array(), $this->initializer54741a9c292c0091639834);
        return array('valueHolder54741a9c2922b661537685');
    }
    ...
    {
        return $this->initializer54741a9c292c0091639834;
    }
    public function initializeProxy()
    {
        return $this->initializer54741a9c292c0091639834 && $this->initializer54741a9c292c0091639834->__invoke($this->valueHolder54741a9c2922b661537685, $this, 'initializeProxy', array(), $this->initializer54741a9c292c0091639834);
    }
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder54741a9c2922b661537685;
    }
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder54741a9c2922b661537685;
    }
}
class CoreDeliveryBundleLogicCdek_0000000075bcb76900007f16bc7d975d extends \Core\DeliveryBundle\Logic\Cdek implements \ProxyManager\Proxy\VirtualProxyInterface
{
    private $valueHolder54741a9c2af73546301803 = null;
    private $initializer54741a9c2af85593459841 = null;
    private static $publicProperties54741a9c2af42168475316 = array(
        
    );
    public function getCities($options = null)
    {
        $this->initializer54741a9c2af85593459841 && $this->initializer54741a9c2af85593459841->__invoke($this->valueHolder54741a9c2af73546301803, $this, 'getCities', array('options' => $options), $this->initializer54741a9c2af85593459841);
        return $this->valueHolder54741a9c2af73546301803->getCities($options);
    }
    public function getAffiliates($options = null)
    {
        $this->initializer54741a9c2af85593459841 && $this->initializer54741a9c2af85593459841->__invoke($this->valueHolder54741a9c2af73546301803, $this, 'getAffiliates', array('options' => $options), $this->initializer54741a9c2af85593459841);
        return $this->valueHolder54741a9c2af73546301803->getAffiliates($options);
    }
    public function calculate($options)
    {
        $this->initializer54741a9c2af85593459841 && $this->initializer54741a9c2af85593459841->__invoke($this->valueHolder54741a9c2af73546301803, $this, 'calculate', array('options' => $options), $this->initializer54741a9c2af85593459841);
        return $this->valueHolder54741a9c2af73546301803->calculate($options);
    }
    public function trackPackage($options)
    {
        $this->initializer54741a9c2af85593459841 && $this->initializer54741a9c2af85593459841->__invoke($this->valueHolder54741a9c2af73546301803, $this, 'trackPackage', array('options' => $options), $this->initializer54741a9c2af85593459841);
        return $this->valueHolder54741a9c2af73546301803->trackPackage($options);
    }
    public function getInvoice($options)
    {
        $this->initializer54741a9c2af85593459841 && $this->initializer54741a9c2af85593459841->__invoke($this->valueHolder54741a9c2af73546301803, $this, 'getInvoice', array('options' => $options), $this->initializer54741a9c2af85593459841);
        return $this->valueHolder54741a9c2af73546301803->getInvoice($options);
    }
    public function createOrder($options)
    {
        $this->initializer54741a9c2af85593459841 && $this->initializer54741a9c2af85593459841->__invoke($this->valueHolder54741a9c2af73546301803, $this, 'createOrder', array('options' => $options), $this->initializer54741a9c2af85593459841);
        return $this->valueHolder54741a9c2af73546301803->createOrder($options);
    }
    public function cancelOrder($options)
    {
        $this->initializer54741a9c2af85593459841 && $this->initializer54741a9c2af85593459841->__invoke($this->valueHolder54741a9c2af73546301803, $this, 'cancelOrder', array('options' => $options), $this->initializer54741a9c2af85593459841);
        return $this->valueHolder54741a9c2af73546301803->cancelOrder($options);
    }
    public function sendRequest($data, $params = null)
    {
        $this->initializer54741a9c2af85593459841 && $this->initializer54741a9c2af85593459841->__invoke($this->valueHolder54741a9c2af73546301803, $this, 'sendRequest', array('data' => $data, 'params' => $params), $this->initializer54741a9c2af85593459841);
        return $this->valueHolder54741a9c2af73546301803->sendRequest($data, $params);
    }
    public function __construct($initializer)
    {
        $this->initializer54741a9c2af85593459841 = $initializer;
    }
    public function & __get($name)
    {
        $this->initializer54741a9c2af85593459841 && $this->initializer54741a9c2af85593459841->__invoke($this->valueHolder54741a9c2af73546301803, $this, '__get', array('name' => $name), $this->initializer54741a9c2af85593459841);
        if (isset(self::$publicProperties54741a9c2af42168475316[$name])) {
            return $this->valueHolder54741a9c2af73546301803->$name;
        }
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c2af73546301803;
            $backtrace = debug_backtrace(false);
            trigger_error('Undefined property: ' . get_parent_class($this) . '::$' . $name . ' in ' . $backtrace[0]['file'] . ' on line ' . $backtrace[0]['line'], \E_USER_NOTICE);
            return $targetObject->$name;;
            return;
    ...
    public function __set($name, $value)
    {
        $this->initializer54741a9c2af85593459841 && $this->initializer54741a9c2af85593459841->__invoke($this->valueHolder54741a9c2af73546301803, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer54741a9c2af85593459841);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c2af73546301803;
            return $targetObject->$name = $value;;
    ...
    public function __isset($name)
    {
        $this->initializer54741a9c2af85593459841 && $this->initializer54741a9c2af85593459841->__invoke($this->valueHolder54741a9c2af73546301803, $this, '__isset', array('name' => $name), $this->initializer54741a9c2af85593459841);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c2af73546301803;
            return isset($targetObject->$name);;
    ...
    public function __unset($name)
    {
        $this->initializer54741a9c2af85593459841 && $this->initializer54741a9c2af85593459841->__invoke($this->valueHolder54741a9c2af73546301803, $this, '__unset', array('name' => $name), $this->initializer54741a9c2af85593459841);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c2af73546301803;
            unset($targetObject->$name);;
    ...
    public function __clone()
    {
        $this->initializer54741a9c2af85593459841 && $this->initializer54741a9c2af85593459841->__invoke($this->valueHolder54741a9c2af73546301803, $this, '__clone', array(), $this->initializer54741a9c2af85593459841);
        $this->valueHolder54741a9c2af73546301803 = clone $this->valueHolder54741a9c2af73546301803;
    }
    public function __sleep()
    {
        $this->initializer54741a9c2af85593459841 && $this->initializer54741a9c2af85593459841->__invoke($this->valueHolder54741a9c2af73546301803, $this, '__sleep', array(), $this->initializer54741a9c2af85593459841);
        return array('valueHolder54741a9c2af73546301803');
    }
    public function __wakeup()
    {
    }
    ...
    public function getProxyInitializer()
    {
        return $this->initializer54741a9c2af85593459841;
    }
    public function initializeProxy()
    {
        return $this->initializer54741a9c2af85593459841 && $this->initializer54741a9c2af85593459841->__invoke($this->valueHolder54741a9c2af73546301803, $this, 'initializeProxy', array(), $this->initializer54741a9c2af85593459841);
    }
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder54741a9c2af73546301803;
    }
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder54741a9c2af73546301803;
    }
}
class CoreDeliveryBundleLogicDpd_0000000075bcb76e00007f16bc7d975d extends \Core\DeliveryBundle\Logic\Dpd implements \ProxyManager\Proxy\VirtualProxyInterface
{
    private $valueHolder54741a9c32770745095563 = null;
    private $initializer54741a9c32781598076022 = null;
    private static $publicProperties54741a9c3273f431591379 = array(
        
    );
    public function getCities($options = null)
    {
        $this->initializer54741a9c32781598076022 && $this->initializer54741a9c32781598076022->__invoke($this->valueHolder54741a9c32770745095563, $this, 'getCities', array('options' => $options), $this->initializer54741a9c32781598076022);
        return $this->valueHolder54741a9c32770745095563->getCities($options);
    }
    public function getAffiliates($options)
    {
        $this->initializer54741a9c32781598076022 && $this->initializer54741a9c32781598076022->__invoke($this->valueHolder54741a9c32770745095563, $this, 'getAffiliates', array('options' => $options), $this->initializer54741a9c32781598076022);
        return $this->valueHolder54741a9c32770745095563->getAffiliates($options);
    }
    public function calculate($options)
    {
        $this->initializer54741a9c32781598076022 && $this->initializer54741a9c32781598076022->__invoke($this->valueHolder54741a9c32770745095563, $this, 'calculate', array('options' => $options), $this->initializer54741a9c32781598076022);
        return $this->valueHolder54741a9c32770745095563->calculate($options);
    }
    public function trackPackage($options)
    {
        $this->initializer54741a9c32781598076022 && $this->initializer54741a9c32781598076022->__invoke($this->valueHolder54741a9c32770745095563, $this, 'trackPackage', array('options' => $options), $this->initializer54741a9c32781598076022);
        return $this->valueHolder54741a9c32770745095563->trackPackage($options);
    }
    public function getSticker($options)
    {
        $this->initializer54741a9c32781598076022 && $this->initializer54741a9c32781598076022->__invoke($this->valueHolder54741a9c32770745095563, $this, 'getSticker', array('options' => $options), $this->initializer54741a9c32781598076022);
        return $this->valueHolder54741a9c32770745095563->getSticker($options);
    }
    public function getInvoice($options)
    {
        $this->initializer54741a9c32781598076022 && $this->initializer54741a9c32781598076022->__invoke($this->valueHolder54741a9c32770745095563, $this, 'getInvoice', array('options' => $options), $this->initializer54741a9c32781598076022);
        return $this->valueHolder54741a9c32770745095563->getInvoice($options);
    }
    public function createOrder($options)
    {
        $this->initializer54741a9c32781598076022 && $this->initializer54741a9c32781598076022->__invoke($this->valueHolder54741a9c32770745095563, $this, 'createOrder', array('options' => $options), $this->initializer54741a9c32781598076022);
        return $this->valueHolder54741a9c32770745095563->createOrder($options);
    }
    public function cancelOrder($options)
    {
        $this->initializer54741a9c32781598076022 && $this->initializer54741a9c32781598076022->__invoke($this->valueHolder54741a9c32770745095563, $this, 'cancelOrder', array('options' => $options), $this->initializer54741a9c32781598076022);
        return $this->valueHolder54741a9c32770745095563->cancelOrder($options);
    }
    public function sendRequest($data, $params = null)
    {
        $this->initializer54741a9c32781598076022 && $this->initializer54741a9c32781598076022->__invoke($this->valueHolder54741a9c32770745095563, $this, 'sendRequest', array('data' => $data, 'params' => $params), $this->initializer54741a9c32781598076022);
        return $this->valueHolder54741a9c32770745095563->sendRequest($data, $params);
    }
    public function setExtraServices($extraServices, $options)
    {
        $this->initializer54741a9c32781598076022 && $this->initializer54741a9c32781598076022->__invoke($this->valueHolder54741a9c32770745095563, $this, 'setExtraServices', array('extraServices' => $extraServices, 'options' => $options), $this->initializer54741a9c32781598076022);
        return $this->valueHolder54741a9c32770745095563->setExtraServices($extraServices, $options);
    }
    public function __construct($initializer)
    {
        $this->initializer54741a9c32781598076022 = $initializer;
    }
    public function & __get($name)
    {
        $this->initializer54741a9c32781598076022 && $this->initializer54741a9c32781598076022->__invoke($this->valueHolder54741a9c32770745095563, $this, '__get', array('name' => $name), $this->initializer54741a9c32781598076022);
        if (isset(self::$publicProperties54741a9c3273f431591379[$name])) {
            return $this->valueHolder54741a9c32770745095563->$name;
        }
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c32770745095563;
            $backtrace = debug_backtrace(false);
            trigger_error('Undefined property: ' . get_parent_class($this) . '::$' . $name . ' in ' . $backtrace[0]['file'] . ' on line ' . $backtrace[0]['line'], \E_USER_NOTICE);
            return $targetObject->$name;;
            return;
    ...
    public function __set($name, $value)
    {
        $this->initializer54741a9c32781598076022 && $this->initializer54741a9c32781598076022->__invoke($this->valueHolder54741a9c32770745095563, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer54741a9c32781598076022);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c32770745095563;
            return $targetObject->$name = $value;;
    ...
    public function __isset($name)
    {
        $this->initializer54741a9c32781598076022 && $this->initializer54741a9c32781598076022->__invoke($this->valueHolder54741a9c32770745095563, $this, '__isset', array('name' => $name), $this->initializer54741a9c32781598076022);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c32770745095563;
            return isset($targetObject->$name);;
    ...
    public function __unset($name)
    {
        $this->initializer54741a9c32781598076022 && $this->initializer54741a9c32781598076022->__invoke($this->valueHolder54741a9c32770745095563, $this, '__unset', array('name' => $name), $this->initializer54741a9c32781598076022);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c32770745095563;
            unset($targetObject->$name);;
    ...
    public function __clone()
    {
        $this->initializer54741a9c32781598076022 && $this->initializer54741a9c32781598076022->__invoke($this->valueHolder54741a9c32770745095563, $this, '__clone', array(), $this->initializer54741a9c32781598076022);
        $this->valueHolder54741a9c32770745095563 = clone $this->valueHolder54741a9c32770745095563;
    }
    public function __sleep()
    {
        $this->initializer54741a9c32781598076022 && $this->initializer54741a9c32781598076022->__invoke($this->valueHolder54741a9c32770745095563, $this, '__sleep', array(), $this->initializer54741a9c32781598076022);
        return array('valueHolder54741a9c32770745095563');
    }
    public function __wakeup()
    {
    }
    ...
    public function getProxyInitializer()
    {
        return $this->initializer54741a9c32781598076022;
    }
    public function initializeProxy()
    {
        return $this->initializer54741a9c32781598076022 && $this->initializer54741a9c32781598076022->__invoke($this->valueHolder54741a9c32770745095563, $this, 'initializeProxy', array(), $this->initializer54741a9c32781598076022);
    }
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder54741a9c32770745095563;
    }
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder54741a9c32770745095563;
    }
}
class CoreDeliveryBundleLogicPek_0000000075bcb76f00007f16bc7d975d extends \Core\DeliveryBundle\Logic\Pek implements \ProxyManager\Proxy\VirtualProxyInterface
{
    private $valueHolder54741a9c38e5a230535120 = null;
    private $initializer54741a9c38e6c217095966 = null;
    private static $publicProperties54741a9c38e27651129455 = array(
        
    );
    public function getCities($options = null)
    {
        $this->initializer54741a9c38e6c217095966 && $this->initializer54741a9c38e6c217095966->__invoke($this->valueHolder54741a9c38e5a230535120, $this, 'getCities', array('options' => $options), $this->initializer54741a9c38e6c217095966);
        return $this->valueHolder54741a9c38e5a230535120->getCities($options);
    }
    public function calculate($options)
    {
        $this->initializer54741a9c38e6c217095966 && $this->initializer54741a9c38e6c217095966->__invoke($this->valueHolder54741a9c38e5a230535120, $this, 'calculate', array('options' => $options), $this->initializer54741a9c38e6c217095966);
        return $this->valueHolder54741a9c38e5a230535120->calculate($options);
    }
    public function trackPackage($options)
    {
        $this->initializer54741a9c38e6c217095966 && $this->initializer54741a9c38e6c217095966->__invoke($this->valueHolder54741a9c38e5a230535120, $this, 'trackPackage', array('options' => $options), $this->initializer54741a9c38e6c217095966);
        return $this->valueHolder54741a9c38e5a230535120->trackPackage($options);
    }
    public function sendRequest($data, $params = null)
    {
        $this->initializer54741a9c38e6c217095966 && $this->initializer54741a9c38e6c217095966->__invoke($this->valueHolder54741a9c38e5a230535120, $this, 'sendRequest', array('data' => $data, 'params' => $params), $this->initializer54741a9c38e6c217095966);
        return $this->valueHolder54741a9c38e5a230535120->sendRequest($data, $params);
    }
    public function __construct($initializer)
    {
        $this->initializer54741a9c38e6c217095966 = $initializer;
    }
    public function & __get($name)
    {
        $this->initializer54741a9c38e6c217095966 && $this->initializer54741a9c38e6c217095966->__invoke($this->valueHolder54741a9c38e5a230535120, $this, '__get', array('name' => $name), $this->initializer54741a9c38e6c217095966);
        if (isset(self::$publicProperties54741a9c38e27651129455[$name])) {
            return $this->valueHolder54741a9c38e5a230535120->$name;
        }
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c38e5a230535120;
            $backtrace = debug_backtrace(false);
            trigger_error('Undefined property: ' . get_parent_class($this) . '::$' . $name . ' in ' . $backtrace[0]['file'] . ' on line ' . $backtrace[0]['line'], \E_USER_NOTICE);
            return $targetObject->$name;;
            return;
    ...
    public function __set($name, $value)
    {
        $this->initializer54741a9c38e6c217095966 && $this->initializer54741a9c38e6c217095966->__invoke($this->valueHolder54741a9c38e5a230535120, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer54741a9c38e6c217095966);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c38e5a230535120;
            return $targetObject->$name = $value;;
    ...
    public function __isset($name)
    {
        $this->initializer54741a9c38e6c217095966 && $this->initializer54741a9c38e6c217095966->__invoke($this->valueHolder54741a9c38e5a230535120, $this, '__isset', array('name' => $name), $this->initializer54741a9c38e6c217095966);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c38e5a230535120;
            return isset($targetObject->$name);;
    ...
    public function __unset($name)
    {
        $this->initializer54741a9c38e6c217095966 && $this->initializer54741a9c38e6c217095966->__invoke($this->valueHolder54741a9c38e5a230535120, $this, '__unset', array('name' => $name), $this->initializer54741a9c38e6c217095966);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c38e5a230535120;
            unset($targetObject->$name);;
    ...
    public function __clone()
    {
        $this->initializer54741a9c38e6c217095966 && $this->initializer54741a9c38e6c217095966->__invoke($this->valueHolder54741a9c38e5a230535120, $this, '__clone', array(), $this->initializer54741a9c38e6c217095966);
        $this->valueHolder54741a9c38e5a230535120 = clone $this->valueHolder54741a9c38e5a230535120;
    }
    public function __sleep()
    {
        $this->initializer54741a9c38e6c217095966 && $this->initializer54741a9c38e6c217095966->__invoke($this->valueHolder54741a9c38e5a230535120, $this, '__sleep', array(), $this->initializer54741a9c38e6c217095966);
        return array('valueHolder54741a9c38e5a230535120');
    }
    public function __wakeup()
    {
    }
    ...
    public function getProxyInitializer()
    {
        return $this->initializer54741a9c38e6c217095966;
    }
    public function initializeProxy()
    {
        return $this->initializer54741a9c38e6c217095966 && $this->initializer54741a9c38e6c217095966->__invoke($this->valueHolder54741a9c38e5a230535120, $this, 'initializeProxy', array(), $this->initializer54741a9c38e6c217095966);
    }
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder54741a9c38e5a230535120;
    }
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder54741a9c38e5a230535120;
    }
}
class CoreDeliveryBundleLogicDellin_0000000075bcb76c00007f16bc7d975d extends \Core\DeliveryBundle\Logic\Dellin implements \ProxyManager\Proxy\VirtualProxyInterface
{
    private $valueHolder54741a9c3b35d152956653 = null;
    private $initializer54741a9c3b36f243050738 = null;
    private static $publicProperties54741a9c3b32f557258359 = array(
        
    );
    public function getCities($options = null)
    {
        $this->initializer54741a9c3b36f243050738 && $this->initializer54741a9c3b36f243050738->__invoke($this->valueHolder54741a9c3b35d152956653, $this, 'getCities', array('options' => $options), $this->initializer54741a9c3b36f243050738);
        return $this->valueHolder54741a9c3b35d152956653->getCities($options);
    }
    public function calculate($options)
    {
        $this->initializer54741a9c3b36f243050738 && $this->initializer54741a9c3b36f243050738->__invoke($this->valueHolder54741a9c3b35d152956653, $this, 'calculate', array('options' => $options), $this->initializer54741a9c3b36f243050738);
        return $this->valueHolder54741a9c3b35d152956653->calculate($options);
    }
    public function trackPackage($options)
    {
        $this->initializer54741a9c3b36f243050738 && $this->initializer54741a9c3b36f243050738->__invoke($this->valueHolder54741a9c3b35d152956653, $this, 'trackPackage', array('options' => $options), $this->initializer54741a9c3b36f243050738);
        return $this->valueHolder54741a9c3b35d152956653->trackPackage($options);
    }
    public function sendRequest($data, $params = null)
    {
        $this->initializer54741a9c3b36f243050738 && $this->initializer54741a9c3b36f243050738->__invoke($this->valueHolder54741a9c3b35d152956653, $this, 'sendRequest', array('data' => $data, 'params' => $params), $this->initializer54741a9c3b36f243050738);
        return $this->valueHolder54741a9c3b35d152956653->sendRequest($data, $params);
    }
    public function __construct($initializer)
    {
        $this->initializer54741a9c3b36f243050738 = $initializer;
    }
    public function & __get($name)
    {
        $this->initializer54741a9c3b36f243050738 && $this->initializer54741a9c3b36f243050738->__invoke($this->valueHolder54741a9c3b35d152956653, $this, '__get', array('name' => $name), $this->initializer54741a9c3b36f243050738);
        if (isset(self::$publicProperties54741a9c3b32f557258359[$name])) {
            return $this->valueHolder54741a9c3b35d152956653->$name;
        }
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c3b35d152956653;
            $backtrace = debug_backtrace(false);
            trigger_error('Undefined property: ' . get_parent_class($this) . '::$' . $name . ' in ' . $backtrace[0]['file'] . ' on line ' . $backtrace[0]['line'], \E_USER_NOTICE);
            return $targetObject->$name;;
            return;
    ...
    public function __set($name, $value)
    {
        $this->initializer54741a9c3b36f243050738 && $this->initializer54741a9c3b36f243050738->__invoke($this->valueHolder54741a9c3b35d152956653, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer54741a9c3b36f243050738);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c3b35d152956653;
            return $targetObject->$name = $value;;
    ...
    public function __isset($name)
    {
        $this->initializer54741a9c3b36f243050738 && $this->initializer54741a9c3b36f243050738->__invoke($this->valueHolder54741a9c3b35d152956653, $this, '__isset', array('name' => $name), $this->initializer54741a9c3b36f243050738);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c3b35d152956653;
            return isset($targetObject->$name);;
    ...
    public function __unset($name)
    {
        $this->initializer54741a9c3b36f243050738 && $this->initializer54741a9c3b36f243050738->__invoke($this->valueHolder54741a9c3b35d152956653, $this, '__unset', array('name' => $name), $this->initializer54741a9c3b36f243050738);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c3b35d152956653;
            unset($targetObject->$name);;
    ...
    public function __clone()
    {
        $this->initializer54741a9c3b36f243050738 && $this->initializer54741a9c3b36f243050738->__invoke($this->valueHolder54741a9c3b35d152956653, $this, '__clone', array(), $this->initializer54741a9c3b36f243050738);
        $this->valueHolder54741a9c3b35d152956653 = clone $this->valueHolder54741a9c3b35d152956653;
    }
    public function __sleep()
    {
        $this->initializer54741a9c3b36f243050738 && $this->initializer54741a9c3b36f243050738->__invoke($this->valueHolder54741a9c3b35d152956653, $this, '__sleep', array(), $this->initializer54741a9c3b36f243050738);
        return array('valueHolder54741a9c3b35d152956653');
    }
    public function __wakeup()
    {
    }
    ...
    public function getProxyInitializer()
    {
        return $this->initializer54741a9c3b36f243050738;
    }
    public function initializeProxy()
    {
        return $this->initializer54741a9c3b36f243050738 && $this->initializer54741a9c3b36f243050738->__invoke($this->valueHolder54741a9c3b35d152956653, $this, 'initializeProxy', array(), $this->initializer54741a9c3b36f243050738);
    }
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder54741a9c3b35d152956653;
    }
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder54741a9c3b35d152956653;
    }
}
class CoreDeliveryBundleLogicPostRu_0000000075bcb76d00007f16bc7d975d extends \Core\DeliveryBundle\Logic\PostRu implements \ProxyManager\Proxy\VirtualProxyInterface
{
    private $valueHolder54741a9c3d3ac115755821 = null;
    private $initializer54741a9c3d3c0644518355 = null;
    private static $publicProperties54741a9c3d372998228742 = array(
        
    );
    public function getCities($options = null)
    {
        $this->initializer54741a9c3d3c0644518355 && $this->initializer54741a9c3d3c0644518355->__invoke($this->valueHolder54741a9c3d3ac115755821, $this, 'getCities', array('options' => $options), $this->initializer54741a9c3d3c0644518355);
        return $this->valueHolder54741a9c3d3ac115755821->getCities($options);
    }
    public function calculate($options)
    {
        $this->initializer54741a9c3d3c0644518355 && $this->initializer54741a9c3d3c0644518355->__invoke($this->valueHolder54741a9c3d3ac115755821, $this, 'calculate', array('options' => $options), $this->initializer54741a9c3d3c0644518355);
        return $this->valueHolder54741a9c3d3ac115755821->calculate($options);
    }
    public function trackPackage($options)
    {
        $this->initializer54741a9c3d3c0644518355 && $this->initializer54741a9c3d3c0644518355->__invoke($this->valueHolder54741a9c3d3ac115755821, $this, 'trackPackage', array('options' => $options), $this->initializer54741a9c3d3c0644518355);
        return $this->valueHolder54741a9c3d3ac115755821->trackPackage($options);
    }
    public function sendRequest($data, $params = null)
    {
        $this->initializer54741a9c3d3c0644518355 && $this->initializer54741a9c3d3c0644518355->__invoke($this->valueHolder54741a9c3d3ac115755821, $this, 'sendRequest', array('data' => $data, 'params' => $params), $this->initializer54741a9c3d3c0644518355);
        return $this->valueHolder54741a9c3d3ac115755821->sendRequest($data, $params);
    }
    public function __construct($initializer)
    {
        $this->initializer54741a9c3d3c0644518355 = $initializer;
    }
    public function & __get($name)
    {
        $this->initializer54741a9c3d3c0644518355 && $this->initializer54741a9c3d3c0644518355->__invoke($this->valueHolder54741a9c3d3ac115755821, $this, '__get', array('name' => $name), $this->initializer54741a9c3d3c0644518355);
        if (isset(self::$publicProperties54741a9c3d372998228742[$name])) {
            return $this->valueHolder54741a9c3d3ac115755821->$name;
        }
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c3d3ac115755821;
            $backtrace = debug_backtrace(false);
            trigger_error('Undefined property: ' . get_parent_class($this) . '::$' . $name . ' in ' . $backtrace[0]['file'] . ' on line ' . $backtrace[0]['line'], \E_USER_NOTICE);
            return $targetObject->$name;;
            return;
    ...
    public function __set($name, $value)
    {
        $this->initializer54741a9c3d3c0644518355 && $this->initializer54741a9c3d3c0644518355->__invoke($this->valueHolder54741a9c3d3ac115755821, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer54741a9c3d3c0644518355);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c3d3ac115755821;
            return $targetObject->$name = $value;;
    ...
    public function __isset($name)
    {
        $this->initializer54741a9c3d3c0644518355 && $this->initializer54741a9c3d3c0644518355->__invoke($this->valueHolder54741a9c3d3ac115755821, $this, '__isset', array('name' => $name), $this->initializer54741a9c3d3c0644518355);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c3d3ac115755821;
            return isset($targetObject->$name);;
    ...
    public function __unset($name)
    {
        $this->initializer54741a9c3d3c0644518355 && $this->initializer54741a9c3d3c0644518355->__invoke($this->valueHolder54741a9c3d3ac115755821, $this, '__unset', array('name' => $name), $this->initializer54741a9c3d3c0644518355);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c3d3ac115755821;
            unset($targetObject->$name);;
    ...
    public function __clone()
    {
        $this->initializer54741a9c3d3c0644518355 && $this->initializer54741a9c3d3c0644518355->__invoke($this->valueHolder54741a9c3d3ac115755821, $this, '__clone', array(), $this->initializer54741a9c3d3c0644518355);
        $this->valueHolder54741a9c3d3ac115755821 = clone $this->valueHolder54741a9c3d3ac115755821;
    }
    public function __sleep()
    {
        $this->initializer54741a9c3d3c0644518355 && $this->initializer54741a9c3d3c0644518355->__invoke($this->valueHolder54741a9c3d3ac115755821, $this, '__sleep', array(), $this->initializer54741a9c3d3c0644518355);
        return array('valueHolder54741a9c3d3ac115755821');
    }
    public function __wakeup()
    {
    }
    ...
    public function getProxyInitializer()
    {
        return $this->initializer54741a9c3d3c0644518355;
    }
    public function initializeProxy()
    {
        return $this->initializer54741a9c3d3c0644518355 && $this->initializer54741a9c3d3c0644518355->__invoke($this->valueHolder54741a9c3d3ac115755821, $this, 'initializeProxy', array(), $this->initializer54741a9c3d3c0644518355);
    }
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder54741a9c3d3ac115755821;
    }
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder54741a9c3d3ac115755821;
    }
}
class CoreDeliveryBundleLogicEms_0000000075bcb77200007f16bc7d975d extends \Core\DeliveryBundle\Logic\Ems implements \ProxyManager\Proxy\VirtualProxyInterface
{
    private $valueHolder54741a9c40119416304815 = null;
    private $initializer54741a9c4012b897077061 = null;
    private static $publicProperties54741a9c400eb595086403 = array(
        
    );
    public function getCities($options = null)
    {
        $this->initializer54741a9c4012b897077061 && $this->initializer54741a9c4012b897077061->__invoke($this->valueHolder54741a9c40119416304815, $this, 'getCities', array('options' => $options), $this->initializer54741a9c4012b897077061);
        return $this->valueHolder54741a9c40119416304815->getCities($options);
    }
    public function calculate($options)
    {
        $this->initializer54741a9c4012b897077061 && $this->initializer54741a9c4012b897077061->__invoke($this->valueHolder54741a9c40119416304815, $this, 'calculate', array('options' => $options), $this->initializer54741a9c4012b897077061);
        return $this->valueHolder54741a9c40119416304815->calculate($options);
    }
    public function trackPackage($options)
    {
        $this->initializer54741a9c4012b897077061 && $this->initializer54741a9c4012b897077061->__invoke($this->valueHolder54741a9c40119416304815, $this, 'trackPackage', array('options' => $options), $this->initializer54741a9c4012b897077061);
        return $this->valueHolder54741a9c40119416304815->trackPackage($options);
    }
    public function sendRequest($data, $params = null)
    {
        $this->initializer54741a9c4012b897077061 && $this->initializer54741a9c4012b897077061->__invoke($this->valueHolder54741a9c40119416304815, $this, 'sendRequest', array('data' => $data, 'params' => $params), $this->initializer54741a9c4012b897077061);
        return $this->valueHolder54741a9c40119416304815->sendRequest($data, $params);
    }
    public function __construct($initializer)
    {
        $this->initializer54741a9c4012b897077061 = $initializer;
    }
    public function & __get($name)
    {
        $this->initializer54741a9c4012b897077061 && $this->initializer54741a9c4012b897077061->__invoke($this->valueHolder54741a9c40119416304815, $this, '__get', array('name' => $name), $this->initializer54741a9c4012b897077061);
        if (isset(self::$publicProperties54741a9c400eb595086403[$name])) {
            return $this->valueHolder54741a9c40119416304815->$name;
        }
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c40119416304815;
            $backtrace = debug_backtrace(false);
            trigger_error('Undefined property: ' . get_parent_class($this) . '::$' . $name . ' in ' . $backtrace[0]['file'] . ' on line ' . $backtrace[0]['line'], \E_USER_NOTICE);
            return $targetObject->$name;;
            return;
    ...
    public function __set($name, $value)
    {
        $this->initializer54741a9c4012b897077061 && $this->initializer54741a9c4012b897077061->__invoke($this->valueHolder54741a9c40119416304815, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer54741a9c4012b897077061);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c40119416304815;
            return $targetObject->$name = $value;;
    ...
    public function __isset($name)
    {
        $this->initializer54741a9c4012b897077061 && $this->initializer54741a9c4012b897077061->__invoke($this->valueHolder54741a9c40119416304815, $this, '__isset', array('name' => $name), $this->initializer54741a9c4012b897077061);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c40119416304815;
            return isset($targetObject->$name);;
    ...
    public function __unset($name)
    {
        $this->initializer54741a9c4012b897077061 && $this->initializer54741a9c4012b897077061->__invoke($this->valueHolder54741a9c40119416304815, $this, '__unset', array('name' => $name), $this->initializer54741a9c4012b897077061);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c40119416304815;
            unset($targetObject->$name);;
    ...
    public function __clone()
    {
        $this->initializer54741a9c4012b897077061 && $this->initializer54741a9c4012b897077061->__invoke($this->valueHolder54741a9c40119416304815, $this, '__clone', array(), $this->initializer54741a9c4012b897077061);
        $this->valueHolder54741a9c40119416304815 = clone $this->valueHolder54741a9c40119416304815;
    }
    public function __sleep()
    {
        $this->initializer54741a9c4012b897077061 && $this->initializer54741a9c4012b897077061->__invoke($this->valueHolder54741a9c40119416304815, $this, '__sleep', array(), $this->initializer54741a9c4012b897077061);
        return array('valueHolder54741a9c40119416304815');
    }
    public function __wakeup()
    {
    }
    ...
    public function getProxyInitializer()
    {
        return $this->initializer54741a9c4012b897077061;
    }
    public function initializeProxy()
    {
        return $this->initializer54741a9c4012b897077061 && $this->initializer54741a9c4012b897077061->__invoke($this->valueHolder54741a9c40119416304815, $this, 'initializeProxy', array(), $this->initializer54741a9c4012b897077061);
    }
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder54741a9c40119416304815;
    }
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder54741a9c40119416304815;
    }
}
class CoreDeliveryBundleLogicJelDor_0000000075bcb77300007f16bc7d975d extends \Core\DeliveryBundle\Logic\JelDor implements \ProxyManager\Proxy\VirtualProxyInterface
{
    private $valueHolder54741a9c4214e902897821 = null;
    private $initializer54741a9c42160118528992 = null;
    private static $publicProperties54741a9c42120402416365 = array(
        
    );
    public function getCities($options = null)
    {
        $this->initializer54741a9c42160118528992 && $this->initializer54741a9c42160118528992->__invoke($this->valueHolder54741a9c4214e902897821, $this, 'getCities', array('options' => $options), $this->initializer54741a9c42160118528992);
        return $this->valueHolder54741a9c4214e902897821->getCities($options);
    }
    public function calculate($options)
    {
        $this->initializer54741a9c42160118528992 && $this->initializer54741a9c42160118528992->__invoke($this->valueHolder54741a9c4214e902897821, $this, 'calculate', array('options' => $options), $this->initializer54741a9c42160118528992);
        return $this->valueHolder54741a9c4214e902897821->calculate($options);
    }
    public function trackPackage($options)
    {
        $this->initializer54741a9c42160118528992 && $this->initializer54741a9c42160118528992->__invoke($this->valueHolder54741a9c4214e902897821, $this, 'trackPackage', array('options' => $options), $this->initializer54741a9c42160118528992);
        return $this->valueHolder54741a9c4214e902897821->trackPackage($options);
    }
    public function sendRequest($data, $params = null)
    {
        $this->initializer54741a9c42160118528992 && $this->initializer54741a9c42160118528992->__invoke($this->valueHolder54741a9c4214e902897821, $this, 'sendRequest', array('data' => $data, 'params' => $params), $this->initializer54741a9c42160118528992);
        return $this->valueHolder54741a9c4214e902897821->sendRequest($data, $params);
    }
    public function __construct($initializer)
    {
        $this->initializer54741a9c42160118528992 = $initializer;
    }
    public function & __get($name)
    {
        $this->initializer54741a9c42160118528992 && $this->initializer54741a9c42160118528992->__invoke($this->valueHolder54741a9c4214e902897821, $this, '__get', array('name' => $name), $this->initializer54741a9c42160118528992);
        if (isset(self::$publicProperties54741a9c42120402416365[$name])) {
            return $this->valueHolder54741a9c4214e902897821->$name;
        }
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c4214e902897821;
            $backtrace = debug_backtrace(false);
            trigger_error('Undefined property: ' . get_parent_class($this) . '::$' . $name . ' in ' . $backtrace[0]['file'] . ' on line ' . $backtrace[0]['line'], \E_USER_NOTICE);
            return $targetObject->$name;;
            return;
    ...
    public function __set($name, $value)
    {
        $this->initializer54741a9c42160118528992 && $this->initializer54741a9c42160118528992->__invoke($this->valueHolder54741a9c4214e902897821, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer54741a9c42160118528992);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c4214e902897821;
            return $targetObject->$name = $value;;
    ...
    public function __isset($name)
    {
        $this->initializer54741a9c42160118528992 && $this->initializer54741a9c42160118528992->__invoke($this->valueHolder54741a9c4214e902897821, $this, '__isset', array('name' => $name), $this->initializer54741a9c42160118528992);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c4214e902897821;
            return isset($targetObject->$name);;
    ...
    public function __unset($name)
    {
        $this->initializer54741a9c42160118528992 && $this->initializer54741a9c42160118528992->__invoke($this->valueHolder54741a9c4214e902897821, $this, '__unset', array('name' => $name), $this->initializer54741a9c42160118528992);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c4214e902897821;
            unset($targetObject->$name);;
    ...
    public function __clone()
    {
        $this->initializer54741a9c42160118528992 && $this->initializer54741a9c42160118528992->__invoke($this->valueHolder54741a9c4214e902897821, $this, '__clone', array(), $this->initializer54741a9c42160118528992);
        $this->valueHolder54741a9c4214e902897821 = clone $this->valueHolder54741a9c4214e902897821;
    }
    public function __sleep()
    {
        $this->initializer54741a9c42160118528992 && $this->initializer54741a9c42160118528992->__invoke($this->valueHolder54741a9c4214e902897821, $this, '__sleep', array(), $this->initializer54741a9c42160118528992);
        return array('valueHolder54741a9c4214e902897821');
    }
    public function __wakeup()
    {
    }
    ...
    public function getProxyInitializer()
    {
        return $this->initializer54741a9c42160118528992;
    }
    public function initializeProxy()
    {
        return $this->initializer54741a9c42160118528992 && $this->initializer54741a9c42160118528992->__invoke($this->valueHolder54741a9c4214e902897821, $this, 'initializeProxy', array(), $this->initializer54741a9c42160118528992);
    }
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder54741a9c4214e902897821;
    }
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder54741a9c4214e902897821;
    }
}
class CoreDeliveryBundleLogicEnergy_0000000075bcb77000007f16bc7d975d extends \Core\DeliveryBundle\Logic\Energy implements \ProxyManager\Proxy\VirtualProxyInterface
{
    private $valueHolder54741a9c4406e881349813 = null;
    private $initializer54741a9c44081540975117 = null;
    private static $publicProperties54741a9c4403b635930626 = array(
        
    );
    public function getCities($options = null)
    {
        $this->initializer54741a9c44081540975117 && $this->initializer54741a9c44081540975117->__invoke($this->valueHolder54741a9c4406e881349813, $this, 'getCities', array('options' => $options), $this->initializer54741a9c44081540975117);
        return $this->valueHolder54741a9c4406e881349813->getCities($options);
    }
    public function calculate($options)
    {
        $this->initializer54741a9c44081540975117 && $this->initializer54741a9c44081540975117->__invoke($this->valueHolder54741a9c4406e881349813, $this, 'calculate', array('options' => $options), $this->initializer54741a9c44081540975117);
        return $this->valueHolder54741a9c4406e881349813->calculate($options);
    }
    public function trackPackage($options)
    {
        $this->initializer54741a9c44081540975117 && $this->initializer54741a9c44081540975117->__invoke($this->valueHolder54741a9c4406e881349813, $this, 'trackPackage', array('options' => $options), $this->initializer54741a9c44081540975117);
        return $this->valueHolder54741a9c4406e881349813->trackPackage($options);
    }
    public function sendRequest($data, $params = null)
    {
        $this->initializer54741a9c44081540975117 && $this->initializer54741a9c44081540975117->__invoke($this->valueHolder54741a9c4406e881349813, $this, 'sendRequest', array('data' => $data, 'params' => $params), $this->initializer54741a9c44081540975117);
        return $this->valueHolder54741a9c4406e881349813->sendRequest($data, $params);
    }
    public function __construct($initializer)
    {
        $this->initializer54741a9c44081540975117 = $initializer;
    }
    public function & __get($name)
    {
        $this->initializer54741a9c44081540975117 && $this->initializer54741a9c44081540975117->__invoke($this->valueHolder54741a9c4406e881349813, $this, '__get', array('name' => $name), $this->initializer54741a9c44081540975117);
        if (isset(self::$publicProperties54741a9c4403b635930626[$name])) {
            return $this->valueHolder54741a9c4406e881349813->$name;
        }
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c4406e881349813;
            $backtrace = debug_backtrace(false);
            trigger_error('Undefined property: ' . get_parent_class($this) . '::$' . $name . ' in ' . $backtrace[0]['file'] . ' on line ' . $backtrace[0]['line'], \E_USER_NOTICE);
            return $targetObject->$name;;
            return;
    ...
    public function __set($name, $value)
    {
        $this->initializer54741a9c44081540975117 && $this->initializer54741a9c44081540975117->__invoke($this->valueHolder54741a9c4406e881349813, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer54741a9c44081540975117);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c4406e881349813;
            return $targetObject->$name = $value;;
    ...
    public function __isset($name)
    {
        $this->initializer54741a9c44081540975117 && $this->initializer54741a9c44081540975117->__invoke($this->valueHolder54741a9c4406e881349813, $this, '__isset', array('name' => $name), $this->initializer54741a9c44081540975117);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c4406e881349813;
            return isset($targetObject->$name);;
    ...
    public function __unset($name)
    {
        $this->initializer54741a9c44081540975117 && $this->initializer54741a9c44081540975117->__invoke($this->valueHolder54741a9c4406e881349813, $this, '__unset', array('name' => $name), $this->initializer54741a9c44081540975117);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c4406e881349813;
            unset($targetObject->$name);;
    ...
    public function __clone()
    {
        $this->initializer54741a9c44081540975117 && $this->initializer54741a9c44081540975117->__invoke($this->valueHolder54741a9c4406e881349813, $this, '__clone', array(), $this->initializer54741a9c44081540975117);
        $this->valueHolder54741a9c4406e881349813 = clone $this->valueHolder54741a9c4406e881349813;
    }
    public function __sleep()
    {
        $this->initializer54741a9c44081540975117 && $this->initializer54741a9c44081540975117->__invoke($this->valueHolder54741a9c4406e881349813, $this, '__sleep', array(), $this->initializer54741a9c44081540975117);
        return array('valueHolder54741a9c4406e881349813');
    }
    public function __wakeup()
    {
    }
    ...
    public function getProxyInitializer()
    {
        return $this->initializer54741a9c44081540975117;
    }
    public function initializeProxy()
    {
        return $this->initializer54741a9c44081540975117 && $this->initializer54741a9c44081540975117->__invoke($this->valueHolder54741a9c4406e881349813, $this, 'initializeProxy', array(), $this->initializer54741a9c44081540975117);
    }
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder54741a9c4406e881349813;
    }
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder54741a9c4406e881349813;
    }
}
class CoreOfficeWorkTimeBundleLogicBasicDataLogic_0000000075bca6eb00007f16bc7d975d extends \Core\OfficeWorkTimeBundle\Logic\BasicDataLogic implements \ProxyManager\Proxy\VirtualProxyInterface
{
    private $valueHolder54741a9c46059132368924 = null;
    private $initializer54741a9c46072098412190 = null;
    private static $publicProperties54741a9c46011934316160 = array(
        
    );
    public function getSchedule()
    {
        $this->initializer54741a9c46072098412190 && $this->initializer54741a9c46072098412190->__invoke($this->valueHolder54741a9c46059132368924, $this, 'getSchedule', array(), $this->initializer54741a9c46072098412190);
        return $this->valueHolder54741a9c46059132368924->getSchedule();
    }
    public function sendRequest(array $data)
    {
        $this->initializer54741a9c46072098412190 && $this->initializer54741a9c46072098412190->__invoke($this->valueHolder54741a9c46059132368924, $this, 'sendRequest', array('data' => $data), $this->initializer54741a9c46072098412190);
        return $this->valueHolder54741a9c46059132368924->sendRequest($data);
    }
    public function __construct($initializer)
    {
        $this->initializer54741a9c46072098412190 = $initializer;
    }
    public function & __get($name)
    {
        $this->initializer54741a9c46072098412190 && $this->initializer54741a9c46072098412190->__invoke($this->valueHolder54741a9c46059132368924, $this, '__get', array('name' => $name), $this->initializer54741a9c46072098412190);
        if (isset(self::$publicProperties54741a9c46011934316160[$name])) {
            return $this->valueHolder54741a9c46059132368924->$name;
        }
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c46059132368924;
            $backtrace = debug_backtrace(false);
            trigger_error('Undefined property: ' . get_parent_class($this) . '::$' . $name . ' in ' . $backtrace[0]['file'] . ' on line ' . $backtrace[0]['line'], \E_USER_NOTICE);
            return $targetObject->$name;;
            return;
    ...
    public function __set($name, $value)
    {
        $this->initializer54741a9c46072098412190 && $this->initializer54741a9c46072098412190->__invoke($this->valueHolder54741a9c46059132368924, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer54741a9c46072098412190);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c46059132368924;
            return $targetObject->$name = $value;;
    ...
    public function __isset($name)
    {
        $this->initializer54741a9c46072098412190 && $this->initializer54741a9c46072098412190->__invoke($this->valueHolder54741a9c46059132368924, $this, '__isset', array('name' => $name), $this->initializer54741a9c46072098412190);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c46059132368924;
            return isset($targetObject->$name);;
    ...
    public function __unset($name)
    {
        $this->initializer54741a9c46072098412190 && $this->initializer54741a9c46072098412190->__invoke($this->valueHolder54741a9c46059132368924, $this, '__unset', array('name' => $name), $this->initializer54741a9c46072098412190);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c46059132368924;
            unset($targetObject->$name);;
    ...
    public function __clone()
    {
        $this->initializer54741a9c46072098412190 && $this->initializer54741a9c46072098412190->__invoke($this->valueHolder54741a9c46059132368924, $this, '__clone', array(), $this->initializer54741a9c46072098412190);
        $this->valueHolder54741a9c46059132368924 = clone $this->valueHolder54741a9c46059132368924;
    }
    public function __sleep()
    {
        $this->initializer54741a9c46072098412190 && $this->initializer54741a9c46072098412190->__invoke($this->valueHolder54741a9c46059132368924, $this, '__sleep', array(), $this->initializer54741a9c46072098412190);
        return array('valueHolder54741a9c46059132368924');
    }
    public function __wakeup()
    {
    }
    ...
    public function getProxyInitializer()
    {
        return $this->initializer54741a9c46072098412190;
    }
    public function initializeProxy()
    {
        return $this->initializer54741a9c46072098412190 && $this->initializer54741a9c46072098412190->__invoke($this->valueHolder54741a9c46059132368924, $this, 'initializeProxy', array(), $this->initializer54741a9c46072098412190);
    }
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder54741a9c46059132368924;
    }
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder54741a9c46059132368924;
    }
}
class CoreOfficeWorkTimeBundleLogicOfficeWorkTimeLogic_0000000075bca6ee00007f16bc7d975d extends \Core\OfficeWorkTimeBundle\Logic\OfficeWorkTimeLogic implements \ProxyManager\Proxy\VirtualProxyInterface
{
    private $valueHolder54741a9c470ea466397334 = null;
    private $initializer54741a9c470fc245864650 = null;
    private static $publicProperties54741a9c470bb557805910 = array(
        
    );
    public function getSchedule()
    {
        $this->initializer54741a9c470fc245864650 && $this->initializer54741a9c470fc245864650->__invoke($this->valueHolder54741a9c470ea466397334, $this, 'getSchedule', array(), $this->initializer54741a9c470fc245864650);
        return $this->valueHolder54741a9c470ea466397334->getSchedule();
    }
    public function getState()
    {
        $this->initializer54741a9c470fc245864650 && $this->initializer54741a9c470fc245864650->__invoke($this->valueHolder54741a9c470ea466397334, $this, 'getState', array(), $this->initializer54741a9c470fc245864650);
        return $this->valueHolder54741a9c470ea466397334->getState();
    }
    public function __construct($initializer)
    {
        $this->initializer54741a9c470fc245864650 = $initializer;
    }
    public function & __get($name)
    {
        $this->initializer54741a9c470fc245864650 && $this->initializer54741a9c470fc245864650->__invoke($this->valueHolder54741a9c470ea466397334, $this, '__get', array('name' => $name), $this->initializer54741a9c470fc245864650);
        if (isset(self::$publicProperties54741a9c470bb557805910[$name])) {
            return $this->valueHolder54741a9c470ea466397334->$name;
        }
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c470ea466397334;
            $backtrace = debug_backtrace(false);
            trigger_error('Undefined property: ' . get_parent_class($this) . '::$' . $name . ' in ' . $backtrace[0]['file'] . ' on line ' . $backtrace[0]['line'], \E_USER_NOTICE);
            return $targetObject->$name;;
            return;
    ...
    public function __set($name, $value)
    {
        $this->initializer54741a9c470fc245864650 && $this->initializer54741a9c470fc245864650->__invoke($this->valueHolder54741a9c470ea466397334, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer54741a9c470fc245864650);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c470ea466397334;
            return $targetObject->$name = $value;;
    ...
    public function __isset($name)
    {
        $this->initializer54741a9c470fc245864650 && $this->initializer54741a9c470fc245864650->__invoke($this->valueHolder54741a9c470ea466397334, $this, '__isset', array('name' => $name), $this->initializer54741a9c470fc245864650);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c470ea466397334;
            return isset($targetObject->$name);;
    ...
    public function __unset($name)
    {
        $this->initializer54741a9c470fc245864650 && $this->initializer54741a9c470fc245864650->__invoke($this->valueHolder54741a9c470ea466397334, $this, '__unset', array('name' => $name), $this->initializer54741a9c470fc245864650);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder54741a9c470ea466397334;
            unset($targetObject->$name);;
    ...
    public function __clone()
    {
        $this->initializer54741a9c470fc245864650 && $this->initializer54741a9c470fc245864650->__invoke($this->valueHolder54741a9c470ea466397334, $this, '__clone', array(), $this->initializer54741a9c470fc245864650);
        $this->valueHolder54741a9c470ea466397334 = clone $this->valueHolder54741a9c470ea466397334;
    }
    public function __sleep()
    {
        $this->initializer54741a9c470fc245864650 && $this->initializer54741a9c470fc245864650->__invoke($this->valueHolder54741a9c470ea466397334, $this, '__sleep', array(), $this->initializer54741a9c470fc245864650);
        return array('valueHolder54741a9c470ea466397334');
    }
    public function __wakeup()
    {
    }
    ...
    public function getProxyInitializer()
    {
        return $this->initializer54741a9c470fc245864650;
    }
    public function initializeProxy()
    {
        return $this->initializer54741a9c470fc245864650 && $this->initializer54741a9c470fc245864650->__invoke($this->valueHolder54741a9c470ea466397334, $this, 'initializeProxy', array(), $this->initializer54741a9c470fc245864650);
    }
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder54741a9c470ea466397334;
    }
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder54741a9c470ea466397334;
    }
}
