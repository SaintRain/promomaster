 ...
 */
class SiteCategory extends \Core\CategoryBundle\Entity\SiteCategory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'parent', 'childrens', 'slug', 'id', 'lft', 'lvl', 'rgt', 'root', 'indexPosition', 'createdDateTime', 'isEnabled', 'name', 'captionRu', 'captionEn');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SiteCategory $proxy) {
