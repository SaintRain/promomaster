...
class __TwigTemplate_94851194f90a3a67bd7ca24a339aa5dad6590b4f16de840fe9919f93b6b1b306 extends Twig_Template
{
...
<p>-- <br />С вопросами и предложениями обращайтесь через форму <a href=\"";
        // line 16
        echo twig_escape_filter($this->env, (isset($context["contactsLink"]) ? $context["contactsLink"] : $this->getContext($context, "contactsLink")), "html", null, true);
        echo "\">обратной связи</a></p>

<p>С уважением и наилучшими пожеланиями,</p>
<p>команда ";
        // line 19
        echo twig_escape_filter($this->env, (isset($context["base_url"]) ? $context["base_url"] : $this->getContext($context, "base_url")), "html", null, true);
        echo "</p>
";
        // line 20
