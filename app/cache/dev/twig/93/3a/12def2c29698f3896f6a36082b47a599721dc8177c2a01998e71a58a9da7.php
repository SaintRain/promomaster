...
class __TwigTemplate_933a12def2c29698f3896f6a36082b47a599721dc8177c2a01998e71a58a9da7 extends Twig_Template
{
    ...
    ";
        // line 9
        $context["user"] = $this->getAttribute($this->getAttribute((isset($context["order"]) ? $context["order"] : $this->getContext($context, "order")), "contragent", array()), "user", array());
        // line 10
        echo "    <p style=\"width:700px\">";
        // line 11
        echo "";
        echo "Здравствуйте";
        echo twig_escape_filter($this->env, (isset($context["helloPrefix"]) ? $context["helloPrefix"] : $this->getContext($context, "helloPrefix")), "html", null, true);
        echo " Ваш заказ принят.<br>
        ";
        // line 15
        echo "";
        echo "Статус заказа вы можете отследить в личном кабинете на странице: <a href=\"";
        echo twig_escape_filter($this->env, (isset($context["urlOrder"]) ? $context["urlOrder"] : $this->getContext($context, "urlOrder")), "html", null, true);
        echo "\" target=\"_blank\">";
        echo twig_escape_filter($this->env, (isset($context["urlOrder"]) ? $context["urlOrder"] : $this->getContext($context, "urlOrder")), "html", null, true);
        echo "</a><br>
        ...
        ";
        // line 17
        if ((isset($context["payUrl"]) ? $context["payUrl"] : $this->getContext($context, "payUrl"))) {
            // line 18
            echo "            <br/><a href=\"";
            echo twig_escape_filter($this->env, (isset($context["payUrl"]) ? $context["payUrl"] : $this->getContext($context, "payUrl")), "html", null, true);
            ...
            // line 20
            echo "                ";
            if ((isset($context["attachment"]) ? $context["attachment"] : $this->getContext($context, "attachment"))) {
                // line 21
                echo "";
    ...
    <table width=\"700px\" cellpadding=\"5\" cellspacing=\"0\">
        ...
        if ($this->getAttribute((isset($context["order"]) ? $context["order"] : $this->getContext($context, "order")), "extraStatus", array())) {
            // line 44
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["order"]) ? $context["order"] : $this->getContext($context, "order")), "extraStatus", array()), ("caption" . $this->getAttribute((isset($context["ServiceContainer"]) ? $context["ServiceContainer"] : $this->getContext($context, "ServiceContainer")), "getParameter", array(0 => "locale"), "method"))), "html", null, true);
        } else {
            // line 46
            echo "В обработке";
        }
        ...
        if ($this->getAttribute((isset($context["order"]) ? $context["order"] : $this->getContext($context, "order")), "deliveryMethod", array())) {
            ...
            <tr>
                ...
                <td>";
            // line 64
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["order"]) ? $context["order"] : $this->getContext($context, "order")), "deliveryMethod", array()), ("caption" . $this->getAttribute((isset($context["ServiceContainer"]) ? $context["ServiceContainer"] : $this->getContext($context, "ServiceContainer")), "getParameter", array(0 => "locale"), "method"))), "html", null, true);
            echo "</td>
            </tr>
    ...
    <table class=\"border\" width=\"700px\" border=\"1\" cellpadding=\"5\" cellspacing=\"0\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["composition"]) {
            ...
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("core_product", array("slug" => $this->getAttribute($this->getAttribute($context["composition"], "product", array()), "slug", array()))), "html", null, true);
            echo "\" target=\"_blank\">";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($context["composition"], "product", array()), ("caption" . $this->getAttribute((isset($context["ServiceContainer"]) ? $context["ServiceContainer"] : $this->getContext($context, "ServiceContainer")), "getParameter", array(0 => "locale"), "method"))), "html", null, true);
            echo "</a>
                    <br>
                    <span style=\"font-size:11px\">";
            // line 103
            echo twig_escape_filter($this->env, (($this->getAttribute($this->getAttribute($context["composition"], "product", array()), "color", array())) ? (($this->getAttribute($this->getAttribute($this->getAttribute($context["composition"], "product", array()), "color", array()), ("caption" . $this->getAttribute((isset($context["ServiceContainer"]) ? $context["ServiceContainer"] : $this->getContext($context, "ServiceContainer")), "getParameter", array(0 => "locale"), "method"))) . " цвет")) : ("")), "html", null, true);
    ...
    ";
        ...
        ";
                ...
                // line 171
                echo "            ";
                if ($this->getAttribute((isset($context["order"]) ? $context["order"] : $this->getContext($context, "order")), "recipientCompany", array())) {
                    // line 172
                    echo "            <tr>
