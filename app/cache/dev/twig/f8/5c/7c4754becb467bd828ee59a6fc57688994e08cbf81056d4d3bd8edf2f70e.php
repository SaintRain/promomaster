...
class __TwigTemplate_f85c7c4754becb467bd828ee59a6fc57688994e08cbf81056d4d3bd8edf2f70e extends Twig_Template
{
...
";
    ...
    public function block_balance_history_tbody($context, array $blocks = array())
    {
        ...
        if ((isset($context["balanceHistory"]) ? $context["balanceHistory"] : $this->getContext($context, "balanceHistory"))) {
            ...
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, "now", "d-m-Y_H-i-s", (isset($context["default_timezone"]) ? $context["default_timezone"] : $this->getContext($context, "default_timezone"))), "html", null, true);
            ...
            $context["balance"] = 0;
            // line 25
            $context["dateShort"] = twig_capitalize_string_filter($this->env, $this->env->getExtension('common_extension')->getMonthWordFilter($this->getAttribute(twig_first($this->env, (isset($context["balanceHistory"]) ? $context["balanceHistory"] : $this->getContext($context, "balanceHistory"))), "date", array()), true));
            // line 26
            ...
            foreach ($context['_seq'] as $context["i"] => $context["item"]) {
                ...
                // line 29
                if ((((isset($context["dateShort"]) ? $context["dateShort"] : $this->getContext($context, "dateShort")) != (isset($context["dateShortTmp"]) ? $context["dateShortTmp"] : $this->getContext($context, "dateShortTmp"))) || ($context["i"] == 0))) {
                    // line 30
                    $context["dateShort"] = (isset($context["dateShortTmp"]) ? $context["dateShortTmp"] : $this->getContext($context, "dateShortTmp"));
                    // line 32
                    echo "<tr>
                        <th colspan=\"5\" class=\"table-th\">";
                    // line 33
                    echo twig_escape_filter($this->env, (isset($context["dateShort"]) ? $context["dateShort"] : $this->getContext($context, "dateShort")), "html", null, true);
                    echo "</th>
                    </tr>";
                }
                // line 38
                echo "<tr>
                        <td>";
                // line 40
                echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute($context["item"], "date", array()), "d.m.Y", (isset($context["default_timezone"]) ? $context["default_timezone"] : $this->getContext($context, "default_timezone"))), "html", null, true);
                // line 41
                echo "</td>
                        <td align=\"right\" ";
                // line 42
                ...
                if ( !$this->getAttribute($context["item"], "type", array())) {
                    ...
                    // line 47
                    $context["balance"] = ((isset($context["balance"]) ? $context["balance"] : $this->getContext($context, "balance")) - $this->getAttribute($context["item"], "amount", array()));
                }
                // line 50
                echo "</div>
                        </td>
