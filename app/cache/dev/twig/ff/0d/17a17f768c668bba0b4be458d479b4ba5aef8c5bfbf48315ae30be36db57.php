...
class __TwigTemplate_ff0d17a17f768c668bba0b4be458d479b4ba5aef8c5bfbf48315ae30be36db57 extends Twig_Template
{
    ...
    <fieldset>
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["extra"]) ? $context["extra"] : $this->getContext($context, "extra")), "priceHike", array()));
        $context['loop'] = array(
    ...
    \$(function () {
        ...
        \$('.setNewBasePriceButton').click(function () {
            ...
            if (ids.length > 0) {
                \$.post(\"";
        // line 160
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["admin"]) ? $context["admin"] : $this->getContext($context, "admin")), "generateObjectUrl", array(0 => "setBasePriceForProductsFromPrice", 1 => $this->getAttribute((isset($context["admin"]) ? $context["admin"] : $this->getContext($context, "admin")), "subject", array())), "method"), "html", null, true);
        echo "\", {ids: ids})
                        .done(function (data) {
