...
class __TwigTemplate_ff4252d78a81a8192cb1855529d1374c654b199226ef33d43274d5df5cfcd760 extends Twig_Template
{
    ...
    <form class=\"sky-form sky-form-other-style\"  action=\"";
        ...
        <fieldset class=\"sky-form-other-style\">
            ...
            <div class=\"row margin-bottom-20\">
                <div class=\"col-sm-6  ";
        // line 42
        if ($this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "firstname", array()), 'errors')) {
            echo "state-error";
        }
        echo "\">
                    <label>Имя</label>
        ...
        echo "
                ...
                <div class=\"col-sm-6  ";
        // line 48
        if ($this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "lastname", array()), 'errors')) {
            echo "state-error";
        }
        echo "\">
                    <label>Фамилия</label>
        ...
        echo "
            ...
            <div class=\"margin-bottom-20 ";
        // line 74
        if ($this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "phone", array()), 'errors')) {
            echo "state-error";
        }
        echo "\">
                <label>Телефон </label>
        ...
        echo "
            ...
            <div class=\"margin-bottom-20 ";
        // line 82
        if ($this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "isRssNews", array()), 'errors')) {
            echo "state-error";
        }
        echo "\">
                <label class=\"checkbox\">
                    ";
        // line 84
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "isRssNews", array()), 'widget');
        echo "<i></i> Получать рассылку</label>
                ";
        // line 85
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "isRssNews", array()), 'errors');
        echo "
                </label>
            </div>
