...
class __TwigTemplate_fc45d847fe989658fb0c2e5405bc272b59a974e0c7d54e202547243dfdf635c4 extends Twig_Template
{
...
";
    ...
    public function block_comments_block($context, array $blocks = array())
    {
        ...
        $context['_seq'] = twig_ensure_traversable(twig_reverse_filter($this->env, $this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "adminComments", array())));
        $context['loop'] = array(
        ...
        // line 29
        echo twig_escape_filter($this->env, $this->env->getExtension('common_extension')->get_classFunction((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object"))), "html", null, true);
        echo "\">
        ...
        echo "                    ";
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "subscribersOnAdminComments", array()));
        foreach ($context['_seq'] as $context["_key"] => $context["subscriber"]) {
            // line 35
            echo "                        ";
            if (($this->getAttribute($context["subscriber"], "id", array()) == $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "user", array()), "id", array()))) {
                // line 36
                echo "                            ";
