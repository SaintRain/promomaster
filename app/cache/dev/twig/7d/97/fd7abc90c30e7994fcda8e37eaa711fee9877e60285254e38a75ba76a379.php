...
class __TwigTemplate_7d97fd7abc90c30e7994fcda8e37eaa711fee9877e60285254e38a75ba76a379 extends Twig_Template
{
    ...
    <div class=\"side_col_pad\">
        ...
        // line 6
        echo "            ";
        if ((((((isset($context["curRoute"]) ? $context["curRoute"] : $this->getContext($context, "curRoute")) == "core_faq_homepage") || ((isset($context["curRoute"]) ? $context["curRoute"] : $this->getContext($context, "curRoute")) == "core_faq_search")) || ((isset($context["curRoute"]) ? $context["curRoute"] : $this->getContext($context, "curRoute")) == "core_faq_article")) || ((isset($context["curRoute"]) ? $context["curRoute"] : $this->getContext($context, "curRoute")) == "core_faq_category"))) {
            // line 7
            echo "                ";
        ...
        echo "\" class=\"sidebar_menu_link\">Помощь</a></li>
            ...
            ";
        // line 11
        if (($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "request", array()), "attributes", array()), "get", array(0 => "_route"), "method") == "core_common_about")) {
            // line 12
        ...
        echo "
            ...
            ";
        // line 18
        if (($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "request", array()), "attributes", array()), "get", array(0 => "_route"), "method") == "trouble_ticket_contact")) {
            // line 19
        ...
        echo "
            ";
        // line 24
        if (($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "request", array()), "attributes", array()), "get", array(0 => "_route"), "method") == "core_common_privacy_policies")) {
            // line 25
