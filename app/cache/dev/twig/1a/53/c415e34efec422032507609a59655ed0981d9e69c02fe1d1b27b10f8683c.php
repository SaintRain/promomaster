...
class __TwigTemplate_1a53c415e34efec422032507609a59655ed0981d9e69c02fe1d1b27b10f8683c extends Twig_Template
{
    ...
    <fieldset>
        <div class=\"sonata-ba-collapsed-fields\">
            <p>Показаны записи из прайса, которые определены как испорченные.<br/> 
                ...
                Всего ";
        // line 8
        echo twig_escape_filter($this->env, twig_length_filter($this->env, $this->getAttribute((isset($context["extra"]) ? $context["extra"] : $this->getContext($context, "extra")), "analysisBadRecords", array())), "html", null, true);
        echo " шт.</p>
            
            
            ";
        // line 11
        if ($this->getAttribute((isset($context["extra"]) ? $context["extra"] : $this->getContext($context, "extra")), "analysisBadRecords", array())) {
            // line 12
            ...
            $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["extra"]) ? $context["extra"] : $this->getContext($context, "extra")), "analysisBadRecords", array()));
