...
class __TwigTemplate_a3bc2df0c655618eaf367c98643b449d4ebe08215d058c213ef95d30797a04e1 extends Twig_Template
{
        ...
        if (($this->getAttribute((isset($context["data"]) ? $context["data"] : null), "products", array(), "any", true, true) && twig_length_filter($this->env, $this->getAttribute((isset($context["data"]) ? $context["data"] : $this->getContext($context, "data")), "products", array())))) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
                ...
                echo "
                                ";
                // line 86
                $context["quantity"] = $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["data"]) ? $context["data"] : $this->getContext($context, "data")), "sessionOrder", array()), "products", array(), "array"), $this->getAttribute($context["product"], "id", array()), array(), "array"), "quantity", array(), "array");
                // line 87
                ...
                // line 128
                if (((isset($context["quantity"]) ? $context["quantity"] : $this->getContext($context, "quantity")) >= $this->getAttribute($context["product"], "availabilityQuantity", array()))) {
                    echo " disabled";
                }
                echo "\" data-action=\"setQuantity\">&nbsp;</span>
                                        </div>
                ...
                if ($this->getAttribute($context["product"], "unitOfMeasure", array())) {
                    echo "&nbsp;";
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($context["product"], "unitOfMeasure", array()), ("shortCaption" . $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "request", array()), "locale", array()))), "html", null, true);
                }
                echo "</span>
                                        </div>
                                    </td>
                ...
                if ($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["orderCostInfo"]) ? $context["orderCostInfo"] : $this->getContext($context, "orderCostInfo")), "composition", array(), "array"), $this->getAttribute($context["product"], "id", array()), array(), "array"), "discountValue", array(), "array")) {
                    ...
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["orderCostInfo"]) ? $context["orderCostInfo"] : $this->getContext($context, "orderCostInfo")), "composition", array(), "array"), $this->getAttribute($context["product"], "id", array()), array(), "array"), "discountValue", array(), "array"), "html", null, true);
                    echo "</b>";
                    if ($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["orderCostInfo"]) ? $context["orderCostInfo"] : $this->getContext($context, "orderCostInfo")), "composition", array(), "array"), $this->getAttribute($context["product"], "id", array()), array(), "array"), "isDiscountValueInPercent", array(), "array")) {
                        ...
                        echo twig_escape_filter($this->env, $this->env->getExtension('money_extension')->moneyFormatFunction($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["orderCostInfo"]) ? $context["orderCostInfo"] : $this->getContext($context, "orderCostInfo")), "composition", array(), "array"), $this->getAttribute($context["product"], "id", array()), array(), "array"), "discountValueInMoney", array(), "array")), "html", null, true);
                        echo "</b> ";
                        echo twig_escape_filter($this->env, $this->env->getExtension('money_extension')->currencyFormatFunction(), "html", null, true);
                        echo ")";
                    } else {
            ...
            // line 173
            echo twig_escape_filter($this->env, $this->env->getExtension('money_extension')->moneyFormatFunction($this->getAttribute((isset($context["orderCostInfo"]) ? $context["orderCostInfo"] : $this->getContext($context, "orderCostInfo")), "total_cost", array(), "array")), "html", null, true);
            echo "</b><span>&nbsp;";
            echo twig_escape_filter($this->env, $this->env->getExtension('money_extension')->currencyFormatFunction(), "html", null, true);
            echo "</span></td>
                                </tr>
            ...
            echo "
                    ...
                    ";
            // line 203
            if (((isset($context["countNotPaidOrders"]) ? $context["countNotPaidOrders"] : $this->getContext($context, "countNotPaidOrders")) > 0)) {
                // line 204
                echo "
                        <br>
                        У Вас есть ";
                // line 206
                echo twig_escape_filter($this->env, (isset($context["countNotPaidOrders"]) ? $context["countNotPaidOrders"] : $this->getContext($context, "countNotPaidOrders")), "html", null, true);
                echo " ";
                echo twig_escape_filter($this->env, $this->env->getExtension('decline_of_number_extension')->declOfNumFunction((isset($context["countNotPaidOrders"]) ? $context["countNotPaidOrders"] : $this->getContext($context, "countNotPaidOrders")), array(0 => "неоплаченный заказ", 1 => "неоплаченных заказa", 2 => "неоплаченных заказов")), "html", null, true);
...
";
    ...
    {
        return array (  483 => 302,  479 => 300,  477 => 299,  475 => 298,  472 => 297,  469 => 296,  461 => 290,  454 => 261,  451 => 211,  447 => 209,  437 => 206,  433 => 204,  431 => 203,  425 => 199,  416 => 192,  413 => 188,  411 => 186,  403 => 179,  397 => 178,  387 => 173,  382 => 170,  373 => 166,  368 => 163,  366 => 162,  363 => 161,  354 => 150,  344 => 145,  328 => 143,  326 => 142,  319 => 140,  307 => 136,  301 => 134,  297 => 132,  295 => 131,  287 => 128,  281 => 127,  278 => 126,  267 => 117,  255 => 114,  252 => 113,  250 => 112,  241 => 108,  238 => 107,  231 => 104,  229 => 102,  219 => 100,  212 => 96,  210 => 95,  206 => 94,  204 => 93,  196 => 90,  187 => 87,  185 => 86,  182 => 85,  178 => 84,  165 => 73,  163 => 72,  160 => 71,  158 => 70,  146 => 61,  143 => 60,  140 => 59,  134 => 55,  132 => 51,  126 => 47,  120 => 44,  116 => 42,  113 => 41,  111 => 40,  107 => 38,  87 => 36,  82 => 30,  78 => 22,  75 => 21,  72 => 20,  66 => 18,  60 => 17,  54 => 16,  45 => 9,  22 => 13,  11 => 9,);
    }
}
