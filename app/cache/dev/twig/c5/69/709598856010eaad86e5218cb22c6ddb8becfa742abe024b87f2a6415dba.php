...
class __TwigTemplate_c569709598856010eaad86e5218cb22c6ddb8becfa742abe024b87f2a6415dba extends Twig_Template
{
...
<div class=\"row-fluid alone\">
    ...
    <form class=\"form-horizontal trouble-ticket-msg-form\"
        ...
        // line 20
        echo "        ";
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "body", array()), 'widget', array("attr" => array("class" => "msg-body span12")));
        echo "
        ";
        // line 21
