...
/* CoreOrderBundle:Admin\Form\Order\type:waybills_in_order_widget.html.twig */
class __TwigTemplate_7107780e0912c294505083a08094bd3d30f1afa7167a9719a06dbe7e552bef9c extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        $this->blocks = array(
            ...
            '__internal_7aebca62848baa25bea3ac5f470eecf506a563dc0e56847b6ea5cd3ce8f8b518' => array($this, 'block___internal_7aebca62848baa25bea3ac5f470eecf506a563dc0e56847b6ea5cd3ce8f8b518'),
        );
    }
...
";
    ...
    public function block_collection_widget_row($context, array $blocks = array())
    {
        ...
        // line 3
        echo "        ";
        $this->env->loadTemplate("CoreOrderBundle:Admin/Form/Blocks:collection_widget.html.twig")->display(array_merge($context, array("form" => (isset($context["child"]) ? $context["child"] : $this->getContext($context, "child")))));
        // line 4
        echo "    ";
    ...
    public function block_waybills_in_order_widget($context, array $blocks = array())
    {
        ...
        <div class=\"controls sonata-ba-field sonata-ba-field-standard-natural  \">
            <ul class=\"collection-modify control-group\" id=\"";
                ...
                echo "\" data-prototype=\"";
                echo twig_escape_filter($this->env, (string) $this->renderBlock("__internal_7aebca62848baa25bea3ac5f470eecf506a563dc0e56847b6ea5cd3ce8f8b518", $context, $blocks));
                echo "\">
                ";
                // line 14
                $context['_parent'] = (array) $context;
            ...
            ";
                ...
                if (twig_length_filter($this->env, $context["child"])) {
                    ...
                    ";
                    // line 23
                    if ((($this->getAttribute((isset($context["waybill"]) ? $context["waybill"] : $this->getContext($context, "waybill")), "isAutoGenerated", array()) == 1) && twig_length_filter($this->env, $this->getAttribute((isset($context["waybill"]) ? $context["waybill"] : $this->getContext($context, "waybill")), "number", array())))) {
                        // line 24
                        echo "                        <a target=\"_blank\" href=\"";
                        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_core_delivery_service_printWaybill", array("id" => $this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "id", array()), "sellerId" => $this->getAttribute($this->getAttribute((isset($context["waybill"]) ? $context["waybill"] : $this->getContext($context, "waybill")), "salesMan", array()), "id", array()), "deliveryMethodId" => $this->getAttribute($this->getAttribute((isset($context["waybill"]) ? $context["waybill"] : $this->getContext($context, "waybill")), "deliveryMode", array()), "id", array()), "waybillId" => $this->getAttribute((isset($context["waybill"]) ? $context["waybill"] : $this->getContext($context, "waybill")), "number", array()))), "html", null, true);
    ...
    // line 13
    public function block___internal_7aebca62848baa25bea3ac5f470eecf506a563dc0e56847b6ea5cd3ce8f8b518($context, array $blocks = array())
    {
        $this->env->loadTemplate("CoreOrderBundle:Admin/Form/Blocks:collection_widget.html.twig")->display(array_merge($context, array("form" => $this->getAttribute($this->getAttribute((isset($context["child"]) ? $context["child"] : $this->getContext($context, "child")), "vars", array()), "prototype", array()), "allow_delete" => $this->getAttribute($this->getAttribute((isset($context["child"]) ? $context["child"] : $this->getContext($context, "child")), "vars", array()), "allow_delete", array()), "id" => $this->getAttribute((isset($context["loop"]) ? $context["loop"] : $this->getContext($context, "loop")), "index", array()))));
    }

    public function getTemplateName()
    {
        return "CoreOrderBundle:Admin\\Form\\Order\\type:waybills_in_order_widget.html.twig";
    }
