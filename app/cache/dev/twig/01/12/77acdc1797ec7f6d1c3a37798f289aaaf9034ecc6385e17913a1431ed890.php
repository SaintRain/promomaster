...
class __TwigTemplate_011277acdc1797ec7f6d1c3a37798f289aaaf9034ecc6385e17913a1431ed890 extends Twig_Template
{
...
";
    ...
    public function block_core_payment_admin_id_text_widget($context, array $blocks = array())
    {
        // line 10
        echo "    ";
        $context["payment"] = $this->getAttribute($this->getAttribute((isset($context["sonata_admin"]) ? $context["sonata_admin"] : $this->getContext($context, "sonata_admin")), "admin", array()), "subject", array());
        // line 11
        echo "    ";
        if ($this->getAttribute((isset($context["payment"]) ? $context["payment"] : $this->getContext($context, "payment")), "id", array())) {
            // line 12
            echo "
        <h4>Платеж #";
            // line 13
            ...
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["payment"]) ? $context["payment"] : $this->getContext($context, "payment")), "createdAt", array()), "d.m.Y H:i:s", (isset($context["default_timezone"]) ? $context["default_timezone"] : $this->getContext($context, "default_timezone"))), "html", null, true);
            echo ")</span></h4>
...
";
    ...
    public function block_core_payment_admin_order_ajax_entity_widget($context, array $blocks = array())
    {
        ...
        ";
        // line 47
        $context["order"] = $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["sonata_admin"]) ? $context["sonata_admin"] : $this->getContext($context, "sonata_admin")), "admin", array()), "subject", array()), "order", array());
        // line 48
        echo "
        ";
        // line 49
        if ((isset($context["order"]) ? $context["order"] : $this->getContext($context, "order"))) {
            ...
            ";
            // line 55
            if ($this->getAttribute((isset($context["order"]) ? $context["order"] : $this->getContext($context, "order")), "isCheckedStatus", array())) {
                // line 56
            ...
            ";
            // line 67
            if ($this->getAttribute((isset($context["order"]) ? $context["order"] : $this->getContext($context, "order")), "isCanceledStatus", array())) {
                // line 68
            ...
            if ($this->getAttribute((isset($context["order"]) ? $context["order"] : $this->getContext($context, "order")), "extraStatus", array())) {
                ...
                echo "\">";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["order"]) ? $context["order"] : $this->getContext($context, "order")), "extraStatus", array()), "captionRu", array()), "html", null, true);
                echo "</span>
            ";
            }
            // line 74
