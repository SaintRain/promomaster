...
class __TwigTemplate_21a8974fdd1a7b2bb692d55bd98b92efd1566ee994a7ba17b4e2d6c9c2b377fd extends Twig_Template
{
...
";
    ...
    public function block_actions($context, array $blocks = array())
    {
        // line 13
        echo "    ";
        if (($this->getAttribute((isset($context["object"]) ? $context["object"] : null), "slug", array(), "any", true, true) && $this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "slug", array()))) {
            // line 14
            echo "
        <div class=\"sonata-actions btn-group\">
            ...
            // line 17
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("core_product", array("slug" => $this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "slug", array()))), "html", null, true);
    ...
    ";
        ...
        if ((array_key_exists("nextObject", $context) || array_key_exists("prevObject", $context))) {
            ...
            <div class=\"pull-right\">
                ";
            // line 25
            if ((array_key_exists("prevObject", $context) && (isset($context["prevObject"]) ? $context["prevObject"] : $this->getContext($context, "prevObject")))) {
                // line 26
                echo "                    <span class=\"btn btn-link\">
                        <a title=\"Предыдущий (ctrl + &larr;)\" id=\"btn-prev\" class=\"prev-next\" href=\"";
                // line 27
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_core_product_commonproduct_edit", array("id" => $this->getAttribute((isset($context["prevObject"]) ? $context["prevObject"] : $this->getContext($context, "prevObject")), "id", array()))), "html", null, true);
                echo "\"><i class=\"icon-step-backward\"></i>";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["prevObject"]) ? $context["prevObject"] : $this->getContext($context, "prevObject")), ("caption" . $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "request", array()), "locale", array()))), "html", null, true);
                echo "</a>
                    </span>
                ";
            }
            // line 30
            echo "                ";
            if ((array_key_exists("nextObject", $context) && (isset($context["nextObject"]) ? $context["nextObject"] : $this->getContext($context, "nextObject")))) {
                // line 31
                echo "                    <span class=\"btn btn-link\">
                        <a title=\"Следующий (ctrl + &rarr;)\" id=\"btn-next\" class=\"prev-next\" href=\"";
                // line 32
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_core_product_commonproduct_edit", array("id" => $this->getAttribute((isset($context["nextObject"]) ? $context["nextObject"] : $this->getContext($context, "nextObject")), "id", array()))), "html", null, true);
                echo "\">";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["nextObject"]) ? $context["nextObject"] : $this->getContext($context, "nextObject")), ("caption" . $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "request", array()), "locale", array()))), "html", null, true);
