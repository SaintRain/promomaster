...
class __TwigTemplate_963fda1557eb9f5c5048b12d04a763bebecbd12241d591dee88c9ccbd29784f5 extends Twig_Template
{
...
";
    ...
    public function block_sonata_admin_content($context, array $blocks = array())
    {
        ...
        <h2>Инвентаризация по складам
            ";
        // line 16
        if (($this->getAttribute($this->getAttribute((isset($context["search"]) ? $context["search"] : null), "filter", array(), "any", false, true), "only_free", array(), "any", true, true) && $this->getAttribute($this->getAttribute((isset($context["search"]) ? $context["search"] : $this->getContext($context, "search")), "filter", array()), "only_free", array()))) {
            // line 17
    ...
    <table style=\"width:";
        // line 27
        if (($this->getAttribute((isset($context["search"]) ? $context["search"] : $this->getContext($context, "search")), "format", array()) == "pdf")) {
            echo "100%";
        } else {
            echo "50%";
        }
        ...
        foreach ($context['_seq'] as $context["s_id"] => $context["s"]) {
            ...
            if ($this->getAttribute((isset($context["data"]) ? $context["data"] : null), $context["s_id"], array(), "array", true, true)) {
                ...
                echo "                                ";
                $context['_parent'] = (array) $context;
                $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute((isset($context["data"]) ? $context["data"] : $this->getContext($context, "data")), $context["s_id"], array(), "array"), "data", array()));
            ...
            // line 52
            if ($this->getAttribute((isset($context["data"]) ? $context["data"] : null), $context["s_id"], array(), "array", true, true)) {
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["data"]) ? $context["data"] : $this->getContext($context, "data")), $context["s_id"], array(), "array"), "total_quantity", array()), "html", null, true);
            } else {
                echo "0";
            }
            echo "</b></td>
            ...
            // line 53
            if ($this->getAttribute((isset($context["data"]) ? $context["data"] : null), $context["s_id"], array(), "array", true, true)) {
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["data"]) ? $context["data"] : $this->getContext($context, "data")), $context["s_id"], array(), "array"), "total_quantity_with_defect", array()), "html", null, true);
            } else {
                echo "0";
            }
            echo "</b></td>
