...
class __TwigTemplate_197ba0b316759ef9f6585ffe28404152e6c206bc6d3c8f93003b91c21fcc3b46 extends Twig_Template
{
...
<div class=\"header_useraccount";
    ...
    ";
        ...
        if ($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "user", array())) {
            ...
            // line 5
            echo "        ";
            $context["totalCountNotification"] = (isset($context["orderCountNotification"]) ? $context["orderCountNotification"] : $this->getContext($context, "orderCountNotification"));
            // line 6
            echo "        ";
            ...
            if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "user", array()), "firstname", array()) || $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "user", array()), "lastname", array()))) {
                echo twig_escape_filter($this->env, (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "user", array()), "lastname", array()) . " ") . $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "user", array()), "firstname", array())), "html", null, true);
            } else {
            ...
            // line 8
            if (((isset($context["totalCountNotification"]) ? $context["totalCountNotification"] : $this->getContext($context, "totalCountNotification")) > 0)) {
                echo "&nbsp;<span class=\"notice_indicator\">";
                echo twig_escape_filter($this->env, (isset($context["totalCountNotification"]) ? $context["totalCountNotification"] : $this->getContext($context, "totalCountNotification")), "html", null, true);
                echo "</span>";
            }
            // line 9
            ...
            if ((isset($context["contragent"]) ? $context["contragent"] : $this->getContext($context, "contragent"))) {
                ...
                echo "</li>
                        <li class=\"pad\">Баланс: ";
                // line 23
                echo twig_escape_filter($this->env, $this->env->getExtension('money_extension')->moneyFormatFunction($this->env->getExtension('payment_extension')->getBalanceFunction($this->getAttribute((isset($context["contragent"]) ? $context["contragent"] : $this->getContext($context, "contragent")), "id", array()))), "html", null, true);
                echo " ";
                echo twig_escape_filter($this->env, $this->env->getExtension('money_extension')->currencyFormatFunction(), "html", null, true);
                echo "</li>";
                // line 24
                if (($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "user", array()), "contragents", array()), "count", array()) > 1)) {
                    // line 25
                    echo "<li>
