...
/* CoreOrderBundle:Admin\Form\Order\type:canceled_status_widget.html.twig */
class __TwigTemplate_10c166b58d87b95331f67906986dbaeb24ba5a0aee2b6563762bc3b1ca810d48 extends Twig_Template
{
    ...
    public function block_canceled_status_widget($context, array $blocks = array())
    {
            ...
            <table cellpadding=\"5\" cellspacing=\"0\">
                <tr>
                    ...
                    <td>
                        <select ";
        // line 10
        if (($this->getAttribute((isset($context["order"]) ? $context["order"] : $this->getContext($context, "order")), "isCanceledStatus", array()) &&  !(isset($context["noDisable"]) ? $context["noDisable"] : $this->getContext($context, "noDisable")))) {
            echo " disabled ";
        }
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["r"]) {
            ...
            if (( !$this->getAttribute((isset($context["order"]) ? $context["order"] : $this->getContext($context, "order")), "shippedDateTime", array()) && ((($this->getAttribute($context["r"], "name", array()) == twig_constant("Core\\OrderBundle\\Entity\\Order::returnCanceledReasonName")) || ($this->getAttribute($context["r"], "name", array()) == twig_constant("Core\\OrderBundle\\Entity\\Order::reorderCanceledReasonName"))) && ( !$this->getAttribute($this->getAttribute((isset($context["order"]) ? $context["order"] : null), "reasonForCanceling", array(), "any", false, true), "name", array(), "any", true, true) || (($this->getAttribute($this->getAttribute((isset($context["order"]) ? $context["order"] : $this->getContext($context, "order")), "reasonForCanceling", array()), "name", array()) != twig_constant("Core\\OrderBundle\\Entity\\Order::returnCanceledReasonName")) && ($this->getAttribute($this->getAttribute((isset($context["order"]) ? $context["order"] : $this->getContext($context, "order")), "reasonForCanceling", array()), "name", array()) != twig_constant("Core\\OrderBundle\\Entity\\Order::reorderCanceledReasonName"))))))) {
                ...
                echo "\" ";
                if (($this->getAttribute((isset($context["order"]) ? $context["order"] : $this->getContext($context, "order")), "reasonForCanceling", array()) && ($this->getAttribute($this->getAttribute((isset($context["order"]) ? $context["order"] : $this->getContext($context, "order")), "reasonForCanceling", array()), "id", array()) == $this->getAttribute($context["r"], "id", array())))) {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["s"]) {
            ...
            echo "\" ";
            if (($this->getAttribute((isset($context["order"]) ? $context["order"] : $this->getContext($context, "order")), "stockForCanceling", array()) && ($this->getAttribute($this->getAttribute((isset($context["order"]) ? $context["order"] : $this->getContext($context, "order")), "stockForCanceling", array()), "id", array()) == $this->getAttribute($context["s"], "id", array())))) {
                echo " selected=\"selected\" ";
            }
            echo ">";
        ...
        echo " value=\"";
        echo twig_escape_filter($this->env, twig_number_format_filter($this->env, $this->getAttribute((isset($context["order"]) ? $context["order"] : $this->getContext($context, "order")), "keepMoneySumForCanceling", array()), 2, ",", "."), "html", null, true);
        ...
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["order"]) ? $context["order"] : $this->getContext($context, "order")), "commentForCanceling", array()), "html", null, true);
        echo "</textarea>
                    </td>
                </tr>
            </table>
        ...
        echo "') {
                    ...
                    ";
        // line 71
        if (($this->getAttribute((isset($context["order"]) ? $context["order"] : $this->getContext($context, "order")), "shippedDateTime", array()) || $this->getAttribute((isset($context["order"]) ? $context["order"] : $this->getContext($context, "order")), "stockForCanceling", array()))) {
            // line 72
        ...
        // line 87
        if ($this->getAttribute((isset($context["order"]) ? $context["order"] : $this->getContext($context, "order")), "deliveryCost", array())) {
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["order"]) ? $context["order"] : $this->getContext($context, "order")), "deliveryCost", array()), "html", null, true);
        } else {
            echo "0.00";
        }
        echo "\";
    ...
    {
        return "CoreOrderBundle:Admin\\Form\\Order\\type:canceled_status_widget.html.twig";
    }
