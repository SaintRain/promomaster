...
class __TwigTemplate_3236cdf721849767c9c171c5d15a77ef40daf9ec3022cf4917790a08cfcb09f1 extends Twig_Template
{
    ...
    {
        if ($this->getAttribute((isset($context["site"]) ? $context["site"] : $this->getContext($context, "site")), "id", array())) {
            echo "Редактирование настроек сайта ";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["site"]) ? $context["site"] : $this->getContext($context, "site")), "domain", array()), "html", null, true);
        } else {
    ...
    <form style=\"clear: both\" class=\"sky-form sky-form-other-style\"
        ...
        // line 68
        if ($this->getAttribute((isset($context["site"]) ? $context["site"] : $this->getContext($context, "site")), "id", array())) {
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("core_cabinet_site_edit", array("id" => $this->getAttribute((isset($context["site"]) ? $context["site"] : $this->getContext($context, "site")), "id", array()))), "html", null, true);
        } else {
            echo $this->env->getExtension('routing')->getPath("core_cabinet_site_create");
        }
        echo "\" ";
        ...
        <fieldset class=\"sky-form-other-style\">
            ...
            <div class=\"row margin-bottom-20\">
                <div class=\"col-sm-6  ";
        // line 73
        if ($this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "domain", array()), 'errors')) {
            echo "state-error";
        }
        echo "\">
        ...
        echo "
            ...
            <div class=\"row margin-bottom-20\">
                <div class=\"col-lg-12  ";
        // line 81
        if ($this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "categories", array()), 'errors')) {
            echo "state-error";
        }
        echo "\">
        ...
        echo "
            ...
            <div class=\"row margin-bottom-20\">
                <div class=\"col-sm-6  ";
        // line 89
        if ($this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "mirrors", array()), 'errors')) {
            echo "state-error";
        }
        echo "\">
                    <label>Зеркала</label>
                    ";
        // line 91
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "mirrors", array()), 'widget', array("attr" => array("class" => "form-control")));
        echo "
                    ";
        // line 92
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "mirrors", array()), 'errors');
        echo "
            ...
            <div class=\"row margin-bottom-20\">
                <div class=\"col-sm-6  ";
        // line 98
        if ($this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "keywords", array()), 'errors')) {
            echo "state-error";
        }
        echo "\">
                    ...
                    ";
        // line 100
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "keywords", array()), 'widget', array("attr" => array("class" => "form-control")));
        echo "
    ...
    <script>
        ...
        if ($this->getAttribute((isset($context["site"]) ? $context["site"] : $this->getContext($context, "site")), "id", array())) {
            ...
            // line 136
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("core_cabinet_site_delete", array("id" => $this->getAttribute((isset($context["site"]) ? $context["site"] : $this->getContext($context, "site")), "id", array()))), "html", null, true);
            echo "';
                }
            });
            ";
