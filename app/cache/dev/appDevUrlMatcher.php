...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
                ...
                if (0 === strpos($pathinfo, '/_console')) {
                    ...
                    if (rtrim($pathinfo, '/') === '/_console') {
                        if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                            ...
                            goto not_ru__RG__console;
                        }

                        if (substr($pathinfo, -1) !== '/') {
                            return $this->redirect($pathinfo.'/', 'ru__RG__console');
                        }

                        return array (  '_controller' => 'CoreSphere\\ConsoleBundle\\Controller\\ConsoleController::consoleAction',  '_locale' => 'ru',  '_route' => 'ru__RG__console',);
                    }
                    not_ru__RG__console:

                    // ru__RG__console_exec
                    if (0 === strpos($pathinfo, '/_console/commands') && preg_match('#^/_console/commands(?:\\.(?P<_format>json))?$#s', $pathinfo, $matches)) {
                        if ($this->context->getMethod() != 'POST') {
                            $allow[] = 'POST';
                            goto not_ru__RG__console_exec;
                        }

                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__console_exec')), array (  '_controller' => 'CoreSphere\\ConsoleBundle\\Controller\\ConsoleController::execAction',  '_format' => 'json',  '_locale' => 'ru',));
                    }
                    not_ru__RG__console_exec:
        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            if (0 === strpos($pathinfo, '/admin/core')) {
                ...
                if (0 === strpos($pathinfo, '/admin/core/category')) {
                    if (0 === strpos($pathinfo, '/admin/core/category/sitecategory')) {
                        // ru__RG__admin_core_category_sitecategory_list
                        if ($pathinfo === '/admin/core/category/sitecategory/list') {
                            return array (  '_controller' => 'Core\\CategoryBundle\\Controller\\Admin\\CommonAdminCategoryController::listAction',  '_sonata_admin' => 'core_category_site_admin',  '_sonata_name' => 'admin_core_category_sitecategory_list',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_category_sitecategory_list',);
                        }

                        // ru__RG__admin_core_category_sitecategory_create
                        if ($pathinfo === '/admin/core/category/sitecategory/create') {
                            return array (  '_controller' => 'Core\\CategoryBundle\\Controller\\Admin\\CommonAdminCategoryController::createAction',  '_sonata_admin' => 'core_category_site_admin',  '_sonata_name' => 'admin_core_category_sitecategory_create',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_category_sitecategory_create',);
                        }

                        // ru__RG__admin_core_category_sitecategory_batch
                        if ($pathinfo === '/admin/core/category/sitecategory/batch') {
                            return array (  '_controller' => 'Core\\CategoryBundle\\Controller\\Admin\\CommonAdminCategoryController::batchAction',  '_sonata_admin' => 'core_category_site_admin',  '_sonata_name' => 'admin_core_category_sitecategory_batch',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_category_sitecategory_batch',);
                        }

                        // ru__RG__admin_core_category_sitecategory_edit
                        if (preg_match('#^/admin/core/category/sitecategory/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__admin_core_category_sitecategory_edit')), array (  '_controller' => 'Core\\CategoryBundle\\Controller\\Admin\\CommonAdminCategoryController::editAction',  '_sonata_admin' => 'core_category_site_admin',  '_sonata_name' => 'admin_core_category_sitecategory_edit',  '_locale' => 'ru',));
                        }

                        // ru__RG__admin_core_category_sitecategory_delete
                        if (preg_match('#^/admin/core/category/sitecategory/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__admin_core_category_sitecategory_delete')), array (  '_controller' => 'Core\\CategoryBundle\\Controller\\Admin\\CommonAdminCategoryController::deleteAction',  '_sonata_admin' => 'core_category_site_admin',  '_sonata_name' => 'admin_core_category_sitecategory_delete',  '_locale' => 'ru',));
                        }

                        // ru__RG__admin_core_category_sitecategory_show
                        if (preg_match('#^/admin/core/category/sitecategory/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__admin_core_category_sitecategory_show')), array (  '_controller' => 'Core\\CategoryBundle\\Controller\\Admin\\CommonAdminCategoryController::showAction',  '_sonata_admin' => 'core_category_site_admin',  '_sonata_name' => 'admin_core_category_sitecategory_show',  '_locale' => 'ru',));
                        }

                        // ru__RG__admin_core_category_sitecategory_export
                        if ($pathinfo === '/admin/core/category/sitecategory/export') {
                            return array (  '_controller' => 'Core\\CategoryBundle\\Controller\\Admin\\CommonAdminCategoryController::exportAction',  '_sonata_admin' => 'core_category_site_admin',  '_sonata_name' => 'admin_core_category_sitecategory_export',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_category_sitecategory_export',);
                        }
                ...
                if (0 === strpos($pathinfo, '/admin/core/directory')) {
                    if (0 === strpos($pathinfo, '/admin/core/directory/adplacesize')) {
                        // ru__RG__admin_core_directory_adplacesize_list
                        if ($pathinfo === '/admin/core/directory/adplacesize/list') {
                            return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::listAction',  '_sonata_admin' => 'core_ad_place_size_admin',  '_sonata_name' => 'admin_core_directory_adplacesize_list',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_directory_adplacesize_list',);
                        }

                        // ru__RG__admin_core_directory_adplacesize_create
                        if ($pathinfo === '/admin/core/directory/adplacesize/create') {
                            return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::createAction',  '_sonata_admin' => 'core_ad_place_size_admin',  '_sonata_name' => 'admin_core_directory_adplacesize_create',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_directory_adplacesize_create',);
                        }

                        // ru__RG__admin_core_directory_adplacesize_batch
                        if ($pathinfo === '/admin/core/directory/adplacesize/batch') {
                            return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::batchAction',  '_sonata_admin' => 'core_ad_place_size_admin',  '_sonata_name' => 'admin_core_directory_adplacesize_batch',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_directory_adplacesize_batch',);
                        }

                        // ru__RG__admin_core_directory_adplacesize_edit
                        if (preg_match('#^/admin/core/directory/adplacesize/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__admin_core_directory_adplacesize_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'core_ad_place_size_admin',  '_sonata_name' => 'admin_core_directory_adplacesize_edit',  '_locale' => 'ru',));
                        }

                        // ru__RG__admin_core_directory_adplacesize_delete
                        if (preg_match('#^/admin/core/directory/adplacesize/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__admin_core_directory_adplacesize_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'core_ad_place_size_admin',  '_sonata_name' => 'admin_core_directory_adplacesize_delete',  '_locale' => 'ru',));
                        }

                        // ru__RG__admin_core_directory_adplacesize_show
                        if (preg_match('#^/admin/core/directory/adplacesize/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__admin_core_directory_adplacesize_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'core_ad_place_size_admin',  '_sonata_name' => 'admin_core_directory_adplacesize_show',  '_locale' => 'ru',));
                        }

                        // ru__RG__admin_core_directory_adplacesize_export
                        if ($pathinfo === '/admin/core/directory/adplacesize/export') {
                            return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::exportAction',  '_sonata_admin' => 'core_ad_place_size_admin',  '_sonata_name' => 'admin_core_directory_adplacesize_export',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_directory_adplacesize_export',);
                        }

                        // ru__RG__admin_core_directory_adplacesize_history
                        if (preg_match('#^/admin/core/directory/adplacesize/(?P<id>[^/]++)/history$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__admin_core_directory_adplacesize_history')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::historyAction',  '_sonata_admin' => 'core_ad_place_size_admin',  '_sonata_name' => 'admin_core_directory_adplacesize_history',  '_locale' => 'ru',));
                        }

                        // ru__RG__admin_core_directory_adplacesize_history_view_revision
                        if (preg_match('#^/admin/core/directory/adplacesize/(?P<id>[^/]++)/history/(?P<revision>[^/]++)/view$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__admin_core_directory_adplacesize_history_view_revision')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::historyViewRevisionAction',  '_sonata_admin' => 'core_ad_place_size_admin',  '_sonata_name' => 'admin_core_directory_adplacesize_history_view_revision',  '_locale' => 'ru',));
                        }
                ...
                if (0 === strpos($pathinfo, '/admin/core/banner/commonbanner')) {
                    // ru__RG__admin_core_banner_commonbanner_list
                    if ($pathinfo === '/admin/core/banner/commonbanner/list') {
                        return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::listAction',  '_sonata_admin' => 'core_banner_admin',  '_sonata_name' => 'admin_core_banner_commonbanner_list',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_banner_commonbanner_list',);
                    }

                    // ru__RG__admin_core_banner_commonbanner_create
                    if ($pathinfo === '/admin/core/banner/commonbanner/create') {
                        return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::createAction',  '_sonata_admin' => 'core_banner_admin',  '_sonata_name' => 'admin_core_banner_commonbanner_create',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_banner_commonbanner_create',);
                    }

                    // ru__RG__admin_core_banner_commonbanner_batch
                    if ($pathinfo === '/admin/core/banner/commonbanner/batch') {
                        return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::batchAction',  '_sonata_admin' => 'core_banner_admin',  '_sonata_name' => 'admin_core_banner_commonbanner_batch',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_banner_commonbanner_batch',);
                    }

                    // ru__RG__admin_core_banner_commonbanner_edit
                    if (preg_match('#^/admin/core/banner/commonbanner/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__admin_core_banner_commonbanner_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'core_banner_admin',  '_sonata_name' => 'admin_core_banner_commonbanner_edit',  '_locale' => 'ru',));
                    }

                    // ru__RG__admin_core_banner_commonbanner_delete
                    if (preg_match('#^/admin/core/banner/commonbanner/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__admin_core_banner_commonbanner_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'core_banner_admin',  '_sonata_name' => 'admin_core_banner_commonbanner_delete',  '_locale' => 'ru',));
                    }

                    // ru__RG__admin_core_banner_commonbanner_show
                    if (preg_match('#^/admin/core/banner/commonbanner/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__admin_core_banner_commonbanner_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'core_banner_admin',  '_sonata_name' => 'admin_core_banner_commonbanner_show',  '_locale' => 'ru',));
                    }

                    // ru__RG__admin_core_banner_commonbanner_export
                    if ($pathinfo === '/admin/core/banner/commonbanner/export') {
                        return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::exportAction',  '_sonata_admin' => 'core_banner_admin',  '_sonata_name' => 'admin_core_banner_commonbanner_export',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_banner_commonbanner_export',);
                    }

                }

                if (0 === strpos($pathinfo, '/admin/core/site')) {
                    if (0 === strpos($pathinfo, '/admin/core/site/site')) {
                        // ru__RG__admin_core_site_site_list
                        if ($pathinfo === '/admin/core/site/site/list') {
                            return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::listAction',  '_sonata_admin' => 'core_site_admin',  '_sonata_name' => 'admin_core_site_site_list',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_site_site_list',);
                        }

                        // ru__RG__admin_core_site_site_create
                        if ($pathinfo === '/admin/core/site/site/create') {
                            return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::createAction',  '_sonata_admin' => 'core_site_admin',  '_sonata_name' => 'admin_core_site_site_create',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_site_site_create',);
                        }

                        // ru__RG__admin_core_site_site_batch
                        if ($pathinfo === '/admin/core/site/site/batch') {
                            return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::batchAction',  '_sonata_admin' => 'core_site_admin',  '_sonata_name' => 'admin_core_site_site_batch',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_site_site_batch',);
                        }

                        // ru__RG__admin_core_site_site_edit
                        if (preg_match('#^/admin/core/site/site/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__admin_core_site_site_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'core_site_admin',  '_sonata_name' => 'admin_core_site_site_edit',  '_locale' => 'ru',));
                        }

                        // ru__RG__admin_core_site_site_delete
                        if (preg_match('#^/admin/core/site/site/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__admin_core_site_site_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'core_site_admin',  '_sonata_name' => 'admin_core_site_site_delete',  '_locale' => 'ru',));
                        }

                        // ru__RG__admin_core_site_site_show
                        if (preg_match('#^/admin/core/site/site/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__admin_core_site_site_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'core_site_admin',  '_sonata_name' => 'admin_core_site_site_show',  '_locale' => 'ru',));
                        }

                        // ru__RG__admin_core_site_site_export
                        if ($pathinfo === '/admin/core/site/site/export') {
                            return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::exportAction',  '_sonata_admin' => 'core_site_admin',  '_sonata_name' => 'admin_core_site_site_export',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_site_site_export',);
                        }

                    }

                    if (0 === strpos($pathinfo, '/admin/core/site/adplace')) {
                        // ru__RG__admin_core_site_adplace_list
                        if ($pathinfo === '/admin/core/site/adplace/list') {
                            return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::listAction',  '_sonata_admin' => 'core_ad_place_admin',  '_sonata_name' => 'admin_core_site_adplace_list',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_site_adplace_list',);
                        }

                        // ru__RG__admin_core_site_adplace_create
                        if ($pathinfo === '/admin/core/site/adplace/create') {
                            return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::createAction',  '_sonata_admin' => 'core_ad_place_admin',  '_sonata_name' => 'admin_core_site_adplace_create',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_site_adplace_create',);
                        }

                        // ru__RG__admin_core_site_adplace_batch
                        if ($pathinfo === '/admin/core/site/adplace/batch') {
                            return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::batchAction',  '_sonata_admin' => 'core_ad_place_admin',  '_sonata_name' => 'admin_core_site_adplace_batch',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_site_adplace_batch',);
                        }

                        // ru__RG__admin_core_site_adplace_edit
                        if (preg_match('#^/admin/core/site/adplace/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__admin_core_site_adplace_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'core_ad_place_admin',  '_sonata_name' => 'admin_core_site_adplace_edit',  '_locale' => 'ru',));
                        }

                        // ru__RG__admin_core_site_adplace_delete
                        if (preg_match('#^/admin/core/site/adplace/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__admin_core_site_adplace_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'core_ad_place_admin',  '_sonata_name' => 'admin_core_site_adplace_delete',  '_locale' => 'ru',));
                        }

                        // ru__RG__admin_core_site_adplace_show
                        if (preg_match('#^/admin/core/site/adplace/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__admin_core_site_adplace_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'core_ad_place_admin',  '_sonata_name' => 'admin_core_site_adplace_show',  '_locale' => 'ru',));
                        }

                        // ru__RG__admin_core_site_adplace_export
                        if ($pathinfo === '/admin/core/site/adplace/export') {
                            return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::exportAction',  '_sonata_admin' => 'core_ad_place_admin',  '_sonata_name' => 'admin_core_site_adplace_export',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_site_adplace_export',);
                        }

                    }

                    if (0 === strpos($pathinfo, '/admin/core/site/section')) {
                        // ru__RG__admin_core_site_section_list
                        if ($pathinfo === '/admin/core/site/section/list') {
                            return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::listAction',  '_sonata_admin' => 'core_section_admin',  '_sonata_name' => 'admin_core_site_section_list',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_site_section_list',);
                        }

                        // ru__RG__admin_core_site_section_create
                        if ($pathinfo === '/admin/core/site/section/create') {
                            return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::createAction',  '_sonata_admin' => 'core_section_admin',  '_sonata_name' => 'admin_core_site_section_create',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_site_section_create',);
                        }

                        // ru__RG__admin_core_site_section_batch
                        if ($pathinfo === '/admin/core/site/section/batch') {
                            return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::batchAction',  '_sonata_admin' => 'core_section_admin',  '_sonata_name' => 'admin_core_site_section_batch',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_site_section_batch',);
                        }

                        // ru__RG__admin_core_site_section_edit
                        if (preg_match('#^/admin/core/site/section/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__admin_core_site_section_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'core_section_admin',  '_sonata_name' => 'admin_core_site_section_edit',  '_locale' => 'ru',));
                        }

                        // ru__RG__admin_core_site_section_delete
                        if (preg_match('#^/admin/core/site/section/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__admin_core_site_section_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'core_section_admin',  '_sonata_name' => 'admin_core_site_section_delete',  '_locale' => 'ru',));
                        }

                        // ru__RG__admin_core_site_section_show
                        if (preg_match('#^/admin/core/site/section/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__admin_core_site_section_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'core_section_admin',  '_sonata_name' => 'admin_core_site_section_show',  '_locale' => 'ru',));
                        }

                        // ru__RG__admin_core_site_section_export
                        if ($pathinfo === '/admin/core/site/section/export') {
                            return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::exportAction',  '_sonata_admin' => 'core_section_admin',  '_sonata_name' => 'admin_core_site_section_export',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_site_section_export',);
                        }
                ...
                if (0 === strpos($pathinfo, '/admin/core/adcompany')) {
                    if (0 === strpos($pathinfo, '/admin/core/adcompany/adcompany')) {
                        // ru__RG__admin_core_adcompany_adcompany_list
                        if ($pathinfo === '/admin/core/adcompany/adcompany/list') {
                            return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::listAction',  '_sonata_admin' => 'core_ad_company_admin',  '_sonata_name' => 'admin_core_adcompany_adcompany_list',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_adcompany_adcompany_list',);
                        }

                        // ru__RG__admin_core_adcompany_adcompany_create
                        if ($pathinfo === '/admin/core/adcompany/adcompany/create') {
                            return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::createAction',  '_sonata_admin' => 'core_ad_company_admin',  '_sonata_name' => 'admin_core_adcompany_adcompany_create',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_adcompany_adcompany_create',);
                        }

                        // ru__RG__admin_core_adcompany_adcompany_batch
                        if ($pathinfo === '/admin/core/adcompany/adcompany/batch') {
                            return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::batchAction',  '_sonata_admin' => 'core_ad_company_admin',  '_sonata_name' => 'admin_core_adcompany_adcompany_batch',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_adcompany_adcompany_batch',);
                        }

                        // ru__RG__admin_core_adcompany_adcompany_edit
                        if (preg_match('#^/admin/core/adcompany/adcompany/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__admin_core_adcompany_adcompany_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'core_ad_company_admin',  '_sonata_name' => 'admin_core_adcompany_adcompany_edit',  '_locale' => 'ru',));
                        }

                        // ru__RG__admin_core_adcompany_adcompany_delete
                        if (preg_match('#^/admin/core/adcompany/adcompany/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__admin_core_adcompany_adcompany_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'core_ad_company_admin',  '_sonata_name' => 'admin_core_adcompany_adcompany_delete',  '_locale' => 'ru',));
                        }

                        // ru__RG__admin_core_adcompany_adcompany_show
                        if (preg_match('#^/admin/core/adcompany/adcompany/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__admin_core_adcompany_adcompany_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'core_ad_company_admin',  '_sonata_name' => 'admin_core_adcompany_adcompany_show',  '_locale' => 'ru',));
                        }

                        // ru__RG__admin_core_adcompany_adcompany_export
                        if ($pathinfo === '/admin/core/adcompany/adcompany/export') {
                            return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::exportAction',  '_sonata_admin' => 'core_ad_company_admin',  '_sonata_name' => 'admin_core_adcompany_adcompany_export',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_adcompany_adcompany_export',);
                        }

                    }

                    if (0 === strpos($pathinfo, '/admin/core/adcompany/placement')) {
                        // ru__RG__admin_core_adcompany_placement_list
                        if ($pathinfo === '/admin/core/adcompany/placement/list') {
                            return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::listAction',  '_sonata_admin' => 'core_placement_admin',  '_sonata_name' => 'admin_core_adcompany_placement_list',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_adcompany_placement_list',);
                        }

                        // ru__RG__admin_core_adcompany_placement_create
                        if ($pathinfo === '/admin/core/adcompany/placement/create') {
                            return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::createAction',  '_sonata_admin' => 'core_placement_admin',  '_sonata_name' => 'admin_core_adcompany_placement_create',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_adcompany_placement_create',);
                        }

                        // ru__RG__admin_core_adcompany_placement_batch
                        if ($pathinfo === '/admin/core/adcompany/placement/batch') {
                            return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::batchAction',  '_sonata_admin' => 'core_placement_admin',  '_sonata_name' => 'admin_core_adcompany_placement_batch',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_adcompany_placement_batch',);
                        }

                        // ru__RG__admin_core_adcompany_placement_edit
                        if (preg_match('#^/admin/core/adcompany/placement/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__admin_core_adcompany_placement_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'core_placement_admin',  '_sonata_name' => 'admin_core_adcompany_placement_edit',  '_locale' => 'ru',));
                        }

                        // ru__RG__admin_core_adcompany_placement_delete
                        if (preg_match('#^/admin/core/adcompany/placement/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__admin_core_adcompany_placement_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'core_placement_admin',  '_sonata_name' => 'admin_core_adcompany_placement_delete',  '_locale' => 'ru',));
                        }

                        // ru__RG__admin_core_adcompany_placement_show
                        if (preg_match('#^/admin/core/adcompany/placement/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__admin_core_adcompany_placement_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'core_placement_admin',  '_sonata_name' => 'admin_core_adcompany_placement_show',  '_locale' => 'ru',));
                        }

                        // ru__RG__admin_core_adcompany_placement_export
                        if ($pathinfo === '/admin/core/adcompany/placement/export') {
                            return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::exportAction',  '_sonata_admin' => 'core_placement_admin',  '_sonata_name' => 'admin_core_adcompany_placement_export',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_adcompany_placement_export',);
                        }

                        if (0 === strpos($pathinfo, '/admin/core/adcompany/placementbanner')) {
                            // ru__RG__admin_core_adcompany_placementbanner_list
                            if ($pathinfo === '/admin/core/adcompany/placementbanner/list') {
                                return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::listAction',  '_sonata_admin' => 'core_placement_banner_admin',  '_sonata_name' => 'admin_core_adcompany_placementbanner_list',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_adcompany_placementbanner_list',);
                            }

                            // ru__RG__admin_core_adcompany_placementbanner_create
                            if ($pathinfo === '/admin/core/adcompany/placementbanner/create') {
                                return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::createAction',  '_sonata_admin' => 'core_placement_banner_admin',  '_sonata_name' => 'admin_core_adcompany_placementbanner_create',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_adcompany_placementbanner_create',);
                            }

                            // ru__RG__admin_core_adcompany_placementbanner_batch
                            if ($pathinfo === '/admin/core/adcompany/placementbanner/batch') {
                                return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::batchAction',  '_sonata_admin' => 'core_placement_banner_admin',  '_sonata_name' => 'admin_core_adcompany_placementbanner_batch',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_adcompany_placementbanner_batch',);
                            }

                            // ru__RG__admin_core_adcompany_placementbanner_edit
                            if (preg_match('#^/admin/core/adcompany/placementbanner/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                                return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__admin_core_adcompany_placementbanner_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'core_placement_banner_admin',  '_sonata_name' => 'admin_core_adcompany_placementbanner_edit',  '_locale' => 'ru',));
                            }

                            // ru__RG__admin_core_adcompany_placementbanner_delete
                            if (preg_match('#^/admin/core/adcompany/placementbanner/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                                return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__admin_core_adcompany_placementbanner_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'core_placement_banner_admin',  '_sonata_name' => 'admin_core_adcompany_placementbanner_delete',  '_locale' => 'ru',));
                            }

                            // ru__RG__admin_core_adcompany_placementbanner_show
                            if (preg_match('#^/admin/core/adcompany/placementbanner/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                                return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__admin_core_adcompany_placementbanner_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'core_placement_banner_admin',  '_sonata_name' => 'admin_core_adcompany_placementbanner_show',  '_locale' => 'ru',));
                            }

                            // ru__RG__admin_core_adcompany_placementbanner_export
                            if ($pathinfo === '/admin/core/adcompany/placementbanner/export') {
                                return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::exportAction',  '_sonata_admin' => 'core_placement_banner_admin',  '_sonata_name' => 'admin_core_adcompany_placementbanner_export',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_adcompany_placementbanner_export',);
                            }
                ...
                if (0 === strpos($pathinfo, '/admin/core/file')) {
                    ...
                    if (0 === strpos($pathinfo, '/admin/core/file/flashfile')) {
                        // ru__RG__admin_core_file_flashfile_list
                        if ($pathinfo === '/admin/core/file/flashfile/list') {
                            return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::listAction',  '_sonata_admin' => 'core_file_document_admin',  '_sonata_name' => 'admin_core_file_flashfile_list',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_file_flashfile_list',);
                        }

                        // ru__RG__admin_core_file_flashfile_create
                        if ($pathinfo === '/admin/core/file/flashfile/create') {
                            return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::createAction',  '_sonata_admin' => 'core_file_document_admin',  '_sonata_name' => 'admin_core_file_flashfile_create',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_file_flashfile_create',);
                        }

                        // ru__RG__admin_core_file_flashfile_batch
                        if ($pathinfo === '/admin/core/file/flashfile/batch') {
                            return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::batchAction',  '_sonata_admin' => 'core_file_document_admin',  '_sonata_name' => 'admin_core_file_flashfile_batch',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_file_flashfile_batch',);
                        }

                        // ru__RG__admin_core_file_flashfile_edit
                        if (preg_match('#^/admin/core/file/flashfile/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__admin_core_file_flashfile_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'core_file_document_admin',  '_sonata_name' => 'admin_core_file_flashfile_edit',  '_locale' => 'ru',));
                        }

                        // ru__RG__admin_core_file_flashfile_delete
                        if (preg_match('#^/admin/core/file/flashfile/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__admin_core_file_flashfile_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'core_file_document_admin',  '_sonata_name' => 'admin_core_file_flashfile_delete',  '_locale' => 'ru',));
                        }

                        // ru__RG__admin_core_file_flashfile_show
                        if (preg_match('#^/admin/core/file/flashfile/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__admin_core_file_flashfile_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'core_file_document_admin',  '_sonata_name' => 'admin_core_file_flashfile_show',  '_locale' => 'ru',));
                        }

                        // ru__RG__admin_core_file_flashfile_export
                        if ($pathinfo === '/admin/core/file/flashfile/export') {
                            return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::exportAction',  '_sonata_admin' => 'core_file_document_admin',  '_sonata_name' => 'admin_core_file_flashfile_export',  '_locale' => 'ru',  '_route' => 'ru__RG__admin_core_file_flashfile_export',);
                        }

                        // ru__RG__admin_core_file_flashfile_history
                        if (preg_match('#^/admin/core/file/flashfile/(?P<id>[^/]++)/history$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__admin_core_file_flashfile_history')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::historyAction',  '_sonata_admin' => 'core_file_document_admin',  '_sonata_name' => 'admin_core_file_flashfile_history',  '_locale' => 'ru',));
                        }

                        // ru__RG__admin_core_file_flashfile_history_view_revision
                        if (preg_match('#^/admin/core/file/flashfile/(?P<id>[^/]++)/history/(?P<revision>[^/]++)/view$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__admin_core_file_flashfile_history_view_revision')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::historyViewRevisionAction',  '_sonata_admin' => 'core_file_document_admin',  '_sonata_name' => 'admin_core_file_flashfile_history_view_revision',  '_locale' => 'ru',));
                        }
        ...
        if (0 === strpos($pathinfo, '/cabinet')) {
            if (0 === strpos($pathinfo, '/cabinet/site')) {
                if (0 === strpos($pathinfo, '/cabinet/sites')) {
                    // ru__RG__core_cabinet_site_list_first_page
                    if ($pathinfo === '/cabinet/sites.html') {
                        $requiredSchemes = array (  'http' => 0,);
                        if (!isset($requiredSchemes[$this->context->getScheme()])) {
                            return $this->redirect($pathinfo, 'ru__RG__core_cabinet_site_list_first_page', key($requiredSchemes));
                        }

                        return array (  '_controller' => 'Core\\SiteBundle\\Controller\\CabinetController::listAction',  '_locale' => 'ru',  '_route' => 'ru__RG__core_cabinet_site_list_first_page',);
                    }

                    // ru__RG__core_cabinet_site_list
                    if (preg_match('#^/cabinet/sites/(?P<page>\\d+)\\.html$#s', $pathinfo, $matches)) {
                        $requiredSchemes = array (  'http' => 0,);
                        if (!isset($requiredSchemes[$this->context->getScheme()])) {
                            return $this->redirect($pathinfo, 'ru__RG__core_cabinet_site_list', key($requiredSchemes));
                        }

                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__core_cabinet_site_list')), array (  '_controller' => 'Core\\SiteBundle\\Controller\\CabinetController::listAction',  'page' => 1,  '_locale' => 'ru',));
                    }

                }

                if (0 === strpos($pathinfo, '/cabinet/site_')) {
                    // ru__RG__core_cabinet_site_edit
                    if (0 === strpos($pathinfo, '/cabinet/site_edit') && preg_match('#^/cabinet/site_edit_(?P<id>\\d+)\\.html$#s', $pathinfo, $matches)) {
                        $requiredSchemes = array (  'http' => 0,);
                        if (!isset($requiredSchemes[$this->context->getScheme()])) {
                            return $this->redirect($pathinfo, 'ru__RG__core_cabinet_site_edit', key($requiredSchemes));
                        }

                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__core_cabinet_site_edit')), array (  '_controller' => 'Core\\SiteBundle\\Controller\\CabinetController::editAction',  '_locale' => 'ru',));
                    }

                    // ru__RG__core_cabinet_site_create
                    if ($pathinfo === '/cabinet/site_create.html') {
                        $requiredSchemes = array (  'http' => 0,);
                        if (!isset($requiredSchemes[$this->context->getScheme()])) {
                            return $this->redirect($pathinfo, 'ru__RG__core_cabinet_site_create', key($requiredSchemes));
                        }

                        return array (  '_controller' => 'Core\\SiteBundle\\Controller\\CabinetController::createAction',  '_locale' => 'ru',  '_route' => 'ru__RG__core_cabinet_site_create',);
                    }

                    // ru__RG__core_cabinet_site_delete
                    if (0 === strpos($pathinfo, '/cabinet/site_delete') && preg_match('#^/cabinet/site_delete_(?P<id>\\d+)\\.html$#s', $pathinfo, $matches)) {
                        $requiredSchemes = array (  'http' => 0,);
                        if (!isset($requiredSchemes[$this->context->getScheme()])) {
                            return $this->redirect($pathinfo, 'ru__RG__core_cabinet_site_delete', key($requiredSchemes));
                        }

                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__core_cabinet_site_delete')), array (  '_controller' => 'Core\\SiteBundle\\Controller\\CabinetController::deleteAction',  '_locale' => 'ru',));
                    }
            ...
            if (0 === strpos($pathinfo, '/cabinet/adplace')) {
                if (0 === strpos($pathinfo, '/cabinet/adplaces')) {
                    // ru__RG__core_cabinet_adplace_list_first_page
                    if ($pathinfo === '/cabinet/adplaces.html') {
                        $requiredSchemes = array (  'http' => 0,);
                        if (!isset($requiredSchemes[$this->context->getScheme()])) {
                            return $this->redirect($pathinfo, 'ru__RG__core_cabinet_adplace_list_first_page', key($requiredSchemes));
                        }

                        return array (  '_controller' => 'Core\\SiteBundle\\Controller\\AdPlaceCabinetController::listAction',  '_locale' => 'ru',  '_route' => 'ru__RG__core_cabinet_adplace_list_first_page',);
                    }

                    // ru__RG__core_cabinet_adplace_list
                    if (preg_match('#^/cabinet/adplaces/(?P<page>\\d+)\\.html$#s', $pathinfo, $matches)) {
                        $requiredSchemes = array (  'http' => 0,);
                        if (!isset($requiredSchemes[$this->context->getScheme()])) {
                            return $this->redirect($pathinfo, 'ru__RG__core_cabinet_adplace_list', key($requiredSchemes));
                        }

                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__core_cabinet_adplace_list')), array (  '_controller' => 'Core\\SiteBundle\\Controller\\AdPlaceCabinetController::listAction',  'page' => 1,  '_locale' => 'ru',));
                    }

                }

                if (0 === strpos($pathinfo, '/cabinet/adplace_')) {
                    // ru__RG__core_cabinet_adplace_edit
                    if (0 === strpos($pathinfo, '/cabinet/adplace_edit') && preg_match('#^/cabinet/adplace_edit_(?P<id>\\d+)\\.html$#s', $pathinfo, $matches)) {
                        $requiredSchemes = array (  'http' => 0,);
                        if (!isset($requiredSchemes[$this->context->getScheme()])) {
                            return $this->redirect($pathinfo, 'ru__RG__core_cabinet_adplace_edit', key($requiredSchemes));
                        }

                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__core_cabinet_adplace_edit')), array (  '_controller' => 'Core\\SiteBundle\\Controller\\AdPlaceCabinetController::editAction',  '_locale' => 'ru',));
                    }

                    // ru__RG__core_cabinet_adplace_create
                    if ($pathinfo === '/cabinet/adplace_create.html') {
                        $requiredSchemes = array (  'http' => 0,);
                        if (!isset($requiredSchemes[$this->context->getScheme()])) {
                            return $this->redirect($pathinfo, 'ru__RG__core_cabinet_adplace_create', key($requiredSchemes));
                        }

                        return array (  '_controller' => 'Core\\SiteBundle\\Controller\\AdPlaceCabinetController::createAction',  '_locale' => 'ru',  '_route' => 'ru__RG__core_cabinet_adplace_create',);
                    }

                    // ru__RG__core_cabinet_adplace_delete
                    if (0 === strpos($pathinfo, '/cabinet/adplace_delete') && preg_match('#^/cabinet/adplace_delete_(?P<id>\\d+)\\.html$#s', $pathinfo, $matches)) {
                        $requiredSchemes = array (  'http' => 0,);
                        if (!isset($requiredSchemes[$this->context->getScheme()])) {
                            return $this->redirect($pathinfo, 'ru__RG__core_cabinet_adplace_delete', key($requiredSchemes));
                        }

                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__core_cabinet_adplace_delete')), array (  '_controller' => 'Core\\SiteBundle\\Controller\\AdPlaceCabinetController::deleteAction',  '_locale' => 'ru',));
                    }
            ...
            if (0 === strpos($pathinfo, '/cabinet/section')) {
                if (0 === strpos($pathinfo, '/cabinet/sections')) {
                    // ru__RG__core_cabinet_section_list_first_page
                    if ($pathinfo === '/cabinet/sections.html') {
                        $requiredSchemes = array (  'http' => 0,);
                        if (!isset($requiredSchemes[$this->context->getScheme()])) {
                            return $this->redirect($pathinfo, 'ru__RG__core_cabinet_section_list_first_page', key($requiredSchemes));
                        }

                        return array (  '_controller' => 'Core\\SiteBundle\\Controller\\SectionCabinetController::listAction',  '_locale' => 'ru',  '_route' => 'ru__RG__core_cabinet_section_list_first_page',);
                    }

                    // ru__RG__core_cabinet_section_list
                    if (preg_match('#^/cabinet/sections/(?P<page>\\d+)\\.html$#s', $pathinfo, $matches)) {
                        $requiredSchemes = array (  'http' => 0,);
                        if (!isset($requiredSchemes[$this->context->getScheme()])) {
                            return $this->redirect($pathinfo, 'ru__RG__core_cabinet_section_list', key($requiredSchemes));
                        }

                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__core_cabinet_section_list')), array (  '_controller' => 'Core\\SiteBundle\\Controller\\SectionCabinetController::listAction',  'page' => 1,  '_locale' => 'ru',));
                    }

                }

                if (0 === strpos($pathinfo, '/cabinet/section_')) {
                    // ru__RG__core_cabinet_section_edit
                    if (0 === strpos($pathinfo, '/cabinet/section_edit') && preg_match('#^/cabinet/section_edit_(?P<id>\\d+)\\.html$#s', $pathinfo, $matches)) {
                        $requiredSchemes = array (  'http' => 0,);
                        if (!isset($requiredSchemes[$this->context->getScheme()])) {
                            return $this->redirect($pathinfo, 'ru__RG__core_cabinet_section_edit', key($requiredSchemes));
                        }

                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__core_cabinet_section_edit')), array (  '_controller' => 'Core\\SiteBundle\\Controller\\SectionCabinetController::editAction',  '_locale' => 'ru',));
                    }

                    // ru__RG__core_cabinet_section_create
                    if ($pathinfo === '/cabinet/section_create.html') {
                        $requiredSchemes = array (  'http' => 0,);
                        if (!isset($requiredSchemes[$this->context->getScheme()])) {
                            return $this->redirect($pathinfo, 'ru__RG__core_cabinet_section_create', key($requiredSchemes));
                        }

                        return array (  '_controller' => 'Core\\SiteBundle\\Controller\\SectionCabinetController::createAction',  '_locale' => 'ru',  '_route' => 'ru__RG__core_cabinet_section_create',);
                    }

                    // ru__RG__core_cabinet_section_delete
                    if (0 === strpos($pathinfo, '/cabinet/section_delete') && preg_match('#^/cabinet/section_delete_(?P<id>[^/\\.]++)\\.html$#s', $pathinfo, $matches)) {
                        $requiredSchemes = array (  'http' => 0,);
                        if (!isset($requiredSchemes[$this->context->getScheme()])) {
                            return $this->redirect($pathinfo, 'ru__RG__core_cabinet_section_delete', key($requiredSchemes));
                        }

                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__core_cabinet_section_delete')), array (  '_controller' => 'Core\\SiteBundle\\Controller\\SectionCabinetController::deleteAction',  '_locale' => 'ru',));
                    }
            ...
            if (0 === strpos($pathinfo, '/cabinet/banner')) {
                if (0 === strpos($pathinfo, '/cabinet/banners')) {
                    // ru__RG__core_cabinet_banner_list_first_page
                    if ($pathinfo === '/cabinet/banners.html') {
                        $requiredSchemes = array (  'http' => 0,);
                        if (!isset($requiredSchemes[$this->context->getScheme()])) {
                            return $this->redirect($pathinfo, 'ru__RG__core_cabinet_banner_list_first_page', key($requiredSchemes));
                        }

                        return array (  '_controller' => 'Core\\BannerBundle\\Controller\\CabinetController::listAction',  '_locale' => 'ru',  '_route' => 'ru__RG__core_cabinet_banner_list_first_page',);
                    }

                    // ru__RG__core_cabinet_banner_list
                    if (preg_match('#^/cabinet/banners/(?P<page>\\d+)\\.html$#s', $pathinfo, $matches)) {
                        $requiredSchemes = array (  'http' => 0,);
                        if (!isset($requiredSchemes[$this->context->getScheme()])) {
                            return $this->redirect($pathinfo, 'ru__RG__core_cabinet_banner_list', key($requiredSchemes));
                        }

                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__core_cabinet_banner_list')), array (  '_controller' => 'Core\\BannerBundle\\Controller\\CabinetController::listAction',  'page' => 1,  '_locale' => 'ru',));
                    }

                }

                if (0 === strpos($pathinfo, '/cabinet/banner_')) {
                    // ru__RG__core_cabinet_banner_edit
                    if (0 === strpos($pathinfo, '/cabinet/banner_edit') && preg_match('#^/cabinet/banner_edit_(?P<id>\\d+)\\.html$#s', $pathinfo, $matches)) {
                        $requiredSchemes = array (  'http' => 0,);
                        if (!isset($requiredSchemes[$this->context->getScheme()])) {
                            return $this->redirect($pathinfo, 'ru__RG__core_cabinet_banner_edit', key($requiredSchemes));
                        }

                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__core_cabinet_banner_edit')), array (  '_controller' => 'Core\\BannerBundle\\Controller\\CabinetController::editAction',  '_locale' => 'ru',));
                    }

                    // ru__RG__core_cabinet_banner_create
                    if ($pathinfo === '/cabinet/banner_create.html') {
                        $requiredSchemes = array (  'http' => 0,);
                        if (!isset($requiredSchemes[$this->context->getScheme()])) {
                            return $this->redirect($pathinfo, 'ru__RG__core_cabinet_banner_create', key($requiredSchemes));
                        }

                        return array (  '_controller' => 'Core\\BannerBundle\\Controller\\CabinetController::createAction',  '_locale' => 'ru',  '_route' => 'ru__RG__core_cabinet_banner_create',);
                    }

                    // ru__RG__core_cabinet_banner_delete
                    if (0 === strpos($pathinfo, '/cabinet/banner_delete') && preg_match('#^/cabinet/banner_delete_(?P<id>\\d+)\\.html$#s', $pathinfo, $matches)) {
                        $requiredSchemes = array (  'http' => 0,);
                        if (!isset($requiredSchemes[$this->context->getScheme()])) {
                            return $this->redirect($pathinfo, 'ru__RG__core_cabinet_banner_delete', key($requiredSchemes));
                        }

                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'ru__RG__core_cabinet_banner_delete')), array (  '_controller' => 'Core\\BannerBundle\\Controller\\CabinetController::deleteAction',  '_locale' => 'ru',));
                    }
