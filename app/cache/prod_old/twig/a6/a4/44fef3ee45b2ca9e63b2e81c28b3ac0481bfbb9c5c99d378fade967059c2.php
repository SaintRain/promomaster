...
class __TwigTemplate_a6a444fef3ee45b2ca9e63b2e81c28b3ac0481bfbb9c5c99d378fade967059c2 extends Twig_Template
{
...
";
    ...
    public function block_comments_block_email_message($context, array $blocks = array())
    {
        ...
        echo twig_escape_filter($this->env, (isset($context["domain"]) ? $context["domain"] : $this->getContext($context, "domain")), "html", null, true);
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_core_order_subscribers_toproductbyorder_edit", array("id" => $this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "id", array()))), "html", null, true);
        echo "\">№";
