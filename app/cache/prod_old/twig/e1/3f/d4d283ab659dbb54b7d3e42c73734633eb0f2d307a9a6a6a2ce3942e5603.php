...
class __TwigTemplate_e13fd4d283ab659dbb54b7d3e42c73734633eb0f2d307a9a6a6a2ce3942e5603 extends Twig_Template
{
    ...
    public function block_remote_video_form_widget($context, array $blocks = array())
    {
        ...
        echo "        <fieldset class=\"remote-wrapper\">
            <div class=\"span6\">
                <div class=\"control-group\">
                    ";
        // line 15
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), ("caption" . twig_capitalize_string_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "request", array()), "locale", array())))), 'label', array("label_attr" => array("class" => " control-label extra-label")));
        echo "
                    <div class=\"controls sonata-ba-field sonata-ba-field-standard-natural\">
                        ";
        // line 17
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), ("caption" . twig_capitalize_string_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "request", array()), "locale", array())))), 'widget');
        echo "
                    </div>
                </div>
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["hostings"]) ? $context["hostings"] : $this->getContext($context, "hostings")));
        foreach ($context['_seq'] as $context["_key"] => $context["hosting"]) {
            ...
            echo twig_escape_filter($this->env, (isset($context["playerUri"]) ? $context["playerUri"] : $this->getContext($context, "playerUri")), "html", null, true);
