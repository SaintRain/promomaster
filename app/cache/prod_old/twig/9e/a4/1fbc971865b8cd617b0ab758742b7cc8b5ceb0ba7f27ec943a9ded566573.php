...
class __TwigTemplate_9ea41fbc971865b8cd617b0ab758742b7cc8b5ceb0ba7f27ec943a9ded566573 extends Twig_Template
{
    ...
    public function block_tree_select_widget($context, array $blocks = array())
    {
        ...
        if ($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "vars", array(), "any", false, true), "attr", array(), "any", false, true), "class", array(), "array", true, true)) {
            echo " ";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "vars", array()), "attr", array()), "class", array(), "array"), "html", null, true);
        }
        echo "\">
            ";
        // line 4
        $context["formValue"] = (($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "vars", array(), "any", false, true), "value", array(), "any", false, true), "id", array(), "any", true, true)) ? ($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "vars", array()), "value", array()), "id", array())) : ($this->getAttribute($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "vars", array()), "value", array())));
        // line 5
        echo "            ";
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), 'widget', array("value" => (isset($context["formValue"]) ? $context["formValue"] : $this->getContext($context, "formValue"))));
        echo "
        </div>
    ";
        ...
        // line 8
        echo "    ";
        echo (isset($context["tree"]) ? $context["tree"] : $this->getContext($context, "tree"));
        echo "
";
        // line 13
        echo "<script>
    (function(\$){
        ...
        echo "'
                    ...
                    allowParentSelect: ";
        // line 85
        if ((isset($context["allow_parent_select"]) ? $context["allow_parent_select"] : $this->getContext($context, "allow_parent_select"))) {
            echo "true";
        } else {
            echo "false";
        }
