...
class __TwigTemplate_0b8ffb6a6c47ed202b04c6abc7b2a10792c44596993c83bdfb2d6db0616c7f92 extends Twig_Template
{
    ...
    ";
        ...
        if ($this->getAttribute($this->getAttribute((isset($context["order"]) ? $context["order"] : $this->getContext($context, "order")), "seller", array()), "ogrn", array())) {
            echo ", ОГРН: ";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["order"]) ? $context["order"] : $this->getContext($context, "order")), "seller", array()), "ogrn", array()), "html", null, true);
        }
        echo "</td></tr>
                    <tr><td>&nbsp;</td></tr>
        ...
        if (($this->getAttribute($this->getAttribute((isset($context["order"]) ? $context["order"] : null), "deliveryCity", array(), "any", false, true), "name", array(), "any", true, true) || $this->getAttribute((isset($context["order"]) ? $context["order"] : $this->getContext($context, "order")), "deliveryAddress", array()))) {
            echo ", ";
        ...
        if ($this->getAttribute((isset($context["costInfo"]) ? $context["costInfo"] : null), "history_info", array(), "any", true, true)) {
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["costInfo"]) ? $context["costInfo"] : $this->getContext($context, "costInfo")), "history_info", array()), "total_quantity", array()), "html", null, true);
        } else {
        ...
        // line 52
        if ($this->getAttribute((isset($context["costInfo"]) ? $context["costInfo"] : null), "history_info", array(), "any", true, true)) {
            echo twig_escape_filter($this->env, $this->env->getExtension('money_extension')->moneyFormatFunction($this->getAttribute($this->getAttribute((isset($context["costInfo"]) ? $context["costInfo"] : $this->getContext($context, "costInfo")), "history_info", array()), "composition_total_cost", array())), "html", null, true);
        } else {
