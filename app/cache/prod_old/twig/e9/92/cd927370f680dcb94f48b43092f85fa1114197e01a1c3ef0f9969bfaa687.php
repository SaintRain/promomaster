...
class __TwigTemplate_e992cd927370f680dcb94f48b43092f85fa1114197e01a1c3ef0f9969bfaa687 extends Twig_Template
{
    ...
    public function block_product_modifications_widget($context, array $blocks = array())
    {
        // line 3
        echo "        ";
        $context["general"] = $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["sonata_admin"]) ? $context["sonata_admin"] : $this->getContext($context, "sonata_admin")), "admin", array()), "subject", array()), (isset($context["mappedBy"]) ? $context["mappedBy"] : $this->getContext($context, "mappedBy"))), "general", array());
        // line 4
        echo "        ";
        if ($this->getAttribute((isset($context["general"]) ? $context["general"] : null), "id", array(), "any", true, true)) {
            // line 5
            echo "            ";
            $context["general_id"] = $this->getAttribute((isset($context["general"]) ? $context["general"] : $this->getContext($context, "general")), "id", array());
            // line 6
            echo "        ";
        } else {
            // line 7
...
";
        ...
        if ($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array(), "any", false, true), "get", array(0 => $this->getAttribute($this->getAttribute((isset($context["sonata_admin"]) ? $context["sonata_admin"] : $this->getContext($context, "sonata_admin")), "admin", array()), "uniqid", array())), "method", false, true), (isset($context["name"]) ? $context["name"] : $this->getContext($context, "name")), array(), "array", true, true)) {
            ...
            // line 20
            echo "    ";
            $context["unions"] = $this->env->getExtension('checked_modification')->getModificationDataList($this->getAttribute($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "vars", array()), "data", array()), (isset($context["dInfo"]) ? $context["dInfo"] : $this->getContext($context, "dInfo")), $this->getAttribute((isset($context["options"]) ? $context["options"] : $this->getContext($context, "options")), "class", array()));
        } else {
            // line 22
            echo "    ";
            $context["dInfo"] = false;
...
<script>
    ...
    class: \"";
        ...
        echo "\",
            deleteable: \"";
        // line 40
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "vars", array()), "options", array()), "deleteable", array()), "html", null, true);
        echo "\",
            hideSubjectInList: \"";
        // line 41
    ...
    var indexPosition = \$('.";
        ...
        echo "_createModification(data) {
                                                            \$.post(
                                                                    \"";
        // line 87
        echo $this->env->getExtension('routing')->getPath($this->getAttribute((isset($context["options"]) ? $context["options"] : $this->getContext($context, "options")), "create_route", array()));
        echo "\",
                                                                    data,
                                                                    function(res) {
                                                                    addUnionRows(res, \"";
    ...
    <div id=\"field_container_";
            ...
            if (((!$this->getAttribute((isset($context["unions"]) ? $context["unions"] : $this->getContext($context, "unions")), "count", array())) || ($this->getAttribute((isset($context["unions"]) ? $context["unions"] : $this->getContext($context, "unions")), "count", array()) < 2))) {
                echo "hide";
            }
            echo "\">
                ";
            // line 154
            echo twig_include($this->env, $context, "CoreProductBundle::Admin/Form/modifications_widget/generate_table.html.twig", array("dInfo" => (isset($context["dInfo"]) ? $context["dInfo"] : $this->getContext($context, "dInfo")), "general_id" => (isset($context["general_id"]) ? $context["general_id"] : $this->getContext($context, "general_id")), "subject_id" => $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["sonata_admin"]) ? $context["sonata_admin"] : $this->getContext($context, "sonata_admin")), "admin", array()), "subject", array()), "id", array()), "mappedBy" => (isset($context["mappedBy"]) ? $context["mappedBy"] : $this->getContext($context, "mappedBy")), "field_id" => (isset($context["id"]) ? $context["id"] : $this->getContext($context, "id")), "field_name" => (isset($context["name"]) ? $context["name"] : $this->getContext($context, "name")), "data" => (isset($context["unions"]) ? $context["unions"] : $this->getContext($context, "unions")), "uniqid" => $this->getAttribute($this->getAttribute((isset($context["sonata_admin"]) ? $context["sonata_admin"] : $this->getContext($context, "sonata_admin")), "admin", array()), "uniqid", array()), "options" => $this->getAttribute($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "vars", array()), "options", array()), "sortable" => (isset($context["sortable"]) ? $context["sortable"] : $this->getContext($context, "sortable"))));
            echo "
        </div>
    </div>
        ";
