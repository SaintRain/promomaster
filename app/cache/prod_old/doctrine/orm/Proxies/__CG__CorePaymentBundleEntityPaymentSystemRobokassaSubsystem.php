 ...
 */
class RobokassaSubsystem extends \Core\PaymentBundle\Entity\PaymentSystem\RobokassaSubsystem implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Core\\PaymentBundle\\Entity\\PaymentSystem\\RobokassaSubsystem' . "\0" . 'id', '' . "\0" . 'Core\\PaymentBundle\\Entity\\PaymentSystem\\RobokassaSubsystem' . "\0" . 'system', '' . "\0" . 'Core\\PaymentBundle\\Entity\\PaymentSystem\\RobokassaSubsystem' . "\0" . 'IncCurrLabel', '' . "\0" . 'Core\\PaymentBundle\\Entity\\PaymentSystem\\RobokassaSubsystem' . "\0" . 'isEnabled', '' . "\0" . 'Core\\PaymentBundle\\Entity\\PaymentSystem\\RobokassaSubsystem' . "\0" . 'isInFooter', 'indexPosition', 'parentSystem', 'captionRu', 'captionEn', 'descriptionRu', 'descriptionEn');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RobokassaSubsystem $proxy) {
    ...
    public function getIncCurrLabel()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIncCurrLabel', array());

        return parent::getIncCurrLabel();
    }
    ...
    public function setIncCurrLabel($IncCurrLabel)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIncCurrLabel', array($IncCurrLabel));

        return parent::setIncCurrLabel($IncCurrLabel);
    }
    ...
    public function getParentSystem()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getParentSystem', array());
    ...
    public function setParentSystem($parentSystem)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setParentSystem', array($parentSystem));

        return parent::setParentSystem($parentSystem);
    }
