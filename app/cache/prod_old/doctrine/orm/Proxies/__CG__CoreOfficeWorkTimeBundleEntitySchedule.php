...
namespace Proxies\__CG__\Core\OfficeWorkTimeBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Schedule extends \Core\OfficeWorkTimeBundle\Entity\Schedule implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Core\\OfficeWorkTimeBundle\\Entity\\Schedule' . "\0" . 'id', '' . "\0" . 'Core\\OfficeWorkTimeBundle\\Entity\\Schedule' . "\0" . 'dateTime', '' . "\0" . 'Core\\OfficeWorkTimeBundle\\Entity\\Schedule' . "\0" . 'type', '' . "\0" . 'Core\\OfficeWorkTimeBundle\\Entity\\Schedule' . "\0" . 'updatedDateTime');
        }
