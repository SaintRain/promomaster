 ...
 */
class UnitSerials extends \Core\LogisticsBundle\Entity\UnitSerials implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Core\\LogisticsBundle\\Entity\\UnitSerials' . "\0" . 'unit', '' . "\0" . 'Core\\LogisticsBundle\\Entity\\UnitSerials' . "\0" . 'value', '' . "\0" . 'Core\\LogisticsBundle\\Entity\\UnitSerials' . "\0" . 'createdDateTime');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UnitSerials $proxy) {
