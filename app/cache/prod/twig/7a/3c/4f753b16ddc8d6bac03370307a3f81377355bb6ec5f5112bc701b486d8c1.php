...
class __TwigTemplate_7a3c4f753b16ddc8d6bac03370307a3f81377355bb6ec5f5112bc701b486d8c1 extends Twig_Template
{
...
";
    ...
    public function block_main_content($context, array $blocks = array())
    {
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "session", array()), "flashbag", array()), "get", array(0 => "contactagent_success"), "method"));
        ...
        echo "            <div class=\"cabinet_address_add no_limit\">
                <div class=\"brown_gradient_box\">
                    ";
        // line 25
        $this->env->getExtension('form')->renderer->setTheme((isset($context["indiForm"]) ? $context["indiForm"] : null), array(0 => "CoreCommonBundle:Form:row.html.twig"));
        // line 26
        echo "                    ";
        $this->env->getExtension('form')->renderer->setTheme((isset($context["legalForm"]) ? $context["legalForm"] : null), array(0 => "CoreCommonBundle:Form:row.html.twig"));
        // line 27
        ...
        echo "/>
                    ...
                    ";
        // line 41
        $this->env->loadTemplate("ApplicationSonataUserBundle:Contragent:Form/indi_form.html.twig")->display(array_merge($context, array("form" => (isset($context["indiForm"]) ? $context["indiForm"] : null))));
        // line 42
        echo "                    ";
        $this->env->loadTemplate("ApplicationSonataUserBundle:Contragent:Form/legal_form.html.twig")->display(array_merge($context, array("form" => (isset($context["legalForm"]) ? $context["legalForm"] : null))));
        // line 43
        echo "                </div>
            </div>
        </section>
...
";
    ...
    {
        return array (  151 => 43,  148 => 42,  146 => 41,  137 => 37,  133 => 36,  123 => 31,  119 => 30,  114 => 27,  111 => 26,  109 => 25,  105 => 23,  96 => 20,  93 => 19,  89 => 18,  84 => 15,  81 => 14,  76 => 12,  62 => 11,  58 => 10,  53 => 9,  50 => 8,  44 => 6,  38 => 5,  32 => 4,);
    }
}
