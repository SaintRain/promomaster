...
class __TwigTemplate_23d95f511813bd3a0549a3b919ad2c1dcc18821c22035e52deb7cbe9ab5b690a extends Twig_Template
{
    ...
    <script>
        \$(document).ready(function() {
            var categoryMainId =";
        // line 5
        if ($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["sonata_admin"]) ? $context["sonata_admin"] : null), "admin", array()), "subject", array()), "categoryMain", array())) {
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["sonata_admin"]) ? $context["sonata_admin"] : null), "admin", array()), "subject", array()), "categoryMain", array()), "id", array()), "html", null, true);
        } else {
            echo " false";
        }
        echo ",
