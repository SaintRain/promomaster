...
class __TwigTemplate_3f613cab5aeb13a5d1625f5c6af5d80f238fd85b4cf4581f90472a2d9b89f3d4 extends Twig_Template
{
...
";
    ...
    public function block_comments_block_email_message($context, array $blocks = array())
    {
        ...
        echo twig_escape_filter($this->env, (isset($context["domain"]) ? $context["domain"] : null), "html", null, true);
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_sonata_user_user_edit", array("id" => $this->getAttribute((isset($context["object"]) ? $context["object"] : null), "id", array()))), "html", null, true);
        echo "\">";
