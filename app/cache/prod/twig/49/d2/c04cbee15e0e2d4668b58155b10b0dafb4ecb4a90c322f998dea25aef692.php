...
class __TwigTemplate_49d2c04cbee15e0e2d4668b58155b10b0dafb4ecb4a90c322f998dea25aef692 extends Twig_Template
{
    ...
    public function block_cell_product_price($context, array $blocks = array())
    {
        ...
        if ($this->getAttribute((isset($context["product"]) ? $context["product"] : null), "isDiscontinued", array())) {
            ...
            echo "ПРОИЗВОДСТВА</div>
                        ...
                        ";
        } elseif ($this->getAttribute((isset($context["product"]) ? $context["product"] : null), "orderOnly", array())) {
            // line 85
            echo "
            ...
            if ($this->getAttribute((isset($context["product"]) ? $context["product"] : null), "getAvailabilityQuantityReal", array())) {
                ...
                echo " СКЛАДЕ</div>
                                ...
                                ";
            } elseif ($this->getAttribute((isset($context["product"]) ? $context["product"] : null), "getAvailabilityQuantityVirtualReal", array())) {
                // line 95
                echo "
