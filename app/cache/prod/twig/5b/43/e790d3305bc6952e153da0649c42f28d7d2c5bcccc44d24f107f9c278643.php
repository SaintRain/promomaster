...
class __TwigTemplate_5b43e790d3305bc6952e153da0649c42f28d7d2c5bcccc44d24f107f9c278643 extends Twig_Template
{
...
<div class=\"header_usercart\">
    <div class=\"header_usercart_pad\">
        ...
        if ($this->getAttribute((isset($context["order"]) ? $context["order"] : null), "total_quantity", array(), "any", true, true)) {
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["order"]) ? $context["order"] : null), "total_quantity", array()), "html", null, true);
        } else {
            echo "0";
        }
        echo "</span>
        ...
        // line 10
        if (($this->getAttribute((isset($context["order"]) ? $context["order"] : null), "total_quantity", array(), "any", true, true) && ($this->getAttribute((isset($context["order"]) ? $context["order"] : null), "total_quantity", array()) > 0))) {
            // line 11
            if ($this->getAttribute((isset($context["order"]) ? $context["order"] : null), "total_quantity", array(), "any", true, true)) {
                // line 12
                echo twig_escape_filter($this->env, (($this->getAttribute((isset($context["order"]) ? $context["order"] : null), "total_quantity", array()) . " ") . $this->env->getExtension('decline_of_number_extension')->declOfNumFunction($this->getAttribute((isset($context["order"]) ? $context["order"] : null), "total_quantity", array()), array(0 => "товар", 1 => "товара", 2 => "товаров"))), "html", null, true);
            }
            // line 14
            echo ", ";
            if ($this->getAttribute((isset($context["order"]) ? $context["order"] : null), "total_cost", array(), "any", true, true)) {
                // line 15
                echo twig_escape_filter($this->env, $this->env->getExtension('money_extension')->moneyFormatFunction($this->getAttribute((isset($context["order"]) ? $context["order"] : null), "total_cost", array())), "html", null, true);
            }
            // line 16
            echo " ";
            echo twig_escape_filter($this->env, $this->env->getExtension('money_extension')->currencyFormatFunction(), "html", null, true);
