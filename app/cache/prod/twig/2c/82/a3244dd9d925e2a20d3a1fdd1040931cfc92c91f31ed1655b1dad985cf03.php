...
class __TwigTemplate_2c82a3244dd9d925e2a20d3a1fdd1040931cfc92c91f31ed1655b1dad985cf03 extends Twig_Template
{
    ...
    <script>
        ...
        // line 10
        if ($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["sonata_admin"]) ? $context["sonata_admin"] : null), "admin", array()), "subject", array()), "manufacturerMain", array())) {
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["sonata_admin"]) ? $context["sonata_admin"] : null), "admin", array()), "subject", array()), "manufacturerMain", array()), "id", array()), "html", null, true);
        } else {
            echo " false";
        }
        echo ",
