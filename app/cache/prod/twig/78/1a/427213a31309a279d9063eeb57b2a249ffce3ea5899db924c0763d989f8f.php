...
class __TwigTemplate_781a427213a31309a279d9063eeb57b2a249ffce3ea5899db924c0763d989f8f extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        if (array_key_exists("contragent", $context)) {
            ...
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("application_sonata_user_contact_edit", array("contactId" => $this->getAttribute((isset($context["contact"]) ? $context["contact"] : null), "id", array()))), "html", null, true);
        }
        echo "\" method=\"POST\" ";
    ...
    ";
        ...
        if ($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "passport", array(), "any", true, true)) {
            ...
            ";
            // line 13
            echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "passport", array()), 'row');
            echo "
        </fieldset>
    ";
        }
    ...
    ";
        ...
        ";
        // line 24
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "address", array()), 'row');
        echo "
        ";
        // line 25
        if ($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "postIndex", array(), "any", true, true)) {
            ...
            echo "            <div class=\"form_row \">
                ";
            // line 27
            echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "postIndex", array()), 'label', array("label_attr" => array("class" => "form_label")));
            echo "
                <div class=\"form_row_field";
            // line 28
            if ($this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "postIndex", array()), 'errors')) {
                echo " form_field_error";
            }
            echo "\">
                    ";
            // line 29
            echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "postIndex", array()), 'widget');
            echo "
            ...
            echo "</a>
                    ";
            // line 31
            echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "postIndex", array()), 'errors');
            echo "
                </div>
            </div>
        ";
    ...
    ";
        ...
        if ($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "mark", array(), "any", true, true)) {
            ...
            ";
            // line 38
            echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "mark", array()), 'row');
            echo "
        </fieldset>
    ";
        }
        ...
        ";
        // line 46
        $context["contragent"] = ((array_key_exists("contragent", $context)) ? ((isset($context["contragent"]) ? $context["contragent"] : null)) : ($this->getAttribute((isset($context["contact"]) ? $context["contact"] : null), "contragent", array())));
        // line 47
        echo "        ";
