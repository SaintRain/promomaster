...
class __TwigTemplate_fdf03efe4464a6d1d59144a9db639bbcf6137cd9d466b3076d8da80e6db9c5e0 extends Twig_Template
{
...
";
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["d"]) ? $context["d"] : null), "productDataProperty", array()));
        foreach ($context['_seq'] as $context["_key"] => $context["pdp"]) {
            // line 5
            echo "
";
            // line 6
            if (twig_in_filter($this->getAttribute($this->getAttribute($this->getAttribute($context["pdp"], "data", array()), "property", array()), "name", array()), $this->getAttribute((isset($context["column"]) ? $context["column"] : null), "showProperties", array()))) {
                // line 7
                echo "
";
                // line 8
                if (!twig_in_filter($this->getAttribute($this->getAttribute($this->getAttribute($context["pdp"], "data", array()), "property", array()), "id", array()), (isset($context["used"]) ? $context["used"] : null))) {
                    // line 9
                    if (twig_length_filter($this->env, (isset($context["used"]) ? $context["used"] : null))) {
                        echo "<br>";
                    }
                    // line 10
...
";
    ...
    ";
        ...
        ";
                ...
                if (!twig_in_filter($this->getAttribute($this->getAttribute($this->getAttribute($context["pdp"], "data", array()), "property", array()), "id", array()), (isset($context["used"]) ? $context["used"] : null))) {
                    // line 26
                    $context["used"] = twig_array_merge((isset($context["used"]) ? $context["used"] : null), array(0 => $this->getAttribute($this->getAttribute($this->getAttribute($context["pdp"], "data", array()), "property", array()), "id", array())));
                }
                // line 28
                echo "    
        ";
