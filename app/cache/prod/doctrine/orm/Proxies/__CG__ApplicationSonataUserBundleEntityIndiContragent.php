 ...
 */
class IndiContragent extends \Application\Sonata\UserBundle\Entity\IndiContragent implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Sonata\\UserBundle\\Entity\\IndiContragent' . "\0" . 'firstName', '' . "\0" . 'Application\\Sonata\\UserBundle\\Entity\\IndiContragent' . "\0" . 'lastName', '' . "\0" . 'Application\\Sonata\\UserBundle\\Entity\\IndiContragent' . "\0" . 'surName', 'contactList', 'id', 'city', 'createdDateTime', 'updatedDateTime', 'user', 'phone1', 'phone2', 'phone3', 'contactEmail', 'payments', 'manufacturerDiscounts');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (IndiContragent $proxy) {
     ...
     * {@inheritDoc}
     */
    public function addContactList(\Application\Sonata\UserBundle\Entity\IndiContact $contact)
    {
     ...
     * {@inheritDoc}
     */
    public function removeContactList(\Application\Sonata\UserBundle\Entity\IndiContact $contact)
    {
