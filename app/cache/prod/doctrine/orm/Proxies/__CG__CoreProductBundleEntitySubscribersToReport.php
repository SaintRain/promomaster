...
namespace Proxies\__CG__\Core\ProductBundle\Entity\Subscribers;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class ToReport extends \Core\ProductBundle\Entity\Subscribers\ToReport implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Core\\ProductBundle\\Entity\\Subscribers\\ToReport' . "\0" . 'id', 'email', 'product', '' . "\0" . 'Core\\ProductBundle\\Entity\\Subscribers\\ToReport' . "\0" . 'createdDateTime');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ToReport $proxy) {
