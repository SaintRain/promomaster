 ...
 */
class Status extends \Core\TroubleTicketBundle\Entity\Status implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Core\\TroubleTicketBundle\\Entity\\Status' . "\0" . 'id', '' . "\0" . 'Core\\TroubleTicketBundle\\Entity\\Status' . "\0" . 'indexPosition', '' . "\0" . 'Core\\TroubleTicketBundle\\Entity\\Status' . "\0" . 'isEnabled', '' . "\0" . 'Core\\TroubleTicketBundle\\Entity\\Status' . "\0" . 'captionRu', '' . "\0" . 'Core\\TroubleTicketBundle\\Entity\\Status' . "\0" . 'sysName', '' . "\0" . 'Core\\TroubleTicketBundle\\Entity\\Status' . "\0" . 'isEditable');
        }
