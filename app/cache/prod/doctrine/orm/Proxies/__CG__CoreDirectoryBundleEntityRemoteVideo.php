 ...
 */
class RemoteVideo extends \Core\DirectoryBundle\Entity\RemoteVideo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Core\\DirectoryBundle\\Entity\\RemoteVideo' . "\0" . 'id', '' . "\0" . 'Core\\DirectoryBundle\\Entity\\RemoteVideo' . "\0" . 'code', '' . "\0" . 'Core\\DirectoryBundle\\Entity\\RemoteVideo' . "\0" . 'createdDatetime', '' . "\0" . 'Core\\DirectoryBundle\\Entity\\RemoteVideo' . "\0" . 'updatedDatetime', 'videoHosting', 'captionRu', 'captionEn');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RemoteVideo $proxy) {
    ...
    public function getVideoHosting()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getVideoHosting', array());

        return parent::getVideoHosting();
    }

    /**
     * {@inheritDoc}
     */
    public function setVideoHosting(\Core\DirectoryBundle\Entity\VideoHosting $videoHosting = NULL)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setVideoHosting', array($videoHosting));

        return parent::setVideoHosting($videoHosting);
    }
