 ...
 */
class PlasticCard extends \Core\PaymentBundle\Entity\PaymentSystem\PlasticCard implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Core\\PaymentBundle\\Entity\\PaymentSystem\\PlasticCard' . "\0" . 'shopId', '' . "\0" . 'Core\\PaymentBundle\\Entity\\PaymentSystem\\PlasticCard' . "\0" . 'scid', '' . "\0" . 'Core\\PaymentBundle\\Entity\\PaymentSystem\\PlasticCard' . "\0" . 'shopPassword', '' . "\0" . 'Core\\PaymentBundle\\Entity\\PaymentSystem\\PlasticCard' . "\0" . 'shopSuccessURL', '' . "\0" . 'Core\\PaymentBundle\\Entity\\PaymentSystem\\PlasticCard' . "\0" . 'shopFailURL', 'captionRu', 'captionEn', 'descriptionRu', 'descriptionEn');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PlasticCard $proxy) {
