 ...
 */
class SupplyStatus extends \Core\LogisticsBundle\Entity\SupplyStatus implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Core\\LogisticsBundle\\Entity\\SupplyStatus' . "\0" . 'captionRu', '' . "\0" . 'Core\\LogisticsBundle\\Entity\\SupplyStatus' . "\0" . 'name', '' . "\0" . 'Core\\LogisticsBundle\\Entity\\SupplyStatus' . "\0" . 'indexPosition');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SupplyStatus $proxy) {
