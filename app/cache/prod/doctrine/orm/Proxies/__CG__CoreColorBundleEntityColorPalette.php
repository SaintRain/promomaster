 ...
 */
class ColorPalette extends \Core\ColorBundle\Entity\ColorPalette implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Core\\ColorBundle\\Entity\\ColorPalette' . "\0" . 'id', '' . "\0" . 'Core\\ColorBundle\\Entity\\ColorPalette' . "\0" . 'hex', '' . "\0" . 'Core\\ColorBundle\\Entity\\ColorPalette' . "\0" . 'indexPosition', 'main');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ColorPalette $proxy) {
