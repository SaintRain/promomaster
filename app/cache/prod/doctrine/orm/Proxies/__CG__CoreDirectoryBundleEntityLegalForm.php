 ...
 */
class LegalForm extends \Core\DirectoryBundle\Entity\LegalForm implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Core\\DirectoryBundle\\Entity\\LegalForm' . "\0" . 'captionRu', '' . "\0" . 'Core\\DirectoryBundle\\Entity\\LegalForm' . "\0" . 'fullCaptionRu', '' . "\0" . 'Core\\DirectoryBundle\\Entity\\LegalForm' . "\0" . 'name');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LegalForm $proxy) {
    ...
    public function setFullCaptionRu($fullCaptionRu)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFullCaptionRu', array($fullCaptionRu));

        return parent::setFullCaptionRu($fullCaptionRu);
    }
