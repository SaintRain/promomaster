...
class __TwigTemplate_47479191f967f29f635e4cb245c0e05aa035617166ffd956a2b213e5213f8e29 extends Twig_Template
{
    ...
    <fieldset class=\"sky-form-other-style\">
        ...
        <div class=\"row margin-bottom-20\">
            <div class=\"col-lg-12  ";
        // line 61
        if ($this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "code", array()), 'errors')) {
            echo "state-error";
        }
        echo "\">
                <label>Код *</label>
                ";
        // line 63
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "code", array()), 'widget', array("attr" => array("class" => "form-control")));
        echo "
                ";
        // line 64
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "code", array()), 'errors');
        echo "
            </div>
        </div>
