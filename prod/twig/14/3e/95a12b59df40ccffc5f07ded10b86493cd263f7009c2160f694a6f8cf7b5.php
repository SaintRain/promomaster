...
class __TwigTemplate_143e95a12b59df40ccffc5f07ded10b86493cd263f7009c2160f694a6f8cf7b5 extends Twig_Template
{
...
";
    ...
    public function block_payment_system_switcher($context, array $blocks = array())
    {
        ...
        if (array_key_exists("paymentSytems", $context)) {
            ...
            ";
            // line 14
            $context["ps"] = (isset($context["paymentSytems"]) ? $context["paymentSytems"] : null);
            // line 15
            echo "            ";
            $context["orderCost"] = ((array_key_exists("data", $context)) ? ($this->getAttribute($this->getAttribute((isset($context["data"]) ? $context["data"] : null), "orderCostInfo", array()), "total_cost", array())) : (((array_key_exists("orderCostInfo", $context)) ? ($this->getAttribute((isset($context["orderCostInfo"]) ? $context["orderCostInfo"] : null), "total_cost", array())) : (0))));
            // line 16
            echo "
            <ul class=\"order_payment_group group_switcher\">
                ...
                ";
            // line 19
            if ((($this->getAttribute($this->getAttribute((isset($context["ps"]) ? $context["ps"] : null), "PlasticCard", array(), "array"), "isEnabled", array()) || ($this->getAttribute($this->getAttribute((isset($context["ps"]) ? $context["ps"] : null), "PlasticCardTerminal", array(), "array"), "isEnabled", array()) && (isset($context["isSupplyPlacticCard"]) ? $context["isSupplyPlacticCard"] : null))) && ((isset($context["orderCost"]) ? $context["orderCost"] : null) >= 1))) {
                // line 20
                echo "
                    <li class=\"group_switch no-bg\" data-tab=\"1\"";
                // line 21
                if ( !(isset($context["isSupplyPlacticCard"]) ? $context["isSupplyPlacticCard"] : null)) {
            ...
            echo "
                ";
            // line 28
            if ((($this->getAttribute($this->getAttribute((isset($context["ps"]) ? $context["ps"] : null), "WebMoney", array(), "array"), "isEnabled", array()) || $this->getAttribute($this->getAttribute((isset($context["ps"]) ? $context["ps"] : null), "YandexMoney", array(), "array"), "isEnabled", array())) && ((isset($context["orderCost"]) ? $context["orderCost"] : null) >= 1))) {
                // line 29
                echo "
            ...
            echo "
                ";
            // line 37
            if ($this->getAttribute($this->getAttribute((isset($context["ps"]) ? $context["ps"] : null), "Qiwi", array(), "array"), "isEnabled", array())) {
                // line 38
                echo "
            ...
            echo "
                ";
            // line 46
            if (($this->getAttribute($this->getAttribute((isset($context["ps"]) ? $context["ps"] : null), "BankTransfer", array(), "array"), "isEnabled", array()) || $this->getAttribute($this->getAttribute((isset($context["ps"]) ? $context["ps"] : null), "AlfaBank", array(), "array"), "isEnabled", array()))) {
                // line 47
                echo "
            ...
            echo "
                ";
            // line 55
            if (($this->getAttribute($this->getAttribute((isset($context["ps"]) ? $context["ps"] : null), "Megafon", array(), "array"), "isEnabled", array()) || $this->getAttribute($this->getAttribute((isset($context["ps"]) ? $context["ps"] : null), "Beeline", array(), "array"), "isEnabled", array()))) {
                // line 56
                echo "
            ...
            echo "
                ";
            // line 64
            if ($this->getAttribute($this->getAttribute((isset($context["ps"]) ? $context["ps"] : null), "PayPal", array(), "array"), "isEnabled", array())) {
                // line 65
                echo "
            ...
            <div class=\"order_payment_type type_switcher brown_gradient_box\">
                ...
                ";
            // line 76
            if (((isset($context["isSupplyPlacticCard"]) ? $context["isSupplyPlacticCard"] : null) && ((isset($context["orderCost"]) ? $context["orderCost"] : null) >= 1))) {
                // line 77
                echo "
                    <ul class=\"type_switches\" data-content=\"1\">
                        <li><span style=\"margin-right: 67px;\">";
                // line 79
                if ($this->getAttribute($this->getAttribute((isset($context["ps"]) ? $context["ps"] : null), "PlasticCard", array(), "array"), "isEnabled", array())) {
                    echo "На сайте";
                }
                if (($this->getAttribute($this->getAttribute((isset($context["ps"]) ? $context["ps"] : null), "PlasticCard", array(), "array"), "isEnabled", array()) && $this->getAttribute($this->getAttribute((isset($context["ps"]) ? $context["ps"] : null), "PlasticCardTerminal", array(), "array"), "isEnabled", array()))) {
                    echo "</span> <span>";
                }
                if ($this->getAttribute($this->getAttribute((isset($context["ps"]) ? $context["ps"] : null), "PlasticCardTerminal", array(), "array"), "isEnabled", array())) {
            ...
            echo "
                ";
            // line 86
            if (((isset($context["orderCost"]) ? $context["orderCost"] : null) >= 1)) {
                // line 87
                echo "
                    <ul class=\"type_switches\" data-content=\"2\">
                        ";
                // line 89
                if ($this->getAttribute($this->getAttribute((isset($context["ps"]) ? $context["ps"] : null), "WebMoney", array(), "array"), "isEnabled", array())) {
                ...
                // line 90
                echo "                        ";
                if ($this->getAttribute($this->getAttribute((isset($context["ps"]) ? $context["ps"] : null), "YandexMoney", array(), "array"), "isEnabled", array())) {
            ...
            echo "
                <ul class=\"type_switches\" data-content=\"4\">
                    ";
            // line 96
            if ($this->getAttribute($this->getAttribute((isset($context["ps"]) ? $context["ps"] : null), "BankTransfer", array(), "array"), "isEnabled", array())) {
            ...
            // line 97
            echo "                    ";
            if ($this->getAttribute($this->getAttribute((isset($context["ps"]) ? $context["ps"] : null), "AlfaBank", array(), "array"), "isEnabled", array())) {
            ...
            echo "                </ul>
                <ul class=\"type_switches\" data-content=\"5\">
                    ";
            // line 100
            if ($this->getAttribute($this->getAttribute((isset($context["ps"]) ? $context["ps"] : null), "Megafon", array(), "array"), "isEnabled", array())) {
            ...
            // line 101
            echo "                    ";
            if ($this->getAttribute($this->getAttribute((isset($context["ps"]) ? $context["ps"] : null), "Beeline", array(), "array"), "isEnabled", array())) {
