...
class __TwigTemplate_92d34274a6428e03608a9360fd6b5974120f6b438d04064a9aeea44940e83c57 extends Twig_Template
{
    ...
    public function block_menu_dropdown($context, array $blocks = array())
    {
        ...
        foreach ($context['_seq'] as $context["labelParent"] => $context["items"]) {
            ...
            echo "
                                ";
            // line 24
            $context["tempMenu"] = (isset($context["menu"]) ? $context["menu"] : null);
            // line 25
            ...
            echo twig_escape_filter($this->env, (isset($context["carretArrow"]) ? $context["carretArrow"] : null), "html", null, true);
            echo "\"></span></a>
                ...
                if ((isset($context["display"]) ? $context["display"] : null)) {
                    ...
                    if ($this->getAttribute($context["item"], "route", array(), "any", true, true)) {
                        ...
                        echo "
                                                        <li";
                        // line 57
                        if (($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "attributes", array()), "get", array(0 => "_route"), "method") == $this->getAttribute($context["item"], "route", array()))) {
                            echo " class=\"active\"";
                        }
                        echo "><a href=\"";
            ...
            echo "
                                ...
                                ";
            // line 81
            $context["menu"] = (isset($context["tempMenu"]) ? $context["tempMenu"] : null);
            // line 82
            echo "                            ";
        }
        $_parent = $context['_parent'];
