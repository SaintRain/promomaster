...
class __TwigTemplate_f0b548a9f9612bb499a365e2b5b3dc6fe093021dbefd2d288994fa7448fd38d3 extends Twig_Template
{
...
";
            ...
            echo "
                        <li class=\"\">
                            <a id=\"audit_block_btn\" href=\"#audit_block\" data-toggle=\"tab\">
                                <smal>";
            // line 21
            echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("audit.tabs.name", array(), $this->getAttribute((isset($context["admin"]) ? $context["admin"] : null), "translationDomain", array())), "html", null, true);
            echo "</smal>
                            </a>
                        </li>
    ...
    ";
        ...
        echo ",
                namespace: '";
        // line 54
        if ( !$this->env->getExtension('common_extension')->get_parent_classFunction((isset($context["object"]) ? $context["object"] : null))) {
            echo twig_escape_filter($this->env, twig_escape_filter($this->env, $this->env->getExtension('common_extension')->get_classFunction((isset($context["object"]) ? $context["object"] : null)), "js"), "html", null, true);
        } else {
            echo twig_escape_filter($this->env, twig_escape_filter($this->env, $this->env->getExtension('common_extension')->get_parent_classFunction((isset($context["object"]) ? $context["object"] : null)), "js"), "html", null, true);
        }
        echo "',
                translationDomain: '";
        // line 55
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["admin"]) ? $context["admin"] : null), "translationDomain", array()), "html", null, true);
        echo "'
            };
