...
class __TwigTemplate_8ce41e5ab16d2a6b189ca7477194a302c50df9a49ba5381831ca23173f8f62de extends Twig_Template
{
...
<form id=\"form_image\" style=\"clear: both;";
    ...
    <fieldset class=\"sky-form-other-style\">
        ...
        // line 72
        if ($this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "isOpenUrlInNewWindow", array()), 'errors')) {
            echo "state-error";
        }
        echo "\">
            <label class=\"checkbox\">
                ";
        // line 74
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "isOpenUrlInNewWindow", array()), 'widget');
        echo "<i></i> Открывать ссылку перехода в новом окне</label>
            ";
        // line 75
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "isOpenUrlInNewWindow", array()), 'errors');
        echo "
            </label>
        </div>
        ...
        <div class=\"row margin-bottom-20\">
            <div class=\"col-lg-12  ";
        // line 81
        if ($this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "image", array()), 'errors')) {
            echo "state-error";
        }
        echo "\">
                <label>Файл*</label>
