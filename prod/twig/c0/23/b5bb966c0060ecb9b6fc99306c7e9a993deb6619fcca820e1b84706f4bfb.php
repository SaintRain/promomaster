...
class __TwigTemplate_c023b5bb966c0060ecb9b6fc99306c7e9a993deb6619fcca820e1b84706f4bfb extends Twig_Template
{
    ...
    <aside class=\"side_col\">
        ...
        if (($this->getAttribute((isset($context["data"]) ? $context["data"] : null), "orderCostInfo", array(), "any", true, true) && ($this->getAttribute($this->getAttribute((isset($context["data"]) ? $context["data"] : null), "orderCostInfo", array()), "total_cost", array()) > 0))) {
            ...
            echo "
                ";
            // line 45
            if ((isset($context["orderCostInfo"]) ? $context["orderCostInfo"] : null)) {
                // line 46
                echo "
                    <section class=\"order_summary\">
                        <h2>Ваш заказ <span class=\"order_summary_count\">";
                // line 48
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["orderCostInfo"]) ? $context["orderCostInfo"] : null), "total_quantity", array()), "html", null, true);
                echo "</span></h2>
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
                    ...
                    echo " (";
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["data"]) ? $context["data"] : null), "sessionOrder", array()), "products", array(), "array"), $this->getAttribute($context["product"], "id", array()), array(), "array"), "quantity", array(), "array"), "html", null, true);
                    echo " шт.)</strong>
                    ...
                    if ($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["orderCostInfo"]) ? $context["orderCostInfo"] : null), "composition", array(), "array"), $this->getAttribute($context["product"], "id", array()), array(), "array"), "discountValue", array(), "array")) {
                        ...
                        echo "
                                                <span class=\"discount\">";
                        // line 81
                        echo twig_escape_filter($this->env, $this->env->getExtension('money_extension')->moneyFormatFunction($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["orderCostInfo"]) ? $context["orderCostInfo"] : null), "composition", array(), "array"), $this->getAttribute($context["product"], "id", array()), array(), "array"), "discountValue", array(), "array")), "html", null, true);
                        ...
                        <table class=\"order_summary_total\">
                            <tbody>
                                <tr>
                                    ...
                                    <td class=\"sum price\">";
                // line 96
                echo twig_escape_filter($this->env, $this->env->getExtension('money_extension')->moneyFormatFunction($this->getAttribute((isset($context["orderCostInfo"]) ? $context["orderCostInfo"] : null), "composition_total_cost", array())), "html", null, true);
                echo " ";
                echo twig_escape_filter($this->env, $this->env->getExtension('money_extension')->currencyFormatFunction(), "html", null, true);
                echo "</td>
                                </tr>
                ...
                echo "
                                ";
                // line 105
                if ($this->getAttribute((isset($context["orderCostInfo"]) ? $context["orderCostInfo"] : null), "delivery_cost", array(), "array")) {
                    // line 106
                    echo "
                                    <tr>
                                        <td>Доставка: «";
                    // line 108
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["data"]) ? $context["data"] : null), "order", array()), "deliveryMethod", array()), "captionRu", array()), "html", null, true);
                    echo "»</td>
                                        <td class=\"sum price\">";
                    // line 109
                    echo twig_escape_filter($this->env, $this->env->getExtension('money_extension')->moneyFormatFunction($this->getAttribute((isset($context["orderCostInfo"]) ? $context["orderCostInfo"] : null), "delivery_cost", array())), "html", null, true);
                    echo " ";
                    echo twig_escape_filter($this->env, $this->env->getExtension('money_extension')->currencyFormatFunction(), "html", null, true);
                    echo "</td>
                                    </tr>
                ...
                echo "
                                ";
                // line 114
                if ($this->getAttribute((isset($context["orderCostInfo"]) ? $context["orderCostInfo"] : null), "total_discount_summ", array(), "array")) {
                    // line 115
                    echo "
                                    <tr class=\"discount\">
                                        <td>Скидка</td>
                                        <td class=\"sum price\">-";
                    // line 118
                    echo twig_escape_filter($this->env, $this->env->getExtension('money_extension')->moneyFormatFunction($this->getAttribute((isset($context["orderCostInfo"]) ? $context["orderCostInfo"] : null), "total_discount_summ", array())), "html", null, true);
                    echo " ";
                    echo twig_escape_filter($this->env, $this->env->getExtension('money_extension')->currencyFormatFunction(), "html", null, true);
                    echo "</td>
                                    </tr>
                ...
                echo "
                                    <td class=\"sum price\">";
                // line 131
                echo twig_escape_filter($this->env, $this->env->getExtension('money_extension')->moneyFormatFunction($this->getAttribute((isset($context["orderCostInfo"]) ? $context["orderCostInfo"] : null), "total_cost", array())), "html", null, true);
                echo " ";
                echo twig_escape_filter($this->env, $this->env->getExtension('money_extension')->currencyFormatFunction(), "html", null, true);
                echo "</td>
                                </tr>
