...
class __TwigTemplate_f6e4b8e6bc2e195cea3afad80a431e1f4ef729c7d9a8dec38c437ae318362cef extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["p"]) {
            ...
            echo "                ";
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable(twig_slice($this->env, $this->getAttribute($context["p"], "images", array()), 0, (isset($context["sliceCount"]) ? $context["sliceCount"] : null)));
            ...
            if ($this->getAttribute($context["p"], "warrantyMonths", array())) {
                ...
                // line 34
                if ((((isset($context["years"]) ? $context["years"] : null) > 0) || ((isset($context["months"]) ? $context["months"] : null) > 0))) {
                    // line 35
                    echo "P";
                }
                // line 38
                if (((isset($context["years"]) ? $context["years"] : null) > 0)) {
                    // line 39
                    echo twig_escape_filter($this->env, (isset($context["years"]) ? $context["years"] : null), "html", null, true);
                    echo "Y";
                }
                // line 42
                if (((isset($context["months"]) ? $context["months"] : null) > 0)) {
                    // line 43
                    echo twig_escape_filter($this->env, (isset($context["months"]) ? $context["months"] : null), "html", null, true);
                    echo "M";
                }
            } else {
                // line 47
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["pdp"]) {
                ...
                if ((!twig_in_filter($this->getAttribute($this->getAttribute($this->getAttribute($context["pdp"], "data", array()), "property", array()), "name", array()), twig_get_array_keys_filter(array(0 => "sex", 1 => "age", 2 => "toy_property"))) && $this->getAttribute($this->getAttribute($this->getAttribute($context["pdp"], "data", array()), "property", array()), "isEnabledInYml", array()))) {
                    ...
                    // line 70
                    echo "                    ";
                    if ((($this->getAttribute($this->getAttribute($this->getAttribute($context["pdp"], "data", array()), "property", array()), "editType", array()) == "multiselect") && !twig_in_filter($this->getAttribute($this->getAttribute($this->getAttribute($context["pdp"], "data", array()), "property", array()), "name", array()), (isset($context["isProcessed"]) ? $context["isProcessed"] : null)))) {
                        // line 71
                        echo "                        ";
                        $context["isProcessed"] = twig_array_merge((isset($context["isProcessed"]) ? $context["isProcessed"] : null), array(0 => $this->getAttribute($this->getAttribute($this->getAttribute($context["pdp"], "data", array()), "property", array()), "name", array())));
                        // line 72
                        echo "                        <param name=\"";
                        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($context["pdp"], "data", array()), "property", array()), "captionRu", array()), "html", null, true);
                        echo "\">";
            ...
            // line 91
            echo "            ";
            if (($this->getAttribute((isset($context["age"]) ? $context["age"] : null), "data", array(), "any", true, true) && $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["age"]) ? $context["age"] : null), "data", array()), "property", array()), "isEnabledInYml", array()))) {
                // line 92
                echo "                ";
                $context["fromTo"] = twig_split_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["age"]) ? $context["age"] : null), "data", array()), "value", array()), "-");
                // line 93
                echo "                <param name=\"Возраст от\" unit=\"лет\">";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["fromTo"]) ? $context["fromTo"] : null), 0, array(), "array"), "html", null, true);
                echo "</param>
                <param name=\"Возраст до\" unit=\"лет\">";
                // line 94
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["fromTo"]) ? $context["fromTo"] : null), 1, array(), "array"), "html", null, true);
                echo "</param>
            ";
            }
            // line 96
