 ...
 */
class ManufacturerStepValues extends \Core\DiscountsBundle\Entity\ManufacturerStepValues implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Core\\DiscountsBundle\\Entity\\ManufacturerStepValues' . "\0" . 'manufacturerDiscount', '' . "\0" . 'Core\\DiscountsBundle\\Entity\\ManufacturerStepValues' . "\0" . 'stepValue', '' . "\0" . 'Core\\DiscountsBundle\\Entity\\ManufacturerStepValues' . "\0" . 'stepDays', '' . "\0" . 'Core\\DiscountsBundle\\Entity\\ManufacturerStepValues' . "\0" . 'discountValue', '' . "\0" . 'Core\\DiscountsBundle\\Entity\\ManufacturerStepValues' . "\0" . 'isDiscountValueInPercent', '' . "\0" . 'Core\\DiscountsBundle\\Entity\\ManufacturerStepValues' . "\0" . 'createdDateTime', '' . "\0" . 'Core\\DiscountsBundle\\Entity\\ManufacturerStepValues' . "\0" . 'indexPosition');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ManufacturerStepValues $proxy) {
    ...
    public function getStepDays()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getStepDays', array());

        return parent::getStepDays();
    }
    ...
    public function setStepDays($stepDays)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setStepDays', array($stepDays));

        return parent::setStepDays($stepDays);
    }
