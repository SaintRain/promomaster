 ...
 */
class AdditionalCostsTypeOfSupply extends \Core\LogisticsBundle\Entity\AdditionalCostsTypeOfSupply implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Core\\LogisticsBundle\\Entity\\AdditionalCostsTypeOfSupply' . "\0" . 'indexPosition', 'captionRu', 'captionEn');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AdditionalCostsTypeOfSupply $proxy) {
