...
namespace Proxies\__CG__\Core\BannerBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class ImageBanner extends \Core\BannerBundle\Entity\ImageBanner implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Core\\BannerBundle\\Entity\\ImageBanner' . "\0" . 'url', '' . "\0" . 'Core\\BannerBundle\\Entity\\ImageBanner' . "\0" . 'image', '' . "\0" . 'Core\\BannerBundle\\Entity\\ImageBanner' . "\0" . 'isOpenUrlInNewWindow', 'id');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ImageBanner $proxy) {
    ...
    public function getIsOpenUrlInNewWindow()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIsOpenUrlInNewWindow', array());

        return parent::getIsOpenUrlInNewWindow();
    }
    ...
    public function setIsOpenUrlInNewWindow($isOpenUrlInNewWindow)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIsOpenUrlInNewWindow', array($isOpenUrlInNewWindow));

        return parent::setIsOpenUrlInNewWindow($isOpenUrlInNewWindow);
    }
