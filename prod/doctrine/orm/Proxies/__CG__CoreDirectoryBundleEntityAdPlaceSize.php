 ...
 */
class AdPlaceSize extends \Core\DirectoryBundle\Entity\AdPlaceSize implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Core\\DirectoryBundle\\Entity\\AdPlaceSize' . "\0" . 'id', '' . "\0" . 'Core\\DirectoryBundle\\Entity\\AdPlaceSize' . "\0" . 'captionRu', '' . "\0" . 'Core\\DirectoryBundle\\Entity\\AdPlaceSize' . "\0" . 'name', '' . "\0" . 'Core\\DirectoryBundle\\Entity\\AdPlaceSize' . "\0" . 'width', '' . "\0" . 'Core\\DirectoryBundle\\Entity\\AdPlaceSize' . "\0" . 'height', '' . "\0" . 'Core\\DirectoryBundle\\Entity\\AdPlaceSize' . "\0" . 'indexPosition', '' . "\0" . 'Core\\DirectoryBundle\\Entity\\AdPlaceSize' . "\0" . 'isEnabled');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AdPlaceSize $proxy) {
    ...
    public function isIsEnabled()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isIsEnabled', array());
