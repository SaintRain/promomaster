 ...
 */
class ServiceInCity extends \Core\DeliveryBundle\Entity\ServiceInCity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Core\\DeliveryBundle\\Entity\\ServiceInCity' . "\0" . 'city', '' . "\0" . 'Core\\DeliveryBundle\\Entity\\ServiceInCity' . "\0" . 'description');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ServiceInCity $proxy) {
