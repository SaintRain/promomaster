 ...
 */
class Service extends \Core\DeliveryBundle\Entity\Service implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Core\\DeliveryBundle\\Entity\\Service' . "\0" . 'id', '' . "\0" . 'Core\\DeliveryBundle\\Entity\\Service' . "\0" . 'name', '' . "\0" . 'Core\\DeliveryBundle\\Entity\\Service' . "\0" . 'captionRu', '' . "\0" . 'Core\\DeliveryBundle\\Entity\\Service' . "\0" . 'buyerType', '' . "\0" . 'Core\\DeliveryBundle\\Entity\\Service' . "\0" . 'minSum', '' . "\0" . 'Core\\DeliveryBundle\\Entity\\Service' . "\0" . 'maxSum', '' . "\0" . 'Core\\DeliveryBundle\\Entity\\Service' . "\0" . 'company', '' . "\0" . 'Core\\DeliveryBundle\\Entity\\Service' . "\0" . 'serviceType', '' . "\0" . 'Core\\DeliveryBundle\\Entity\\Service' . "\0" . 'deliveryFrom', '' . "\0" . 'Core\\DeliveryBundle\\Entity\\Service' . "\0" . 'deliveryTo', '' . "\0" . 'Core\\DeliveryBundle\\Entity\\Service' . "\0" . 'internalCode', '' . "\0" . 'Core\\DeliveryBundle\\Entity\\Service' . "\0" . 'isCashOnDelivery', '' . "\0" . 'Core\\DeliveryBundle\\Entity\\Service' . "\0" . 'isShowOnProduct', '' . "\0" . 'Core\\DeliveryBundle\\Entity\\Service' . "\0" . 'position', '' . "\0" . 'Core\\DeliveryBundle\\Entity\\Service' . "\0" . 'waybills');
        }
