 ...
 */
class TransitStatus extends \Core\LogisticsBundle\Entity\TransitStatus implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Core\\LogisticsBundle\\Entity\\TransitStatus' . "\0" . 'captionRu', '' . "\0" . 'Core\\LogisticsBundle\\Entity\\TransitStatus' . "\0" . 'name', '' . "\0" . 'Core\\LogisticsBundle\\Entity\\TransitStatus' . "\0" . 'indexPosition');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TransitStatus $proxy) {
