 ...
 */
class PaymentOnDelivery extends \Core\PaymentBundle\Entity\PaymentSystem\PaymentOnDelivery implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Core\\PaymentBundle\\Entity\\PaymentSystem\\PaymentOnDelivery' . "\0" . 'creditLimit', 'captionRu', 'captionEn', 'descriptionRu', 'descriptionEn');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PaymentOnDelivery $proxy) {
