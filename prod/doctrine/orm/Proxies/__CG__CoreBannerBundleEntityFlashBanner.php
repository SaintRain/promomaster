 ...
 */
class FlashBanner extends \Core\BannerBundle\Entity\FlashBanner implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Core\\BannerBundle\\Entity\\FlashBanner' . "\0" . 'file', '' . "\0" . 'Core\\BannerBundle\\Entity\\FlashBanner' . "\0" . 'height', '' . "\0" . 'Core\\BannerBundle\\Entity\\FlashBanner' . "\0" . 'width', 'id');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FlashBanner $proxy) {
