 ...
 */
class AdPlace extends \Core\SiteBundle\Entity\AdPlace implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Core\\SiteBundle\\Entity\\AdPlace' . "\0" . 'name', '' . "\0" . 'Core\\SiteBundle\\Entity\\AdPlace' . "\0" . 'size', '' . "\0" . 'Core\\SiteBundle\\Entity\\AdPlace' . "\0" . 'width', '' . "\0" . 'Core\\SiteBundle\\Entity\\AdPlace' . "\0" . 'height', '' . "\0" . 'Core\\SiteBundle\\Entity\\AdPlace' . "\0" . 'site', '' . "\0" . 'Core\\SiteBundle\\Entity\\AdPlace' . "\0" . 'user', '' . "\0" . 'Core\\SiteBundle\\Entity\\AdPlace' . "\0" . 'isShowInCatalog', '' . "\0" . 'Core\\SiteBundle\\Entity\\AdPlace' . "\0" . 'createdDateTime', '' . "\0" . 'Core\\SiteBundle\\Entity\\AdPlace' . "\0" . 'indexPosition', '' . "\0" . 'Core\\SiteBundle\\Entity\\AdPlace' . "\0" . 'sections');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AdPlace $proxy) {
    ...
    public function getIsShowInCatalog()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIsShowInCatalog', array());

        return parent::getIsShowInCatalog();
    }
    ...
    public function setIsShowInCatalog($isShowInCatalog)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIsShowInCatalog', array($isShowInCatalog));

        return parent::setIsShowInCatalog($isShowInCatalog);
    }
    ...
    public function setSections($sections)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSections', array($sections));
