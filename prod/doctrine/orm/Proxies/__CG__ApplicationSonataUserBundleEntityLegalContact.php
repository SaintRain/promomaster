 ...
 */
class LegalContact extends \Application\Sonata\UserBundle\Entity\LegalContact implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'organization', 'contragent', 'id', 'address', 'city', 'mark', 'postIndex');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LegalContact $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setContragent(\Application\Sonata\UserBundle\Entity\LegalContragent $contragent = NULL)
    {
