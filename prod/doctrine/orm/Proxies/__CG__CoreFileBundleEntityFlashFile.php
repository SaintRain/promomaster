 ...
 */
class FlashFile extends \Core\FileBundle\Entity\FlashFile implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Core\\FileBundle\\Entity\\FlashFile' . "\0" . 'height', '' . "\0" . 'Core\\FileBundle\\Entity\\FlashFile' . "\0" . 'width', 'name', 'halfPath', 'indexPosition', 'size', 'altRu', 'altEn');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FlashFile $proxy) {
