 ...
 */
class DocumentFile extends \Core\FileBundle\Entity\DocumentFile implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'name', 'halfPath', 'indexPosition', 'size', 'captionRu', 'captionEn');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DocumentFile $proxy) {
