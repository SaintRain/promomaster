 ...
 */
class YandexMoney extends \Core\PaymentBundle\Entity\PaymentSystem\YandexMoney implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Core\\PaymentBundle\\Entity\\PaymentSystem\\YandexMoney' . "\0" . 'shopId', '' . "\0" . 'Core\\PaymentBundle\\Entity\\PaymentSystem\\YandexMoney' . "\0" . 'scid', '' . "\0" . 'Core\\PaymentBundle\\Entity\\PaymentSystem\\YandexMoney' . "\0" . 'shopPassword', '' . "\0" . 'Core\\PaymentBundle\\Entity\\PaymentSystem\\YandexMoney' . "\0" . 'shopSuccessURL', '' . "\0" . 'Core\\PaymentBundle\\Entity\\PaymentSystem\\YandexMoney' . "\0" . 'shopFailURL', 'captionRu', 'captionEn', 'descriptionRu', 'descriptionEn');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (YandexMoney $proxy) {
    ...
    public function setScid($scid)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setScid', array($scid));

        return parent::setScid($scid);
    }
    ...
    public function getScid()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getScid', array());

        return parent::getScid();
    }
    ...
    public function setShopPassword($shopPassword)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setShopPassword', array($shopPassword));

        return parent::setShopPassword($shopPassword);
    }
    ...
    public function getShopPassword()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getShopPassword', array());

        return parent::getShopPassword();
    }
    ...
    public function setShopFailURL($shopFailURL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setShopFailURL', array($shopFailURL));

        return parent::setShopFailURL($shopFailURL);
    }
    ...
    public function getShopFailURL()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getShopFailURL', array());

        return parent::getShopFailURL();
    }
    ...
    public function setShopSuccessURL($shopSuccessURL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setShopSuccessURL', array($shopSuccessURL));

        return parent::setShopSuccessURL($shopSuccessURL);
    }
    ...
    public function getShopSuccessURL()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getShopSuccessURL', array());

        return parent::getShopSuccessURL();
    }
