 ...
 * @copyright  Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class PHPExcel_IOFactory_Fixed
{
	/**
	 * Search locations
	 *
	...
	public static function createReader($readerType = '') {
		...
		foreach (self::$_searchLocations as $searchLocation) {
			if ($searchLocation['type'] == $searchType) {
                ...
                if ($className=='PHPExcel_Reader_Excel5') {
                    //require ($_SERVER['DOCUMENT_ROOT'].'../src/Application/liuggio/ExcelBundle/PHPExcel_Reader_Excel5_Fixed.php');
                    $instance = new \PHPExcel_Reader_Excel5_Fixed();
                }
                else {
