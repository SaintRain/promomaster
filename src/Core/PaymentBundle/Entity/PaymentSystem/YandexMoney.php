...
/**
 * Настройки платежной системы YandexMoney
 *
 * @author Sergeev A.M.
...
/**
 * @ORM\Entity(repositoryClass="Core\PaymentBundle\Entity\PaymentSystem\Repository\YandexMoneyRepository")
 * @ Assert\Callback(methods={"isValid"})
 */
class YandexMoney extends CommonPaymentSystem
{
