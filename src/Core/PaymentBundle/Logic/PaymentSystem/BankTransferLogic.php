...
/**
 * Сервис для работы с платежной системой BankTransfer (квитанция или платежка)
 *
 * @author Sergeev A.M.
...
class BankTransferLogic extends PaymentSystemLogic
{

    const PAYMENT_SYSTEM = 'BankTransfer';
