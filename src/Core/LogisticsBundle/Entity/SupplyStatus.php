...
/**
 * @ORM\Table(name="core_logistics_supply_status")
 * @ORM\Entity(repositoryClass="Core\LogisticsBundle\Entity\Repository\SupplyStatusRepository")
 * @UniqueEntity("name")
 */
class SupplyStatus {
