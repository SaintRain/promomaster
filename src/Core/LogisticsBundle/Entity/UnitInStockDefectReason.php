...
/**
 * Причины списания товарной единицы
 * @author  Sergeev A.M.
...
/**
 * @ORM\Table(name="core_logistics_unit_in_stock_defect_reason")
 * @ORM\Entity(repositoryClass="Core\LogisticsBundle\Entity\Repository\UnitInStockDefectReasonRepository")
 * @UniqueEntity("name")
 */
class UnitInStockDefectReason {
