...
/**
 * Админский класс для причин списания единицы товара на складе
 *
 * @author  Sergeev A.M.
...
class UnitInStockDefectReasonAdmin extends Admin
{
    ...
    {
        $text = null === $object->getId() ? 'Добавление новой причины списания' : 'Редактирование причины списания «' . $object->getCaptionRu() . '»';
        return $text;
    }
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        new UnitStatusFormMapper($formMapper, $options);
    }
