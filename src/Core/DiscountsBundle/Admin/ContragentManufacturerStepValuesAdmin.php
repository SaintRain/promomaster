...
/**
 * Админский класс для редактирования значений индивидуальных скидок по производителям
 *
 * @author  Sergeev A.M.
...
class ContragentManufacturerStepValuesAdmin extends Admin {
    ...
    protected function configureFormFields(FormMapper $formMapper) {
        ...
        $formMapper->add('stepValue', 'money', ['label' => 'Сумма заказа',  'attr'=>['data-mask'=>'money']])
