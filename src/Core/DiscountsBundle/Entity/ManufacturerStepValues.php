...
/**
 * @ORM\Table(name="core_discounts_manufacturer_step_values")
 * @ORM\Entity(repositoryClass="Core\DiscountsBundle\Entity\Repository\ManufacturerStepValuesRepository")
 */
class ManufacturerStepValues {
     ...
     * @ORM\ManyToOne(targetEntity="ManufacturerDiscount", inversedBy="manufacturerStepValues")
