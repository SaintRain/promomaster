...
/**
 * @ORM\Table(name="core_union_product_alternative",
 ...
 */
class ProductAlternativeUnion extends CommonUnion {

    /**
     * Связующая колонка
     * @ORM\ManyToOne(targetEntity="Core\ProductBundle\Entity\CommonProduct", inversedBy="alternative")
