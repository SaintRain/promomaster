...
/**
 * @ORM\Table(name="core_union_order_connected",
 ...
 */
class OrderConnectedUnion extends CommonUnion {

    /**
     * Связующая колонка
     * @ORM\ManyToOne(targetEntity="Core\OrderBundle\Entity\Order", inversedBy="ordersConnected")
