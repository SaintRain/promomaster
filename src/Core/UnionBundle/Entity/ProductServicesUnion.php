...
/**
 * Дополнительные услуги для товаров
 * @author  Sergeev A.M.
...
/**
 * @ORM\Table(name="core_union_product_services",
 ...
 */
class ProductServicesUnion extends CommonUnion {

    /**
     * Связующая колонка
     * @ORM\ManyToOne(targetEntity="Core\ProductBundle\Entity\CommonProduct", inversedBy="services")
