...
/**
 * @ORM\Table(name="core_union_product_similars",
 ...
 */
class ProductSimilarsUnion extends CommonUnion {

    /**
     * Связующая колонка
     * @ORM\ManyToOne(targetEntity="Core\ProductBundle\Entity\CommonProduct", inversedBy="similars")
